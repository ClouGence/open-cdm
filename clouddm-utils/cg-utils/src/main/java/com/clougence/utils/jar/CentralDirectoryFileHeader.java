...
final class CentralDirectoryFileHeader implements FileHeader {
    ...
    void load(byte[] data, int dataOffset, RandomFile variableData, int variableOffset, JarEntryFilter filter) throws IOException {
        // Load fixed part
        this.header = data;
    ...
    static CentralDirectoryFileHeader fromRandomFile(RandomFile data, int offset, JarEntryFilter filter) throws IOException {
