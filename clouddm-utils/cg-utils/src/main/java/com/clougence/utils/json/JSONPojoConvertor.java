...
public class JSONPojoConvertor implements JSON.Convertor {
    ...
    /* ------------------------------------------------------------ */
    protected int getExcludedCount() { return _excluded == null ? 0 : _excluded.size(); }
        ...
        for (Iterator<?> iterator = props.entrySet().iterator(); iterator.hasNext();) {
            ...
            if (setter != null) {
                try {
                    ...
                    logger.warning(_pojoClass.getName() + "#" + setter.getPropertyName() + " not set from " + (entry.getValue().getClass().getName()) + "="
    ...
    public static class Setter {
        ...
        public Method getMethod() { return _setter; }

        public NumberType getNumberType() { return _numberType; }

        public Class<?> getType() { return _type; }

        public Class<?> getComponentType() { return _componentType; }

        public boolean isPropertyNumber() { return _numberType != null; }
    ...
    public static final NumberType SHORT   = Number::shortValue;
    public static final NumberType INTEGER = Number::intValue;
    public static final NumberType FLOAT   = Number::floatValue;
    public static final NumberType LONG    = number -> number instanceof Long ? number : Long.valueOf(number.longValue());
    public static final NumberType DOUBLE  = number -> number instanceof Double ? number : Double.valueOf(number.doubleValue());
