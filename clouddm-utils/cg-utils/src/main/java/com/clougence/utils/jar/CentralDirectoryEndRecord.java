...
class CentralDirectoryEndRecord {
     ...
     * {@link RandomFile}, searching backwards from the end until a valid block is
     * located.
     * @param data the source data
     * @throws IOException in case of I/O errors
     */
    CentralDirectoryEndRecord(RandomFile data) throws IOException {
    ...
    private byte[] createBlockFromEndOfData(RandomFile data, int size) throws IOException {
     ...
     */
    long getStartOfArchive(RandomFile data) {
     ...
     */
    RandomFile getCentralDirectory(RandomFile data) {
    ...
    private static final class Zip64End {
        ...
        private Zip64End(RandomFile data, Zip64Locator locator) throws IOException {
         ...
         * @return the central directory data
         */
        private RandomFile getCentralDirectory(RandomFile data) {
    ...
    private static final class Zip64Locator {
        ...
        private Zip64Locator(RandomFile data, int centralDirectoryEndOffset) throws IOException {
