...
import com.clougence.utils.convert.ConverterBean;
 ...
 * 2019-12-03 reduction based on Apache Commons Beanutils, org.apache.commons.beanutils.BeanMap
 */
public class BeanMap extends AbstractMap<String, Object> implements Cloneable {

    private transient Object                        bean;
    private transient ConverterBean                 transformConvert;
    private final transient Map<String, Method>     readMethods      = new LinkedHashMap<>();
    private final transient Map<String, Method>     writeMethods     = new LinkedHashMap<>();
    private final transient Map<String, Class<?>>   types            = new LinkedHashMap<>();
    ...
    public ConverterBean getTransformConvert() { return this.transformConvert; }

    public void setTransformConvert(ConverterBean transformConvert) { this.transformConvert = transformConvert; }
    ...
    protected Object convertType(Class<?> newType, Object value) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            ...
            } else if (this.transformConvert != null) {
                return transformConvert.convert(value, newType);
            } else {
                return value;
            }
        }
