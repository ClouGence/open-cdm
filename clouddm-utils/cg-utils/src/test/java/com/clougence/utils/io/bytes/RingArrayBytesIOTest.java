...
public class RingArrayBytesIOTest {
    @Test
    public void basicTest01() {
        BytesIO io = BytesIO.ring(111);
        assert io.capacity() == 111;
        assert io.toString().startsWith("RingArrayBytesIO[rMark=");
    }
    ...
    public void copyTest01() throws NoSuchAlgorithmException {
        RingArrayBytesIO byteBuf1 = (RingArrayBytesIO) BytesIO.ring(12);
        byteBuf1.writeBytes(new byte[] { 1, 2, 3, 4 });

        RingArrayBytesIO byteBuf2 = byteBuf1.copy();
