...
/**
 * <li>https://www.postgresql.org/docs/13/datatype.html</li>
...
public enum PostgresTypes implements FieldType {
    ...
    PostgresTypes(String codeKey, JDBCType jdbcType, Integer pgOid, boolean array, boolean needFullName){
        this(codeKey, jdbcType, pgOid, false, array, needFullName);
    }

    PostgresTypes(String codeKey, JDBCType jdbcType, Integer pgOid, boolean serial, boolean array, boolean needFullName){
    ...
    @Override
    public DsType getDsType() { return DsType.PostgreSQL; }
     ...
     */
    public static Map<String, PostgresTypes> arrayEleTypesOfCodeKey() {
        Map<String, PostgresTypes> re = new HashMap<>();
        for (PostgresTypes colType : PostgresTypes.values()) {
            if (!colType.isArray()) {
                continue;
            }
            ...
            for (PostgresTypes eType : PostgresTypes.values()) {
    ...
    public boolean hasFixedChar() {
        return this == PostgresTypes.CHARACTER;
    }
