package com.clougence.adapter.clickhouse.driver;
...
public enum ChDriverDataType {
    ...
    UInt64(JDBCType.BIGINT, BigInteger.class, false, 19, 0, "BIGINT UNSIGNED"),
    UInt32(JDBCType.BIGINT, Long.class, false, 10, 0, "INT UNSIGNED", "INTEGER UNSIGNED", "MEDIUMINT UNSIGNED"),
    UInt16(JDBCType.SMALLINT, Integer.class, false, 5, 0, "SMALLINT UNSIGNED"),
    UInt8(JDBCType.TINYINT, Integer.class, false, 3, 0, "TINYINT UNSIGNED", "INT1 UNSIGNED"),
    Int256(JDBCType.NUMERIC, BigInteger.class, true, 40, 0),
    Int128(JDBCType.NUMERIC, BigInteger.class, true, 20, 0),
    Int64(JDBCType.BIGINT, Long.class, true, 20, 0, "BIGINT", "BIGINT SIGNED"),
    Int32(JDBCType.INTEGER, Integer.class, true, 11, 0, "INT", "INTEGER", "MEDIUMINT", "INT SIGNED", "INTEGER SIGNED", "MEDIUMINT SIGNED"),
    Int16(JDBCType.SMALLINT, Integer.class, true, 6, 0, "SMALLINT", "SMALLINT SIGNED"),
    Int8(JDBCType.TINYINT, Integer.class, true, 4, 0, "TINYINT", "BOOL", "BOOLEAN", "INT1", "BYTE", "TINYINT SIGNED", "INT1 SIGNED"),
    Date(JDBCType.DATE, Date.class, false, 10, 0),
    DateTime(JDBCType.TIMESTAMP, Timestamp.class, false, 19, 0, "TIMESTAMP"),
    ...
    Enum8(JDBCType.VARCHAR, String.class, false, 0, 0, "ENUM"),
    Enum16(JDBCType.VARCHAR, String.class, false, 0, 0),
    Float32(JDBCType.REAL, Float.class, true, 8, 8, "SINGLE", "REAL"),
    Float64(JDBCType.DOUBLE, Double.class, true, 17, 17, "DOUBLE", "DOUBLE PRECISION"),
    ...
    Decimal(JDBCType.DECIMAL, BigDecimal.class, true, 0, 0, "DEC", "NUMERIC", "FIXED"),
    ...
    String(JDBCType.VARCHAR, String.class, false, 0, 0, "CHAR", "NCHAR", "CHARACTER", "VARCHAR", "NVARCHAR", "VARCHAR2", "TEXT", "TINYTEXT", "MEDIUMTEXT", "LONGTEXT", "BLOB",
            "CLOB", "TINYBLOB", "MEDIUMBLOB", "LONGBLOB", "BYTEA", "CHARACTER LARGE OBJECT", "CHARACTER VARYING", "CHAR LARGE OBJECT", "CHAR VARYING", "NATIONAL CHAR",
            "NATIONAL CHARACTER", "NATIONAL CHARACTER LARGE OBJECT", "NATIONAL CHARACTER VARYING", "NATIONAL CHAR VARYING", "NCHAR VARYING", "NCHAR LARGE OBJECT",
            "BINARY LARGE OBJECT", "BINARY VARYING"),
    FixedString(JDBCType.CHAR, String.class, false, -1, 0, "BINARY"),
    ...
    private static final Map<String, ChDriverDataType> name2type;

    static {
        Map<String, ChDriverDataType> map = new HashMap<>();
        String errorMsg = "[%s] is used by type [%s]";
        ChDriverDataType used = null;
        for (ChDriverDataType t : ChDriverDataType.values()) {
    ...
    ChDriverDataType(JDBCType jdbcType, Class<?> javaClass, boolean signed, int defaultPrecision, int defaultScale, String... aliases){
    ...
    public int getSqlType() { return jdbcType.getVendorTypeNumber(); }
    ...
    public static ChDriverDataType fromTypeString(String typeString) {
        return name2type.getOrDefault(typeString.trim().toUpperCase(), ChDriverDataType.Unknown);
    }

    public static ChDriverDataType resolveDefaultArrayDataType(String typeName) {
        return name2type.getOrDefault(typeName, ChDriverDataType.String);
    }
}
