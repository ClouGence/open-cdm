 ...
 */
public enum PolarDBMyTypes implements FieldType {
    ...
    PolarDBMyTypes(String codeKey, JDBCType jdbcType){
        this.codeKey = codeKey;
        this.jdbcType = jdbcType;
    }

    public static PolarDBMyTypes valueOfCode(String code) {
        for (PolarDBMyTypes tableType : PolarDBMyTypes.values()) {
    ...
    @Override
    public DsType getDsType() { return DsType.PolarDBMySQL; }
