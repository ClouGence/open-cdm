 ...
 */
package com.clougence.adapter.gauss.driver;

import java.text.NumberFormat;
import java.text.ParsePosition;


public enum GsServerVersion implements GsVersion {
    ...
    GsServerVersion(String version){
     ...
     * {@link GsVersion}.</p>
     *
     * <p>If the specified version cannot be parsed, the {@link GsVersion#getVersionNum()} will return 0.</p>
     *
     * @param version version in numeric XXYYZZ form, e.g. "090401" for 9.4.1
     * @return a {@link GsVersion} representing the specified version string.
     */
    public static GsVersion from(String version) {
        final int versionNum = parseServerVersionStr(version);
        return new GsVersion() {
            ...
            public boolean equals(Object obj) {
                if (obj instanceof GsVersion) {
                    return this.getVersionNum() == ((GsVersion) obj).getVersionNum();
                }
                return false;
            }
