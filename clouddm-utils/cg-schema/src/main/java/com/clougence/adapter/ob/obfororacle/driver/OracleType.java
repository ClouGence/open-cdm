package com.clougence.adapter.ob.obfororacle.driver;
...
public enum OracleType implements SQLType {
    ...
    INTEGER("INTEGER", OracleTypes.BIGINT),
    INT("INT", OracleTypes.BIGINT),
    ...
    XMLTYPE("XMLTYPE", OracleTypes.VARCHAR/*JDBCType.SQLXML.getVendorTypeNumber()*/),
    ...
    ORDIMAGE("ORDIMAGE"),
    ORDVIDEO("ORDVIDEO"),
    SI_AVERAGE_COLOR("SI_AVERAGECOLOR"),
    SI_COLOR("SI_COLOR"),
    SI_COLOR_HISTOGRAM("SI_COLORHISTOGRAM"),
    ...
    public JDBCType toJdbcType() {
        switch (this) {
            ...
            case SDO_GEOMETRY:
                return JDBCType.STRUCT; // follow debezium
            case BINARY_FLOAT:
