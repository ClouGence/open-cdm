...
public class BytesSeedUiFactory implements SeedUiFactory, FakerUiFieldKeys {
    ...
    private List<UiPanelField> buildSeedUiDetails() {
        ...
        fields.add(UiPanelField.builder()
            ...
            .titleI18N(FakerSeedI18nKeys.FAKER_SEED_BYTES_MINLENGTH_TITLE)
            .descI18N(FakerSeedI18nKeys.FAKER_SEED_BYTES_MINLENGTH_DESC)
            .build());

        fields.add(UiPanelField.builder()
            .field(MAX_LENGTH)
            .type(UiPanelFieldType.Input)
            .titleI18N(FakerSeedI18nKeys.FAKER_SEED_BYTES_MAXLENGTH_TITLE)
            .descI18N(FakerSeedI18nKeys.FAKER_SEED_BYTES_MAXLENGTH_DESC)
            .build());
        return fields;
    }
