...
public class ChLanguageSpi implements DsLanguageSpi {

    private final MetaService                metaService;
    private final ChCompletionStrategyCenter completion = new ChCompletionStrategyCenter();
    private final ChValidateStrategyCenter   validate   = new ChValidateStrategyCenter();

    public ChLanguageSpi(MetaService metaService){
    ...
    public SplitResult split(SplitRequest request) {
        ...
        List<AstSplitScript> scripts = DslHelper.splitDsl(ChSqlDslProvider.INSTANCE, sqlText, location);
