...
import com.clougence.clouddm.ds.clickhouse.parser.antlr.ClickHouseLexer;
...
public class ChSqlDslProvider implements DslProvider {

    public static final DslProvider    INSTANCE    = new ChSqlDslProvider();
    private final AntlrStatementParser TREE_PARSER = new ChSqlAntlrStatementParser();

    @Override
    public String[] getDslName() { return new String[] { "ClickHouse", "ClickHouse SQL Language" }; }

    @Override
    public Lexer createLexer(CharStream charStream) {
        return new ClickHouseLexer(charStream);
    }
