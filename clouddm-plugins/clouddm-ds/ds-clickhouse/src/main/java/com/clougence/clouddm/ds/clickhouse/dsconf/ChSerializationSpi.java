...
public class ChSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "ClickHouse"; // ref DataSourceType.ClickHouse
    private final ObjectMapper objectMapper;

    public ChSerializationSpi(ClassLoader classLoader){
