...
public class DrLanguageSpi implements DsLanguageSpi {

    private final MetaService                metaService;
    private final DrCompletionStrategyCenter completion = new DrCompletionStrategyCenter();
    private final DrValidateStrategyCenter   validate   = new DrValidateStrategyCenter();

    public DrLanguageSpi(MetaService metaService){
    ...
    public SplitResult split(SplitRequest request) {
        ...
        List<AstSplitScript> scripts = DslHelper.splitDsl(DrDslProvider.INSTANCE, sqlText, location);
