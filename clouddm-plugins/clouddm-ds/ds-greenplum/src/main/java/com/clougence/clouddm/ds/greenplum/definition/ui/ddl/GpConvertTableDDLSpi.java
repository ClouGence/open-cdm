package com.clougence.clouddm.ds.greenplum.definition.ui.ddl;
 ...
 */
public class GpConvertTableDDLSpi extends PgFamilyConvertTableDDLSpi {

    public GpConvertTableDDLSpi(){
        // for PG Family
