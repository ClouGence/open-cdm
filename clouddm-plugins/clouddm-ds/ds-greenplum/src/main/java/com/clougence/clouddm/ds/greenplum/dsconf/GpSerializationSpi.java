...
public class GpSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "Greenplum"; // ref DataSourceType.Greenplum
    private final ObjectMapper objectMapper;

    public GpSerializationSpi(ClassLoader classLoader){
