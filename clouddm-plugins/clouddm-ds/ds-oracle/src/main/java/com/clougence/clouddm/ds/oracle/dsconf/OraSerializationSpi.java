...
public class OraSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "Oracle"; // ref DataSourceType.Oracle
    private final ObjectMapper objectMapper;

    public OraSerializationSpi(ClassLoader classLoader){
