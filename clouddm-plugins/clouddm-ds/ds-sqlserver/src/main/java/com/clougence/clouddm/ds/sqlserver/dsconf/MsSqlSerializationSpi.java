...
public class MsSqlSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "SQLServer"; // ref DataSourceType.SQLServer
    private final ObjectMapper objectMapper;

    public MsSqlSerializationSpi(ClassLoader classLoader){
