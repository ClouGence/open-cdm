 ...
 **/
@Slf4j
public class TiSupportSpi implements RdbSupportSpi {

    private final List<RdbIsolation> isolationDef = Arrays.asList(RdbIsolation.REPEATABLE_READ, RdbIsolation.READ_COMMITTED);
