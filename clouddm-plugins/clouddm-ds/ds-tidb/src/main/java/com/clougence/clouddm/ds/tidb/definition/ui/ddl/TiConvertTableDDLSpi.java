package com.clougence.clouddm.ds.tidb.definition.ui.ddl;
 ...
 */
public class TiConvertTableDDLSpi implements ConvertTableDDLSpi {
    ...
    public List<String> convertDDL(TableEditor sourceEditor, SqlBuilder targetSqlBuilder) {
        ...
        sourceEditor.getSource().getAttribute().put(TiDBAttributeNames.ENGINE.getCodeKey(), null);
