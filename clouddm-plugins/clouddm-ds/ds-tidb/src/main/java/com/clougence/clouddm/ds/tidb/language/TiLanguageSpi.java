...
public class TiLanguageSpi implements DsLanguageSpi {
    private final MetaService metaService;
    private final TiCompletionStrategyCenter completion = new TiCompletionStrategyCenter();
    private final TiValidateStrategyCenter validate = new TiValidateStrategyCenter();

    public TiLanguageSpi(MetaService metaService){
    ...
    public SplitResult split(SplitRequest request) {
        ...
        List<AstSplitScript> scripts = DslHelper.splitDsl(TiDBDslProvider.INSTANCE, sqlText, location);
