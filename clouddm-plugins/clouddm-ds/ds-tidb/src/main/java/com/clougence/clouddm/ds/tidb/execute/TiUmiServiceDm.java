...
public class TiUmiServiceDm extends AbstractRdbUmiService<TiMetaProviderDm> implements RdbUmiServiceDm {

    public TiUmiServiceDm(Connection con){
        super(() -> new TiMetaProviderDm(con));
    }
