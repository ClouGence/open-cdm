...
public class PgSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "PostgreSQL"; // ref DataSourceType.PostgreSQL
    private final ObjectMapper objectMapper;

    public PgSerializationSpi(ClassLoader classLoader){
