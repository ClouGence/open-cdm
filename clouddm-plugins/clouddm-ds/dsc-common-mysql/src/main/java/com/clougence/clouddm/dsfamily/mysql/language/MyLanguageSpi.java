...
public class MyLanguageSpi implements DsLanguageSpi {
    ...
    private final MyCompletionStrategyCenter completion;
    private final MyValidateStrategyCenter   validate;

    public MyLanguageSpi(MetaService metaService){
        this.metaService = metaService;
        this.completion = new MyCompletionStrategyCenter();
    ...
    public CompletionResult complete(CompletionRequest request) {
        ...
        result.getItems().addAll(completion.complete(request, this.metaService));
        return result;
    }
    ...
    public ValidateResult validate(ValidateRequest request) {
        ...
        result.getDiagnostics().addAll(validate.validate(request, this.metaService));
        return result;
    }
    ...
    public SplitResult split(SplitRequest request) {
        ...
        List<AstSplitScript> scripts = DslHelper.splitDsl(MyDslProvider.INSTANCE, sqlText, location);
