...
import static com.clougence.clouddm.dsfamily.mysql.parser.antlr.MySqlParser.*;
...
import com.clougence.clouddm.dsfamily.mysql.parser.antlr.MySqlParserBaseVisitor;

public class MySplitVisitor extends MySqlParserBaseVisitor<SecQueryType> {

    public static final AbstractParseTreeVisitor<SecQueryType> INSTANCE = new MySplitVisitor();
