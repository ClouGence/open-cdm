...
public class RedisSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "Redis"; // ref DataSourceType.Redis
    private final ObjectMapper objectMapper;

    public RedisSerializationSpi(ClassLoader classLoader){
