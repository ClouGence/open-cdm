package com.clougence.clouddm.ds.maxcompute.definition.ui.ddl;
 ...
 */
public class McConvertTableDDLSpi implements ConvertTableDDLSpi {
    ...
    static {
        targetList.add(DataSourceType.MaxCompute);
