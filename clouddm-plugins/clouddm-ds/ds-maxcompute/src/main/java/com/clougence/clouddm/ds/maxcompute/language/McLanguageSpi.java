...
public class McLanguageSpi implements DsLanguageSpi {
    private final MetaService                metaService;
    private final McCompletionStrategyCenter completion = new McCompletionStrategyCenter();
    private final McValidateStrategyCenter   validate   = new McValidateStrategyCenter();

    public McLanguageSpi(MetaService metaService){
    ...
    public SplitResult split(SplitRequest request) {
        ...
        List<AstSplitScript> scripts = DslHelper.splitDsl(McSqlDslProvider.INSTANCE, sqlText, location);
