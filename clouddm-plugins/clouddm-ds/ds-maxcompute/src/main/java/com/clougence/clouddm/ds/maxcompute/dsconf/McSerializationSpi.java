...
public class McSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "MaxCompute"; // ref DataSourceType.Dameng
    private final ObjectMapper objectMapper;

    public McSerializationSpi(ClassLoader classLoader){
