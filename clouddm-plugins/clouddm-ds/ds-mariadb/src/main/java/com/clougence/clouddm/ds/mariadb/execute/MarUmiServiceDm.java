...
public class MarUmiServiceDm extends AbstractRdbUmiService<MyMetaProviderDm> implements RdbUmiServiceDm {

    public MarUmiServiceDm(Connection con){
        super(() -> new MarMetaProviderDm(con));
    }
