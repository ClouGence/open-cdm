package com.clougence.clouddm.ds.db2zos.definition;
...
import com.clougence.clouddm.ds.db2zos.definition.ui.editor.table.Db2ForZosTableEditorUiPanelFactory;
...
import com.clougence.clouddm.dsfamily.db2.definition.ui.editor.sequence.Db2SequencePropertyUiPanelFactory;
 ...
 */
public class Db2ForZosDefService extends AbstractDefService implements Spi, TableEditorUiDefService, ViewUiDefService, TriggerUiDefService, SequenceUiDefService, ProcedureUiDefService, FunctionUiDefService {
    ...
    protected TableEditorUiPanel fetchTableEditorUiPanel(DataSourceConfig dsConfig, Connection con, EditorViewMode viewMode, Map<String, String> envVariables) {
        return new Db2ForZosTableEditorUiPanelFactory().createTableEditorUiPanel(dsConfig, viewMode, con);
    }
    ...
    protected PropertyUiPanel fetchSequencePropertyUiPanel(DataSourceConfig dsConfig, Connection dsConnection, Map<String, String> envVariables) {
        return new Db2SequencePropertyUiPanelFactory().create(dsConfig, dsConnection);
    }
