...
public class ObForOraSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "ObForOracle"; // ref DataSourceType.OceanBase
    private final ObjectMapper objectMapper;

    public ObForOraSerializationSpi(ClassLoader classLoader){
