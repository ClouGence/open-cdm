...
public class ObMyLanguageSpi implements DsLanguageSpi {
    private final MetaService                  metaService;
    private final ObMyCompletionStrategyCenter completion = new ObMyCompletionStrategyCenter();
    private final ObMyValidateStrategyCenter   validate   = new ObMyValidateStrategyCenter();

    public ObMyLanguageSpi(MetaService metaService){
    ...
    public SplitResult split(SplitRequest request) {
        ...
        List<AstSplitScript> scripts = DslHelper.splitDsl(ObMyDslProvider.INSTANCE, sqlText, location);
