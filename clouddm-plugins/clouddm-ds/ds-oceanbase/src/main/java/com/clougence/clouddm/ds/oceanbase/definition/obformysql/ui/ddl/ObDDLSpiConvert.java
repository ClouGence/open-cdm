package com.clougence.clouddm.ds.oceanbase.definition.obformysql.ui.ddl;
 ...
 */
public class ObDDLSpiConvert implements ConvertTableDDLSpi {
    ...
    public List<String> convertDDL(TableEditor sourceEditor, SqlBuilder targetSqlBuilder) {
        ...
        sourceEditor.getSource().getAttribute().put(ObForMySQLAttributeNames.ENGINE.getCodeKey(), null);
