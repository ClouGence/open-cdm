package com.clougence.clouddm.ds.oceanbase.definition.obformysql.ui.editor.data;

import java.util.Collections;

import com.clougence.adapter.ob.obformysql.ObForMySQLAttributeNames;
...
public class ObDataEditorUtils implements DsDataEditorI18nKeys {
    ...
    public static String templateOfInsert(Dialect dialect, RdbColumn col, String value) {
        ...
        ObForMySQLTypes sqlType = (ObForMySQLTypes) col.getSqlType();
        switch (sqlType) {
            case BIT:
    ...
    private static String fmtDataValue(ObForMySQLTypes type, String value, boolean asVarchar) {
