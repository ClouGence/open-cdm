package com.clougence.clouddm.ds.oceanbase.definition.obforora.ui.editor.data;
 ...
 * @version: 1.0
 */
public class ObForOraDataEditorUtils implements DsDataEditorI18nKeys {

    public static void configTableHeader(RdbTable rdbTable, DataEditorColumn headerCol, RdbColumn colDef, I18nUtils i18nUtils) {
        ObForOracleTypes sqlType = (ObForOracleTypes) colDef.getSqlType();
        switch (sqlType) {
            case BLOB:
            case RAW: {
    ...
    public static String templateOfInsert(Dialect dialect, RdbColumn col, String value) {
        ...
        ObForOracleTypes sqlType = (ObForOracleTypes) col.getSqlType();
        switch (sqlType) {
            case BLOB:
            case RAW:
    ...
    private static String fmtDataValue(ObForOracleTypes type, String value, boolean asVarchar) {
