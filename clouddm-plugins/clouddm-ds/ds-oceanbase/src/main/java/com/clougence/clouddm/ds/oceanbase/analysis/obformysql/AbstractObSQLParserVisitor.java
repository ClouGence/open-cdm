...
import static com.clougence.clouddm.ds.oceanbase.parser.ob4my.antlr.ObForMySqlParser.*;
...
import com.clougence.clouddm.ds.oceanbase.parser.ob4my.antlr.ObForMySqlParserBaseVisitor;

public abstract class AbstractObSQLParserVisitor extends ObForMySqlParserBaseVisitor<Void> {

    private final MyBuilderFactory builder;
    private final Parser           parser;

    public AbstractObSQLParserVisitor(MyBuilderFactory builder, Parser parser){
