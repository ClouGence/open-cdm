...
public class SrLanguageSpi implements DsLanguageSpi {
    private final MetaService                metaService;
    private final SrCompletionStrategyCenter completion = new SrCompletionStrategyCenter();
    private final SrValidateStrategyCenter   validate   = new SrValidateStrategyCenter();

    public SrLanguageSpi(MetaService metaService){
    ...
    public SplitResult split(SplitRequest request) {
        ...
        List<AstSplitScript> scripts = DslHelper.splitDsl(SrDslProvider.INSTANCE, sqlText, location);
