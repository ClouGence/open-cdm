 ...
 */
public class SrUmiServiceDm extends AbstractRdbUmiService<SrMetaProviderDm> implements RdbUmiServiceDm {

    public SrUmiServiceDm(Connection con){
        super(() -> new SrMetaProviderDm(con));
    }
    ...
    public List<Value> listLeaf(Map<UmiTypes, Object> levelsParam, UmiTypes leafType, String pattern) throws SQLException {
        ...
        if (!catalog.equals(SrMetaProviderUtils.INTERNAL_CATALOG) && leafType != UmiTypes.ExternalTable) {
