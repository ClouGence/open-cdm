...
public class SrSqlSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "StarRocks"; // ref DataSourceType.StarRocks
    private final ObjectMapper objectMapper;

    public SrSqlSerializationSpi(ClassLoader classLoader){
