package com.clougence.clouddm.dsfamily.postgres.definition.ui.ddl;
 ...
 */
public abstract class PgFamilyConvertTableDDLSpi implements ConvertTableDDLSpi {

    protected final List<DataSourceType> targetList  = new ArrayList<>();
    protected final List<DDLType>        ddlTypeList = new ArrayList<>();
