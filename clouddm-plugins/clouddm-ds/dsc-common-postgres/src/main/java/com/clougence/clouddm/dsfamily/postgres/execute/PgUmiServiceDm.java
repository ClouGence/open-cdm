...
public class PgUmiServiceDm extends AbstractRdbUmiService<PgMetaProviderDm> implements RdbUmiServiceDm {

    public PgUmiServiceDm(Connection con){
        super(() -> new PgMetaProviderDm(con));
    }
