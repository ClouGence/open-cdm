...
public class HanaSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "Hana"; // ref DataSourceType.Hana
    private final ObjectMapper objectMapper;

    public HanaSerializationSpi(ClassLoader classLoader){
