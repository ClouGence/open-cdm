...
public class DmSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "Dameng"; // ref DataSourceType.Dameng
    private final ObjectMapper objectMapper;

    public DmSerializationSpi(ClassLoader classLoader){
