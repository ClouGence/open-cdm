 ...
 */
public class DmUmiServiceDm extends AbstractRdbUmiService<DmMetaProviderDm> implements RdbUmiServiceDm {

    public DmUmiServiceDm(Connection con){
        super(() -> new DmMetaProviderDm(con));
    }
    ...
    public List<Value> listLeaf(Map<UmiTypes, Object> levelsParam, UmiTypes leafType, String pattern) throws SQLException {
        ...
        switch (leafType) {
            ...
            case TABLESPACE:
                return this.metadataSupplier.eGet().selectTablespacees(schema);
            default:
