 ...
 */
public class HgSession extends DefaultRdbSession {

    protected Savepoint inTxRequestSavepoint;

    public HgSession(String newSessionId, DataSourceConfig dsConfig, DsObject<Connection> dsObject){
        super(newSessionId, dsConfig, dsObject, new HgHooks());
    }

    public HgSession(String newSessionId, DataSourceConfig dsConfig, DsObject<Connection> dsObject, SessionHook sessionHook){
