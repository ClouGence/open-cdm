...
public class HgPgUmiServiceDm extends AbstractRdbUmiService<HgMetaProviderDm> implements RdbUmiServiceDm {

    public HgPgUmiServiceDm(Connection con){
        super(() -> new HgMetaProviderDm(con));
    }
