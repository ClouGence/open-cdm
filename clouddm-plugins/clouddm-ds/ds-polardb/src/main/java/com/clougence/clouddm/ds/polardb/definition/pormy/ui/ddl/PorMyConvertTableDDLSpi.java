package com.clougence.clouddm.ds.polardb.definition.pormy.ui.ddl;
...
import com.clougence.adapter.polar.pormy.PolarDBMyAttributeNames;
 ...
 */
public class PorMyConvertTableDDLSpi implements ConvertTableDDLSpi {
    ...
    public List<String> convertDDL(TableEditor sourceEditor, SqlBuilder targetSqlBuilder) {
        ...
        // clear engine
        attribute.put(PolarDBMyAttributeNames.ENGINE.getCodeKey(), null);
