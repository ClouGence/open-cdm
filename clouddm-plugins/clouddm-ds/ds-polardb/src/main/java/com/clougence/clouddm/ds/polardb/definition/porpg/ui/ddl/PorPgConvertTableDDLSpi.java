package com.clougence.clouddm.ds.polardb.definition.porpg.ui.ddl;
 ...
 */
public class PorPgConvertTableDDLSpi extends PgFamilyConvertTableDDLSpi {

    public PorPgConvertTableDDLSpi(){
        // for PG Family
