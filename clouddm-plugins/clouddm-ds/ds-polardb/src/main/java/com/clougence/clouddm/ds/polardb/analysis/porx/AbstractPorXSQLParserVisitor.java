...
import static com.clougence.clouddm.ds.polardb.parser.porx.antlr.PolardbXParser.*;
...
import com.clougence.clouddm.ds.polardb.parser.porx.antlr.PolardbXParserBaseVisitor;

public abstract class AbstractPorXSQLParserVisitor extends PolardbXParserBaseVisitor<Void> {

    protected final MyBuilderFactory builder;
    private final Parser             parser;

    public AbstractPorXSQLParserVisitor(MyBuilderFactory builder, Parser parser){
