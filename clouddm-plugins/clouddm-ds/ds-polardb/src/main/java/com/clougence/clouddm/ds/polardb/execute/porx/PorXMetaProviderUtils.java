 ...
 */
@Slf4j
public class PorXMetaProviderUtils extends MyMetaProviderUtils {
    ...
    public List<RdbColumn> convertColumn(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            ...
            try {
                ...
                PolarDbXTypes sqlType = safeToPolarDbXTypes(rs.getString("DATA_TYPE"));
    ...
    protected PolarDbXTypes safeToPolarDbXTypes(Object obj) {
        String dat = (obj == null) ? null : obj.toString();
        for (PolarDbXTypes type : PolarDbXTypes.values()) {
