...
public class PorXUmiServiceDm extends AbstractRdbUmiService<PorXMetaProviderDm> implements RdbUmiServiceDm {

    public PorXUmiServiceDm(Connection con){
        super(() -> new PorXMetaProviderDm(con));
    }
