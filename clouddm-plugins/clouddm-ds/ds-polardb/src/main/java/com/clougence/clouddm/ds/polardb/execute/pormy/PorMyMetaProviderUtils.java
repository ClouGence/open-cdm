 ...
 */
@Slf4j
public class PorMyMetaProviderUtils extends MyMetaProviderUtils {
    ...
    public List<RdbColumn> convertColumn(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            ...
            try {
                ...
                PolarDBMyTypes sqlType = safeToPolarDBMyTypes(rs.getString("DATA_TYPE"));
    ...
    protected PolarDBMyTypes safeToPolarDBMyTypes(Object obj) {
        String dat = (obj == null) ? null : obj.toString();
        for (PolarDBMyTypes type : PolarDBMyTypes.values()) {
