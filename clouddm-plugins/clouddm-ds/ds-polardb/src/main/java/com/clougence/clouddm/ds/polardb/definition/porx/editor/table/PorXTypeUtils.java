...
class PorXTypeUtils {
    ...
    public static String buildColumnType(EColumn columnInfo, TriggerContext triggerContext) {
        ...
        PolarDbXTypes sqlTypes = PolarDbXTypes.valueOfCode(columnInfo.getDbType());
    ...
    private static String buildOptions(EColumn columnInfo) {
        PolarDbXOnCurrentUpdateType currentUpdateType = PolarDbXOnCurrentUpdateType.valueOfCode(CURRENT_UPDATE_TYPE.getValue(columnInfo.getAttribute()));
    ...
    private static String buildNullable(boolean nullable, PolarDbXTypes sqlTypes, MainVersion mainVersion) {
        if (!nullable) {
            return "not null";
        } else {
            return "null";
    ...
    public static String buildDefault(PolarDbXTypes sqlTypes, MainVersion mainVersion, EColumn columnInfo, TriggerContext triggerContext) {
    ...
    private static String buildColumnType(PolarDbXTypes sqlTypes, EColumn columnInfo, TriggerContext triggerContext) {
        if (sqlTypes == null) {
