...
public class PorMySerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "PolarDbMySQL"; // ref DataSourceType.PolarDbMySQL
    private final ObjectMapper objectMapper;

    public PorMySerializationSpi(ClassLoader classLoader){
