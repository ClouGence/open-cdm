package com.clougence.clouddm.ds.polardb.definition.porx.ui.ddl;
 ...
 */
public class PorXConvertTableDDLSpi implements ConvertTableDDLSpi {
    ...
    public List<String> convertDDL(TableEditor sourceEditor, SqlBuilder targetSqlBuilder) {
        throw new UnsupportedOperationException("Unsupported PolarDB for MySQL struct migration");
    }
