...
public class SelSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "SelectDB"; // ref DataSourceType.Doris
    private final ObjectMapper objectMapper;

    public SelSerializationSpi(ClassLoader classLoader){
