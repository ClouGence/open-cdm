 ...
 */
public class GsogSession extends DefaultRdbSession {

    protected Savepoint inTxRequestSavepoint;

    public GsogSession(String newSessionId, DataSourceConfig dsConfig, DsObject<Connection> dsObject){
        super(newSessionId, dsConfig, dsObject, new GsogHooks());
    }

    public GsogSession(String newSessionId, DataSourceConfig dsConfig, DsObject<Connection> dsObject, SessionHook sessionHook){
