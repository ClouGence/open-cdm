package com.clougence.clouddm.ds.gauss.definition.gsog;
...
import com.clougence.clouddm.ds.gauss.definition.gsog.ui.editor.table.GsogTableEditorUiPanelFactory;
import com.clougence.clouddm.ds.gauss.definition.gsog.ui.editor.view.GsogViewEditorUiPanelFactory;
...
public class GsogDefService extends AbstractDefService implements Spi, TableEditorUiDefService, FunctionUiDefService, ProcedureUiDefService, ViewUiDefService, TriggerUiDefService {
    ...
    protected TableEditorUiPanel fetchTableEditorUiPanel(DataSourceConfig dsConfig, Connection con, EditorViewMode viewMode, Map<String, String> envVariables) {
        return new GsogTableEditorUiPanelFactory().createTableEditorUiPanel(dsConfig, viewMode, con);
    }
    ...
    protected UiPanel fetchViewUiPanel(DataSourceConfig dsConfig, Connection con, EditorViewMode viewMode, Map<String, String> envVariables) {
        return new GsogViewEditorUiPanelFactory().createViewUiPanel(dsConfig, viewMode, con);
    }
