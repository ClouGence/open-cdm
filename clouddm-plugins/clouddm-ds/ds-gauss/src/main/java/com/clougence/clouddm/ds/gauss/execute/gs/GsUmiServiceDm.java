...
public class GsUmiServiceDm extends AbstractRdbUmiService<PgMetaProviderDm> implements RdbUmiServiceDm {

    public GsUmiServiceDm(Connection con){
        super(() -> new GsMetaProviderDm(con));
    }
