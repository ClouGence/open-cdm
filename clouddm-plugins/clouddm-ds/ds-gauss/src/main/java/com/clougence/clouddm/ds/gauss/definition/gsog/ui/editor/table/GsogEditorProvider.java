 ...
 */
public class GsogEditorProvider extends AbstractSqlBuilder implements SqlBuilder {

    public static final SqlBuilder INSTANCE = new GsogEditorProvider();

    @Override
    public DsType getDataSourceType() { return DsType.PostgreSQL; }

    public Dialect getDialect() { return GaussDBDialect.INSTANCE; }
    ...
    public List<String> tableCreate(TriggerContext buildContext, String catalog, String schema, String table, ETable eTable) {
        return new GsogCreateUtils().buildCreate(buildContext, catalog, schema, table, eTable);
    }
    ...
    public List<String> createIndex(TriggerContext buildContext, String catalog, String schema, String table, EIndex indexInfo) {
        GsogCreateUtils createUtils = new GsogCreateUtils();
        StringBuilder sqlBuild = new StringBuilder();
