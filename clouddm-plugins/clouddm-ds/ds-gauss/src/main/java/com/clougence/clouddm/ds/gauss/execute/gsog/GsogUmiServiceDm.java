...
public class GsogUmiServiceDm extends AbstractRdbUmiService<PgMetaProviderDm> implements RdbUmiServiceDm {

    public GsogUmiServiceDm(Connection con){
        super(() -> new GsogMetaProviderDm(con));
    }
