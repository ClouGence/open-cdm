...
public class GsSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "GaussDB"; // ref DataSourceType.GaussDB
    private final ObjectMapper objectMapper;

    public GsSerializationSpi(ClassLoader classLoader){
