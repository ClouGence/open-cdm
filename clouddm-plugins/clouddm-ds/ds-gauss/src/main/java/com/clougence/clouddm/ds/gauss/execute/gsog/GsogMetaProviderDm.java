 ...
 */
@Slf4j
public class GsogMetaProviderDm extends PgMetaProviderDm implements MetaDataService {

    public GsogMetaProviderDm(Connection connection){
        super(connection);
        this.providerUtils = new GsogMetaProviderUtils();
    }
