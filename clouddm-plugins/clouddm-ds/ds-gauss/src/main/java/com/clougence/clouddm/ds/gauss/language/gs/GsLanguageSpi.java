 ...
 */
package com.clougence.clouddm.ds.gauss.language.gs;
...
public class GsLanguageSpi implements DsLanguageSpi {
    private final MetaService                metaService;
    private final GsCompletionStrategyCenter completion = new GsCompletionStrategyCenter();
    private final GsValidateStrategyCenter   validate   = new GsValidateStrategyCenter();

    public GsLanguageSpi(MetaService metaService){
    ...
    public SplitResult split(SplitRequest request) {
        ...
        List<AstSplitScript> scripts = DslHelper.splitDsl(GaussDslProvider.INSTANCE, sqlText, location);
