 ...
 */
public class GsEditorProvider extends AbstractSqlBuilder implements SqlBuilder {

    public static final SqlBuilder INSTANCE = new GsEditorProvider();
    ...
    public List<String> tableCreate(TriggerContext buildContext, String catalog, String schema, String table, ETable eTable) {
        return new GsCreateUtils().buildCreate(buildContext, catalog, schema, table, eTable);
    }
    ...
    public List<String> createIndex(TriggerContext buildContext, String catalog, String schema, String table, EIndex indexInfo) {
        GsCreateUtils createUtils = new GsCreateUtils();
        StringBuilder sqlBuild = new StringBuilder();
