package com.clougence.clouddm.ds.gauss.definition.gsog.ui.ddl;
 ...
 */
public class GsogConvertTableDDLSpi extends PgFamilyConvertTableDDLSpi {

    public GsogConvertTableDDLSpi(){
        // for PG Family
