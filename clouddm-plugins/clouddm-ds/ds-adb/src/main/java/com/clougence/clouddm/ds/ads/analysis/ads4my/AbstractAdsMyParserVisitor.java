...
public abstract class AbstractAdsMyParserVisitor extends AdsMyParserBaseVisitor<Void> {

    protected final MyBuilderFactory builder;
    private final Parser             parser;

    public AbstractAdsMyParserVisitor(MyBuilderFactory builder, Parser parser){
