#!/bin/bash
# ============================================================================
# publish-china.sh — 发布 CloudDM 镜像到中国区（阿里云容器镜像）
#
# 用法:
#   ./publish-china.sh                         # 自动探测所有已构建平台
#   ./publish-china.sh --platform=x86_64       # 仅推送 x86_64
#   ./publish-china.sh --platform=x86_64,arm64 # 推送双平台
#
...
usage() {
  cat <<'EOF'
用法: ./publish-china.sh [--platform=PLATFORM]
