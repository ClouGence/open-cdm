...
import com.clougence.sql.iso.sql99.parser.antlr.Sql99Lexer;

/** SQL-99 top-level semicolon boundaries. */
public final class Sql99LexerSplitPolicy implements LexerSplitPolicy {

    @Override
    public LexerSplitBoundary boundary(Token token, LexerSplitContext context) {
        return token.getChannel() == Token.DEFAULT_CHANNEL && token.getType() == Sql99Lexer.SEMI
