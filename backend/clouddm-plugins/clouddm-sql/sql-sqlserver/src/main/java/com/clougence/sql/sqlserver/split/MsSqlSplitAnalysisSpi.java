 ...
 */
package com.clougence.sql.sqlserver.split;
...
public class MsSqlSplitAnalysisSpi implements SplitAnalysisSpi {

    protected DslProvider dslProvider() {
        return MsSqlDslProvider.INSTANCE;
    }

    protected AbstractParseTreeVisitor<SecQueryType> getSplitVisitor() { return MsSplitVisitor.INSTANCE; }
