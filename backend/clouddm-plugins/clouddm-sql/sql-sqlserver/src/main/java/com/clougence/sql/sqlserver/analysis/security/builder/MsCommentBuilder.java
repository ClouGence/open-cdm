...
import com.clougence.sql.sqlserver.analysis.security.domain.MsColumnDomain;
import com.clougence.sql.sqlserver.analysis.security.domain.MsTableDomain;

public class MsCommentBuilder extends CommentBuilder {

    public MsCommentBuilder(TargetType targetType){
        super(targetType);
    }

    @Override
    protected RdbColumnDomain getColumnDomain() { return new MsColumnDomain(); }

    @Override
    protected RdbTableDomain getTableDomain() { return new MsTableDomain(); }
}
