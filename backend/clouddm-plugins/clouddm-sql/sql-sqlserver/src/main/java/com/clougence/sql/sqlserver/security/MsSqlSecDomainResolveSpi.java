 ...
 */
package com.clougence.sql.sqlserver.security;
...
import com.clougence.sql.sqlserver.builder.MsBuildFactory;
...
import com.clougence.sql.sqlserver.security.resolve.*;
...
public class MsSqlSecDomainResolveSpi implements SecDomainResolveSpi {
    ...
    private boolean specialHandle(ParseTree parseTree, List<RuleDomain> result, SplitScript splitScript) {
        ...
        if ((child instanceof SqlServerParser.Ddl_clauseContext
            ...
            if (child.getChild(0) instanceof SqlServerParser.Create_or_alter_triggerContext triggerContext) {
                if (triggerContext.getChild(0) instanceof SqlServerParser.Create_or_alter_dml_triggerContext context) {
            ...
            } else if (child.getChild(0) instanceof SqlServerParser.Create_viewContext viewContext) {
    ...
    private List<RuleDomain> parseSql(SQLStatement statement) {
        ...
        // exec
        if (statement instanceof SQLServerExecStatement execStatement) {
