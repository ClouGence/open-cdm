 ...
 */
package com.clougence.sql.redis.parser.ast.commands.command;
...
@Getter
@Setter
public class CommandGetKeysRedisCmd extends AbstractRedisCmd {
    ...
    @Override
    public RedisCmdType getCmdType() { return RedisCmdType.COMMAND_GETKEYS; }

    @Override
    public void doFormat(FmtWriter writer) throws IOException {
        writer.append("COMMAND GETKEYS");
        writer.append(" ");
