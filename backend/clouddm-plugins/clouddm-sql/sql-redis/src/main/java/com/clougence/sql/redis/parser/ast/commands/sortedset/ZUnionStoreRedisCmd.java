...
import com.clougence.sql.redis.parser.ast.token.AggregateType;
...
@Getter
@Setter
public class ZUnionStoreRedisCmd extends AbstractRedisCmd {
    ...
    @Override
    public RedisCmdType getCmdType() { return RedisCmdType.ZUNIONSTORE; }

    @Override
    public void doFormat(FmtWriter writer) throws IOException {
        writer.append("ZUNIONSTORE");
        writer.append(" ");
