 ...
 */
package com.clougence.sql.redis.split;
...
public class RedisSplitAnalysisSpi implements SplitAnalysisSpi {

    protected DslProvider dslProvider() {
        return RedisDslProvider.INSTANCE;
    }

    protected AbstractParseTreeVisitor<SecQueryType> getSplitVisitor() { return RedisSplitVisitor.INSTANCE; }
