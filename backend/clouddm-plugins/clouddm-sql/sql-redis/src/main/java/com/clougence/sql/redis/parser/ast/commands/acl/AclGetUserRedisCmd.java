 ...
 */
package com.clougence.sql.redis.parser.ast.commands.acl;
...
@Getter
@Setter
public class AclGetUserRedisCmd extends AbstractRedisCmd {

    private StrToken username;

    @Override
    public RedisCmdType getCmdType() { return RedisCmdType.ACL_GETUSER; }

    @Override
    public void doFormat(FmtWriter writer) throws IOException {
        writer.append("ACL GETUSER");
        writer.append(" ");
