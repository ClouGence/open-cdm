...
@Getter
@Setter
public class ClusterReplicasRedisCmd extends AbstractRedisCmd {

    private StrToken nodeId;

    @Override
    public RedisCmdType getCmdType() { return RedisCmdType.CLUSTER_REPLICAS; }

    @Override
    public void doFormat(FmtWriter writer) throws IOException {
        writer.append("CLUSTER REPLICAS");
        writer.append(" ");
