...
@Getter
@Setter
public class ZRemRangeByLexRedisCmd extends AbstractRedisCmd {
    ...
    @Override
    public RedisCmdType getCmdType() { return RedisCmdType.ZREMRANGEBYLEX; }

    @Override
    public void doFormat(FmtWriter writer) throws IOException {
        writer.append("ZREMRANGEBYLEX");
        writer.append(" ");
