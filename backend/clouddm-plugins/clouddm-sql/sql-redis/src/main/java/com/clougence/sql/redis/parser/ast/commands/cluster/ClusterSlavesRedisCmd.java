...
@Getter
@Setter
public class ClusterSlavesRedisCmd extends AbstractRedisCmd {

    private StrToken nodeId;

    @Override
    public RedisCmdType getCmdType() { return RedisCmdType.CLUSTER_SLAVES; }

    @Override
    public void doFormat(FmtWriter writer) throws IOException {
        writer.append("CLUSTER SLAVES");
        writer.append(" ");
