 ...
 */
package com.clougence.sql.redis.parser.ast.commands.hash;
...
import com.clougence.sql.redis.parser.ast.token.KeyOptToken;
...
@Getter
@Setter
public class HExpireAtRedisCmd extends AbstractRedisCmd {
    ...
    @Override
    public RedisCmdType getCmdType() { return RedisCmdType.HEXPIREAT; }
