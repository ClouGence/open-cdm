 ...
 */
package com.clougence.sql.redis.parser.ast.commands.list;
...
@Getter
@Setter
public class LRangeRedisCmd extends AbstractRedisCmd {

    private StrToken keyName;
    private IntToken start;
    private IntToken stop;

    @Override
    public RedisCmdType getCmdType() { return RedisCmdType.LRANGE; }

    @Override
    public void doFormat(FmtWriter writer) throws IOException {
        writer.append("LRANGE");
        writer.append(" ");
        writer.append(fmtString(this.keyName));
        writer.append(" ");
        writer.append(fmtInt(this.start));
        writer.append(" ");
        writer.append(fmtInt(this.stop));
    }
}
