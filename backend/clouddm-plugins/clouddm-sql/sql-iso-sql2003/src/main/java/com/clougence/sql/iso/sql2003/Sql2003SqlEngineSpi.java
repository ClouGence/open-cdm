...
import com.clougence.sql.iso.sql2003.analysis.column.Sql2003SelectColumnAnalysisSpi;
...
public class Sql2003SqlEngineSpi implements SqlEngineSpi {
    ...
    public Sql2003SqlEngineSpi(MetaService metaService){
        ...
        this.selectColumnAnalysisSpi = new Sql2003SelectColumnAnalysisSpi(metaService);
