...
public class CreateProcedureBuilder extends AbstractDomainBuilder {

    private final RdbProcedureDomain domain = new RdbProcedureDomain();
    ...
    public List<Domain> build() {
        ...
        domain.setSqlType(SecQueryType.CREATE_PROCEDURE);
