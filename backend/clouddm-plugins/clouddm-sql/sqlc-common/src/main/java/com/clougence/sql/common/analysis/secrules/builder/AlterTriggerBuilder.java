...
public class AlterTriggerBuilder extends AbstractDomainBuilder {

    private final RdbTriggerDomain triggerDomain = new RdbTriggerDomain();

    @Override
    public List<Domain> build() {
        triggerDomain.setSqlType(SecQueryType.ALTER_TRIGGER);
