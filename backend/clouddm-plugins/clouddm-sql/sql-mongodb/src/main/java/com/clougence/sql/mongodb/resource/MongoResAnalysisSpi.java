 ...
 */
package com.clougence.sql.mongodb.resource;
...
import com.clougence.sql.mongodb.security.domain.MongoCollectionDomain;
...
public class MongoResAnalysisSpi extends RdbResAnalysisSpi {
    ...
    protected List<RdbResObject> convert(DataSourceType dsType, RuleDomain domain, Map<String, Object> ctx) {
        ...
        if (domain instanceof MongoCollectionDomain collectionDomain) {
