...
public class DorisVersionConfigurationTest {
    ...
    public void analysisSpisUseTheirConfiguredParserProvider() {
        ...
        Assertions.assertDoesNotThrow(() -> engine.behaviorAnalysisSpi(doris3).analysisBehavior(BITMAP_INDEX, Map.of(), 0, 0));
        Assertions.assertThrows(AntlerSyntaxException.class, () -> engine.behaviorAnalysisSpi(doris4).analysisBehavior(BITMAP_INDEX, Map.of(), 0, 0));
    }
