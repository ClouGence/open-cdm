...
/** Shares one immutable Doris configuration with the generated lexer. */
public abstract class DorisLexerBase extends Lexer {

    private DorisParserConfig config = new DorisParserConfig(DorisVersion.LATEST);

    protected DorisLexerBase(CharStream input){
        super(input);
    }
