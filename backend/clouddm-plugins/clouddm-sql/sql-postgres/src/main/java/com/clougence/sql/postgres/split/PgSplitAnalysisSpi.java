 ...
 */
package com.clougence.sql.postgres.split;
...
public class PgSplitAnalysisSpi implements SplitAnalysisSpi {

    protected DslProvider dslProvider() {
        return PgDslProvider.INSTANCE;
    }

    protected AbstractParseTreeVisitor<SecQueryType> getSplitVisitor() { return PgSplitVisitor.INSTANCE; }
