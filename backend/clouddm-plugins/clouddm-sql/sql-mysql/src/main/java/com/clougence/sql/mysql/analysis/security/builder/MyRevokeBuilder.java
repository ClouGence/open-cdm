...
import com.clougence.sql.mysql.analysis.security.domain.MyRevokeDomain;

public class MyRevokeBuilder extends RevokeBuilder {

    private final List<MyRevokeDomain> domains = new ArrayList<>();
    ...
    public void handleSubDomain(List<Domain> list, DomainSource source) {
        if (source == DomainSource.OBJ_NAME) {
            ...
            rdbUserDomain.setSqlType(RuleQueryType.REVOKE);
