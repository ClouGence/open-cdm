...
public class OraSplitVisitor extends PlSqlParserBaseVisitor<SecQueryType> {
    ...
    @Override
    public SecQueryType visitAlter_view(Alter_viewContext ctx) {
        return SecQueryType.ALTER_VIEW;
    }

    @Override
    public SecQueryType visitDrop_view(Drop_viewContext ctx) {
    ...
    @Override
    public SecQueryType visitAlter_function(Alter_functionContext ctx) {
    ...
    @Override
    public SecQueryType visitAlter_procedure(Alter_procedureContext ctx) {
        return SecQueryType.ALTER_PROG_OBJ;
    }
    ...
    @Override
    public SecQueryType visitMerge_statement(Merge_statementContext ctx) {
    ...
    @Override
    public SecQueryType visitAlter_user(Alter_userContext ctx) {
    ...
    @Override
    public SecQueryType visitAlter_sequence(Alter_sequenceContext ctx) {
    ...
    @Override
    public SecQueryType visitDrop_synonym(Drop_synonymContext ctx) {
