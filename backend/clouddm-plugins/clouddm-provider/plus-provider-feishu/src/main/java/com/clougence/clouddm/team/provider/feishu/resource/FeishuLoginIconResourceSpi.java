 ...
 */
package com.clougence.clouddm.team.provider.feishu.resource;
...
public class FeishuLoginIconResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public FeishuLoginIconResourceSpi(ClassLoader loader){
