...
public interface OidcI18nKey {
    ...
    String OIDC_VERIFY_TOKEN_MISSING_UNIQUE_ID_ERROR = "OIDC_VERIFY_TOKEN_MISSING_UNIQUE_ID_ERROR";
    ...
    String OIDC_VERIFY_TOKEN_JWK_NOT_FOUND_ERROR     = "OIDC_VERIFY_TOKEN_JWK_NOT_FOUND_ERROR";
}
