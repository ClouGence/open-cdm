 ...
 */
package com.clougence.clouddm.team.provider.dingtalk.resource;
...
public class DingTalkLoginIconResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public DingTalkLoginIconResourceSpi(ClassLoader loader){
