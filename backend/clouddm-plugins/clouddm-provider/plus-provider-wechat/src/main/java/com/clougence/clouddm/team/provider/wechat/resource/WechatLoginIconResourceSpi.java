 ...
 */
package com.clougence.clouddm.team.provider.wechat.resource;
...
public class WechatLoginIconResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public WechatLoginIconResourceSpi(ClassLoader loader){
