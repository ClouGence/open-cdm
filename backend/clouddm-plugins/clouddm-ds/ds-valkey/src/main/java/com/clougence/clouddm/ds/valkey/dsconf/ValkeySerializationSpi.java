...
@Slf4j
public class ValkeySerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "Valkey"; // ref DataSourceType.Valkey
    private final ObjectMapper objectMapper;

    public ValkeySerializationSpi(ClassLoader classLoader){
    ...
    public Object decode(String jsonData, Type tryType) {
        ...
        try {
            ...
            String msg = "decode redis-compatible config failed";
            log.error(msg, e);
