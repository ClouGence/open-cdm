...
public class ValkeyUmiServiceDm extends AbstractRdbUmiService<ValkeyMetaProviderDm> implements RdbUmiServiceDm {

    public ValkeyUmiServiceDm(Connection con){
        super(() -> new ValkeyMetaProviderDm(con));
    }
