...
public class GlideKeys {

    //
    public static final String ADAPTER_NAME            = JdbcDriver.P_ADAPTER_NAME;
    public static final String ADAPTER_NAME_VALUE      = "glide";
    public static final String START_URL               = JdbcDriver.START_URL + ADAPTER_NAME_VALUE + ":";
    public static final String DEFAULT_CLIENT_NAME     = "Glide-JDBC-Client";

    // for call
    public static final String INTERCEPTOR             = "interceptor";
    public static final String CUSTOM_JEDIS            = "customGlide";
    // for client
