 ...
 */
package com.clougence.clouddm.ds.valkey.definition.ui.template;
...
public class ValkeyCmdTemplateSpi extends AbstractCmdTemplateSpi {

    @Override
    protected Dialect getDialect() { return ValkeyDialect.INSTANCE; }
