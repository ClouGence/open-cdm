...
public class ValkeyHooks implements SessionHook {
    ...
    public ColReader createColReader() {
        return new ValkeyColReader();
    }

    @Override
    public DsMetaService createMetaService(Session session) {
        return new ValkeyMetaService(session);
    }
    ...
    public void setCurrentCatalog(Connection conn, String catalogName) {
        throw new UnsupportedOperationException("Valkey Unsupported.");
    }
    ...
    public String getQueryID(Connection conn) throws SQLException {
        return conn.unwrap(GlideConnection.class).getObjectId();
    }

    @Override
    public void killProcess(Connection conn, String connID) throws SQLException {
        conn.unwrap(GlideConnection.class).killDriverConnection(connID);
    }
