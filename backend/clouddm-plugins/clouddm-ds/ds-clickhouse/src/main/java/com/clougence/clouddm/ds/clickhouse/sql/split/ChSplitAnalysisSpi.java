 ...
 */
package com.clougence.clouddm.ds.clickhouse.sql.split;
...
public class ChSplitAnalysisSpi implements SplitAnalysisSpi {

    protected DslProvider dslProvider() {
        return ChSqlDslProvider.INSTANCE;
    }

    protected AbstractParseTreeVisitor<SecQueryType> getSplitVisitor() { return ChSplitVisitor.INSTANCE; }
