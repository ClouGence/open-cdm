 ...
 */
package com.clougence.clouddm.ds.kingbasees.definition.ui.ddl;
...
public class KingbaseESPostgreSQLConvertTableDDLSpi extends PgFamilyConvertTableDDLSpi {

    public KingbaseESPostgreSQLConvertTableDDLSpi(){
        targetList.add(DataSourceType.PostgreSQL);
        targetList.add(DataSourceType.Cloudberry);
        targetList.add(DataSourceType.KingbaseESPostgreSQL);
