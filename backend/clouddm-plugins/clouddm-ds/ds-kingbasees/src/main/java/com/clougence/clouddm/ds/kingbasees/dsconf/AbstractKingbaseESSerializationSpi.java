...
@Slf4j
public abstract class AbstractKingbaseESSerializationSpi implements SerializationService {

    private final ObjectMapper objectMapper;

    protected AbstractKingbaseESSerializationSpi(ClassLoader classLoader){
    ...
    public Object decode(String jsonData, Type tryType) {
        ...
        try {
            ...
            String msg = "Decode KingbaseES serialization data failed.";
            log.error(msg, e);
