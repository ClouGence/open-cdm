...
import com.clougence.clouddm.dsfamily.sqlserver.execute.MsSqlMetaService;
import com.clougence.clouddm.sdk.execute.session.Session;
import com.clougence.clouddm.sdk.execute.session.rdb.DmRdbUmiService;

public class KingbaseESSQLServerMetaService extends MsSqlMetaService {

    public KingbaseESSQLServerMetaService(Session session){
        super(session);
    }

    @Override
    protected DmRdbUmiService rdbUmiService(Connection connection) {
        return new KingbaseESSQLServerUmiServiceDm(connection);
    }
