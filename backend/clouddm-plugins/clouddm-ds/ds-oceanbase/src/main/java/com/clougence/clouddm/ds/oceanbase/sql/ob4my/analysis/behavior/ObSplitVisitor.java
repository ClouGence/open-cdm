...
public class ObSplitVisitor extends ObForMySqlParserBaseVisitor<StatementType> {
    public static final AbstractParseTreeVisitor<StatementType> INSTANCE = new ObSplitVisitor();
