...
public class ObForOracleSplitVisitor extends ObForOracleParserBaseVisitor<StatementType> {
    public static final AbstractParseTreeVisitor<StatementType> INSTANCE = new ObForOracleSplitVisitor();
