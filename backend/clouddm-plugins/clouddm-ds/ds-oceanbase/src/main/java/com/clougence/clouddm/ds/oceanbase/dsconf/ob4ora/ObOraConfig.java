...
public class ObOraConfig extends DataSourceConfig {
    // ------------------------------------------------------------------------------------------------------------------------ GENERAL
    @ConfigDef(group = DsConfigGroup.GENERAL, readOnly = false, name = Fields.tenant, descKey = ObConfigI18nKeys.CONFIG_OCEANBASE_TENANT_DESCRIPTION)
    private String  tenant;
    @ConfigDef(group = DsConfigGroup.GENERAL, readOnly = false, name = Fields.cluster, descKey = ObConfigI18nKeys.CONFIG_OCEANBASE_CLUSTER_DESCRIPTION)
