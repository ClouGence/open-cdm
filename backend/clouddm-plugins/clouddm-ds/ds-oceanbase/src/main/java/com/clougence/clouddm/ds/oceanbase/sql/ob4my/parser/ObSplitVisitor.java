...
public class ObSplitVisitor extends ObForMySqlParserBaseVisitor<SplitQueryType> {
    public static final AbstractParseTreeVisitor<SplitQueryType> INSTANCE = new ObSplitVisitor();
