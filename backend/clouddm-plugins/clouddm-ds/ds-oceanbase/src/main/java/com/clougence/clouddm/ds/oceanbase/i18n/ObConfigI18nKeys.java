...
public interface ObConfigI18nKeys extends ConfigI18nKey {
    ...
    String CONFIG_OCEANBASE_TENANT_DESCRIPTION  = "CONFIG_OCEANBASE_TENANT_DESCRIPTION";
    String CONFIG_OCEANBASE_CLUSTER_LABEL       = "CONFIG_OCEANBASE_CLUSTER_LABEL";
    String CONFIG_OCEANBASE_CLUSTER_DESCRIPTION = "CONFIG_OCEANBASE_CLUSTER_DESCRIPTION";
