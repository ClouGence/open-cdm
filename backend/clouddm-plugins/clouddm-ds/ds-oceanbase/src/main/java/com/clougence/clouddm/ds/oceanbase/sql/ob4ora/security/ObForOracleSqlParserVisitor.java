 ...
 */
package com.clougence.clouddm.ds.oceanbase.sql.ob4ora.security;

import static com.clougence.clouddm.ds.oceanbase.sql.parser.antlr.ObForOracleParser.*;
...
import com.clougence.sql.oracle.builder.OraBuilderFactory;
import com.clougence.sql.oracle.builder.enums.OraAttribute;
import com.clougence.sql.oracle.security.domain.OraColumnDomain;

public class ObForOracleSqlParserVisitor extends ObForOracleParserBaseVisitor<Void> {
