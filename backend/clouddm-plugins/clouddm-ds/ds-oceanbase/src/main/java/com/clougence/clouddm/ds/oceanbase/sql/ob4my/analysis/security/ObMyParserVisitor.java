 ...
 */
package com.clougence.clouddm.ds.oceanbase.sql.ob4my.analysis.security;

import static com.clougence.clouddm.ds.oceanbase.sql.parser.antlr.ObForMySqlParser.*;
...
public class ObMyParserVisitor extends ObForMySqlParserBaseVisitor<Void> {

    private final MyBuilderFactory builder;
