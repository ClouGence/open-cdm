...
public class DrConfig extends DataSourceConfig {
    ...
    @ConfigDef(group = DsConfigGroup.ADVANCED, readOnly = false, name = Fields.connectionCharset, defaultValue = "utf8", descKey = ConfigI18nKey.CONFIG_DORIS_CONN_CHARSET_DESCRIPTION)
    private String  connectionCharset;
    @ConfigDef(group = DsConfigGroup.ADVANCED, readOnly = false, name = Fields.useCursorFetch, descKey = ConfigI18nKey.CONFIG_DORIS_CONN_USE_CURSOR_FETCH)
