...
public class DrConfig extends DataSourceConfig {
    ...
    @ConfigDef(group = DsConfigGroup.ADVANCED, readOnly = false, name = Fields.connectionCharset, defaultValue = "utf8", descKey = DrConfigI18nKeys.CONFIG_RDB_CONN_CHARSET_DESCRIPTION)
