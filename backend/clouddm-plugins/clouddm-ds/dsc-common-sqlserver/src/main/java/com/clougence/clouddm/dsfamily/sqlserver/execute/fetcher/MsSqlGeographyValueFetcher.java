 ...
 */
package com.clougence.clouddm.dsfamily.sqlserver.execute.fetcher;
...
public class MsSqlGeographyValueFetcher extends StringAsClobFetcher {
    ...
    protected StringValueFCD fetchState(String columnName, ResultSet rs, ValueFetcherContext ctx) throws SQLException {
        ...
        if (ctx.getContext() == null || !(ctx.getContext() instanceof StringValueFCD)) {
            ...
            if (geometryBytes == null) {
                ...
                try {
                    com.microsoft.sqlserver.jdbc.Geography parse = com.microsoft.sqlserver.jdbc.Geography.deserialize(geometryBytes);
