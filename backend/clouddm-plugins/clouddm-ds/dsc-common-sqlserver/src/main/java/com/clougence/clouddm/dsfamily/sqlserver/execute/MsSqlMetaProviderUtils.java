...
public class MsSqlMetaProviderUtils {
    ...
    public static List<RdbTable> convertTables(ResultSet rs, String catalog, boolean isView, MainVersion mainVersion) throws SQLException {
    ...
    public static List<RdbForeignKey> convertForeignKey(ResultSet rs, String catalog, MainVersion mainVersion) throws SQLException {
    ...
    public static List<RdbColumn> convertColumn(ResultSet rs, String catalog, MainVersion mainVersion) throws SQLException {
