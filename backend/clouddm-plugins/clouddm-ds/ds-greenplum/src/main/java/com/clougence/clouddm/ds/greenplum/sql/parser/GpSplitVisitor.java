...
/** Greenplum management classification that must not affect PostgreSQL. */
public class GpSplitVisitor extends PgSplitVisitor {

    public GpSplitVisitor(PostgresVersion version){
        super(version);
    }
