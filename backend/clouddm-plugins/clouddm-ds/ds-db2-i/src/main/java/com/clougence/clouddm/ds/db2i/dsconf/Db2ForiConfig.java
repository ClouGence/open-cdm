...
import com.clougence.clouddm.ds.db2i.i18n.Db2ForiConfigI18nKeys;
...
public class Db2ForiConfig extends DataSourceConfig {
    ...
    @ConfigDef(name = Fields.defaultCatalog, //
            group = DsConfigGroup.GENERAL, labelKey = Db2ForiConfigI18nKeys.CONFIG_RDB_DEFAULT_DB_LABEL, descKey = Db2ForiConfigI18nKeys.CONFIG_RDB_DEFAULT_DB_DESC, readOnly = false)
    private String  defaultCatalog;
    // ------------------------------------------------------------------------------------------------------------------------ ADVANCED
    @ConfigDef(name = Fields.connectTimeoutMs, defaultValue = "5000", //
            group = DsConfigGroup.ADVANCED, labelKey = Db2ForiConfigI18nKeys.CONFIG_RDB_CONN_TIMEOUT_MS_LABEL, descKey = Db2ForiConfigI18nKeys.CONFIG_RDB_CONN_TIMEOUT_MS_DESC, readOnly = false)
    private Long    connectTimeoutMs;
    @ConfigDef(name = Fields.soTimeoutSec, defaultValue = "10", //
            group = DsConfigGroup.ADVANCED, labelKey = Db2ForiConfigI18nKeys.CONFIG_DS_SO_TIMEOUT_MS_LABEL, descKey = Db2ForiConfigI18nKeys.CONFIG_DS_SO_TIMEOUT_MS_DESC, readOnly = false)
