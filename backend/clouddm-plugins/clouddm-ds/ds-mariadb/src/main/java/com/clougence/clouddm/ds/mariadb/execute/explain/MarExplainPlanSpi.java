 ...
 */
package com.clougence.clouddm.ds.mariadb.execute.explain;
...
/** Parses MariaDB's own tabular EXPLAIN contract. */
public class MarExplainPlanSpi implements ExplainPlanSpi {
