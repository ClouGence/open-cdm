 ...
 */
package com.clougence.clouddm.ds.gauss.sql.gs.split;
...
public class GsSplitVisitor extends GaussSqlParserBaseVisitor<SecQueryType> {
    public static final AbstractParseTreeVisitor<SecQueryType> INSTANCE = new GsSplitVisitor();

    public GsSplitVisitor(){
    }
    ...
    public SecQueryType visitDropstmt(DropstmtContext ctx) {
        ...
        if (dropContext instanceof TerminalNodeImpl childNode) {
