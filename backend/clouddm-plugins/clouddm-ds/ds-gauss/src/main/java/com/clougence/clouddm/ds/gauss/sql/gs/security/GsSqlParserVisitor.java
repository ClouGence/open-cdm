 ...
 */
package com.clougence.clouddm.ds.gauss.sql.gs.security;

import static com.clougence.clouddm.ds.gauss.sql.gs.parser.antlr.GaussSqlParser.*;
...
import com.clougence.clouddm.ds.gauss.sql.gs.parser.antlr.GaussSqlParserBaseVisitor;
...
import com.clougence.sql.postgres.builder.PgBuilderFactory;
import com.clougence.sql.postgres.builder.enums.PgAttribute;
import com.clougence.sql.postgres.security.domain.PgTableDomain;

public class GsSqlParserVisitor extends GaussSqlParserBaseVisitor<Void> {
