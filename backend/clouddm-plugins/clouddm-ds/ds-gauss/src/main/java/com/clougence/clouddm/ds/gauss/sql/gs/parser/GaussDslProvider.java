 ...
 */
package com.clougence.clouddm.ds.gauss.sql.gs.parser;
...
import com.clougence.clouddm.ds.gauss.sql.gs.parser.antlr.GaussSqlLexer;
import com.clougence.clouddm.ds.gauss.sql.gs.parser.antlr.GaussSqlParser;
...
public class GaussDslProvider implements DslProvider {
    ...
    @Override
    public String[] getDslName() { return new String[] { GsSqlEngineSpi.NAME }; }
