 ...
 */
package com.clougence.clouddm.ds.gauss.sql.analysis.security;
...
public class GaussSqlParserVisitor extends GaussSqlParserBaseVisitor<Void> {

    private final PgBuilderFactory builder;
    private final Parser           parser;

    public GaussSqlParserVisitor(PgBuilderFactory builder, Parser parser){
