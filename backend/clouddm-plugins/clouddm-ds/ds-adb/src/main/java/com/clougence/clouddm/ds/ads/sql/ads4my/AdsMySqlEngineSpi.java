...
import com.clougence.clouddm.ds.ads.sql.ads4my.rewrite.AdbRewriteSpi;
...
public class AdsMySqlEngineSpi implements SqlEngineSpi {
    ...
    static {
        DslHelper.register(AdsMyDslProvider.INSTANCE);
    }
    ...
    public AdsMySqlEngineSpi(MetaService metaService){
        ...
        this.resAnalysisSpi = new AdsMyResAnalysisSpi(metaService);
