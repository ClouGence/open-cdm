 ...
 */
package com.clougence.clouddm.ds.ads.sql.ads4my.security;
...
public class AdsMySecDomainResolveSpi extends MySecDomainResolveSpi {

    public AdsMySecDomainResolveSpi(MetaService metaService){
        super(metaService);
    }
