...
public class AdsMySplitVisitor extends AdsMyParserBaseVisitor<StatementType> {

    public static final AbstractParseTreeVisitor<StatementType> INSTANCE = new AdsMySplitVisitor();
    ...
    @Override
    public StatementType visitAdbExternalTable(AdbExternalTableContext ctx) {
        return StatementType.CREATE_TABLE;
    }
