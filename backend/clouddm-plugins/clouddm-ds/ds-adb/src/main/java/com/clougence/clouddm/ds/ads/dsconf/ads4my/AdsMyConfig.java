...
public class AdsMyConfig extends DataSourceConfig {
    ...
    @ConfigDef(group = DsConfigGroup.ADVANCED, readOnly = false, name = Fields.connectionCharset, defaultValue = "utf8", descKey = ConfigI18nKey.CONFIG_ADSMYSQL_CONN_CHARSET_DESCRIPTION)
    private String  connectionCharset;
    @ConfigDef(group = DsConfigGroup.ADVANCED, readOnly = false, name = Fields.useCursorFetch, descKey = ConfigI18nKey.CONFIG_ADSMYSQL_CONN_USE_CURSOR_FETCH)
