...
public class PorXConfig extends DataSourceConfig {
    ...
    @ConfigDef(name = Fields.connectionCharset, defaultValue = "utf8", descKey = ConfigI18nKey.CONFIG_POLARDBX_CONN_CHARSET_DESCRIPTION, readOnly = false)
    private String  connectionCharset;
    @ConfigDef(name = Fields.useCursorFetch, valueRequire = false, descKey = ConfigI18nKey.CONFIG_POLARDBX_CONN_USE_CURSOR_FETCH, readOnly = false, valueAdvance = "true - false", group = DsConfigGroup.OPTIONS)
