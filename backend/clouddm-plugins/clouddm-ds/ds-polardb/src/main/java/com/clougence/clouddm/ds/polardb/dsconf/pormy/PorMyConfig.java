...
public class PorMyConfig extends DataSourceConfig {
    ...
    @ConfigDef(name = Fields.connectionCharset, defaultValue = "utf8", descKey = ConfigI18nKey.CONFIG_POLARDBMYSQL_CONN_CHARSET_DESCRIPTION, readOnly = false)
    private String  connectionCharset;
    @ConfigDef(name = Fields.useCursorFetch, valueRequire = false, descKey = ConfigI18nKey.CONFIG_POLARDBMYSQL_CONN_USE_CURSOR_FETCH, readOnly = false, valueAdvance = "true - false", group = DsConfigGroup.OPTIONS)
