...
@Slf4j
public abstract class AbstractGoldenDBSerializationSpi implements SerializationService {

    private final ObjectMapper objectMapper;

    protected AbstractGoldenDBSerializationSpi(ClassLoader classLoader){
    ...
    public Object decode(String jsonData, Type tryType) {
        ...
        try {
            ...
            String msg = "Decode GoldenDB serialization data failed.";
            log.error(msg, e);
