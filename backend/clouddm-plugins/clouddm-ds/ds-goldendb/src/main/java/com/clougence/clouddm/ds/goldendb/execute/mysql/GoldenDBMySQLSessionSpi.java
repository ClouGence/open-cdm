...
public class GoldenDBMySQLSessionSpi extends MySessionSpi {

    @Override
    public SessionContextDTO createSessionContext(DataSourceConfig dsConfig, Map<String, Object> params) {
        SessionContextDTO context = super.createSessionContext(dsConfig, params);
        context.setRdbTxIsolation(RdbIsolation.READ_COMMITTED);
        return context;
    }
}
