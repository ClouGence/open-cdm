 ...
 */
package com.clougence.clouddm.dsfamily.oracle.resource;
...
public class OraEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public OraEditorResourceSpi(ClassLoader loader){
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/oracle.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
