 ...
 */
package com.clougence.clouddm.dsfamily.oracle.definition.ui.editor.trigger;
...
public class OraTriggerEditorUiPanelFactory extends DsFamilyTriggerEditorUiPanelFactory implements OraTriggerEditorFields {
    ...
    protected List<ValueDef> fetchTriggerEvents() {
        ...
        UiPanelField columnList = UiPanelField.builder()
            ...
            .titleI18N(Ora18nKeys.EDITOR_TRIGGER_UPDATE_COLUMNS_TITLE)
            .descI18N(Ora18nKeys.EDITOR_TRIGGER_UPDATE_COLUMNS_DESC)
            .build();
    ...
    protected List<ValueDef> fetchTriggerTimes() {
        List<ValueDef> result = new ArrayList<>();
        result.add(fieldOptionDef(Ora18nKeys.EDITOR_TRIGGER_TIME_BEFORE_LABEL, "before"));
    ...
    private List<ValueDef> fetchGranularity() {
        ...
        result.add(fieldOptionDef(Ora18nKeys.EDITOR_TRIGGER_TRIGGER_GRANULARITY_ROW_LABEL, "row")
            .addField(UiPanelField.builder()
                .field(NEW_ALIAS)
                .type(UiPanelFieldType.Input)
                .titleI18N(Ora18nKeys.EDITOR_TRIGGER_NEW_ALIAS_TITLE)
                .descI18N(Ora18nKeys.EDITOR_TRIGGER_NEW_ALIAS_DESC)
                .build())
            .addField(UiPanelField.builder()
                .field(OLD_ALIAS)
                .type(UiPanelFieldType.Input)
                .titleI18N(Ora18nKeys.EDITOR_TRIGGER_OLD_ALIAS_TITLE)
                .descI18N(Ora18nKeys.EDITOR_TRIGGER_OLD_ALIAS_DESC)
                .build())
            .addField(UiPanelField.builder()
                .field(CONDITION)
                .type(UiPanelFieldType.Input)
                ...
                .build()));
        result.add(fieldOptionDef(Ora18nKeys.EDITOR_TRIGGER_TRIGGER_GRANULARITY_STATEMENT_LABEL, "statement"));
        return result;
    }
}
