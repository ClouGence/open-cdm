 ...
 */
package com.clougence.clouddm.dsfamily.oracle.definition.ui.editor.view;
...
public class OraMaterializedViewPropertyUiPanelFactory extends DsFamilyViewPropertyUiPanelFactory implements OraViewEditorFields {
    ...
    protected List<UiPanelField> fillBaseInfoItem(DataSourceConfig dsConfig) {
        ...
        fields.add(UiPanelField.builder()
            ...
            .build());
        fields.add(UiPanelField.builder()
            .field(MVIEW_REFRESH_DATE)
            .type(UiPanelFieldType.MapItem)
            .titleI18N(Ora18nKeys.EDITOR_MVIEW_REFRESH_DATE_TITLE)
            .descI18N(Ora18nKeys.EDITOR_MVIEW_REFRESH_DATE_DESC)
            .readOnly(true)
            .build());
        fields.add(UiPanelField.builder()
            .field(MVIEW_REFRESH_END_TIME)
            .type(UiPanelFieldType.MapItem)
            .titleI18N(Ora18nKeys.EDITOR_MVIEW_REFRESH_END_TIME_TITLE)
            .descI18N(Ora18nKeys.EDITOR_MVIEW_REFRESH_END_TIME_DESC)
            .readOnly(true)
            .build());
        fields.add(UiPanelField.builder()
            .field(SQL)
