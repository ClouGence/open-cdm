 ...
 */
package com.clougence.clouddm.ds.kafka.resource;
...
public class KafkaEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public KafkaEditorResourceSpi(ClassLoader loader){
        this.resourceLoader = new ClassPathResourceLoader(Objects.requireNonNull(loader, "loader"), "");
    }

    @Override
    public String name() {
        return DataSourceType.Kafka.name();
    }
    ...
    public ResourceObject findResource(String category, String resourcePath, ResourceRequest request) {
        ...
        if ("keywords".equals(resourcePath)) {
            return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/kafka.keywords", "text/plain;charset=UTF-8", true, true);
        }
        return null;
    }
}
