...
import com.clougence.clouddm.ds.db2zos.i18n.Db2ForZosConfigI18nKeys;
...
public class Db2ForZosConfig extends DataSourceConfig {
    ...
    @ConfigDef(name = Fields.soTimeoutSec, defaultValue = "10", //
            group = DsConfigGroup.ADVANCED, labelKey = Db2ForZosConfigI18nKeys.CONFIG_DS_SO_TIMEOUT_MS_LABEL, descKey = Db2ForZosConfigI18nKeys.CONFIG_DS_SO_TIMEOUT_MS_DESC, readOnly = false)
