 ...
 */
package com.clougence.clouddm.ds.maxcompute.sql.column;

import com.clougence.clouddm.ds.maxcompute.sql.security.McSQLParserVisitor;
...
public class McSelectColumnAnalysisSpi extends AbstractSelectColumnAnalysisSpi {
    ...
    public McSelectColumnAnalysisSpi(MetaService metaService){
        super(metaService);
    }
    ...
    public List<SelectItem> parseSelectColumn(String script, ContextInfo contextInfo) {
        McConfig mcConfig = (McConfig) contextInfo.getDataSourceConfig();
