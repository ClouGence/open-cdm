...
public interface McConfigI18nKeys extends ConfigI18nKey {
    ...
    String CONFIG_MC_PROJECT_DESC           = "CONFIG_MC_PROJECT_DESC";
    ...
    String CONFIG_MC_INTERACTIVE_MODE_DESC  = "CONFIG_MC_INTERACTIVE_MODE_DESC";
    String CONFIG_MC_SDK_ENDPOINT_LABEL     = "CONFIG_MC_SDK_ENDPOINT_LABEL";
    String CONFIG_MC_SDK_ENDPOINT_DESC      = "CONFIG_MC_SDK_ENDPOINT_DESC";
    String CONFIG_MC_SCHEMA_STYLE_LABEL     = "CONFIG_MC_SCHEMA_STYLE_LABEL";
    String CONFIG_MC_SCHEMA_STYLE_DESC      = "CONFIG_MC_SCHEMA_STYLE_DESC";
    String CONFIG_MC_DEFAULT_SCHEMA_DESC    = "CONFIG_MC_DEFAULT_SCHEMA_DESC";
}
