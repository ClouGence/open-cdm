...
public class OrderGroupByColumnCompletionStrategy extends AbstractColumnCompletionStrategy {
    ...
    public boolean match(CompletionContext context) {
        ...
        return "by".equalsIgnoreCase(previous) &&//
               ("order".equalsIgnoreCase(beforePrevious) || "group".equalsIgnoreCase(beforePrevious));
    }
