 ...
 */
package com.clougence.clouddm.ds.cockroachdb.definition.secrules;
...
public class CrdbSecRulesSupportSpi implements SecRulesSupportSpi {
    ...
    public List<TargetType> exactRangeForQuery() {
        return Arrays.asList(TargetType.Catalog, TargetType.Schema, TargetType.Table, TargetType.View, TargetType.Materialized);
    }
    ...
    public List<TargetType> exactRangeForSen() {
        return Arrays.asList(TargetType.Catalog, TargetType.Schema, TargetType.Table, TargetType.View, TargetType.Materialized, TargetType.Column);
    }
