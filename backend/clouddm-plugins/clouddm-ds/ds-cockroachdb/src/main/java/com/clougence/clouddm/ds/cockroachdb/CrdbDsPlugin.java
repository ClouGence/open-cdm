...
import com.clougence.clouddm.ds.cockroachdb.definition.secrules.CrdbSecRulesSupportSpi;
import com.clougence.clouddm.ds.cockroachdb.definition.ui.ddl.CrdbConvertTableDDLSpi;
import com.clougence.clouddm.ds.cockroachdb.dsconf.CrdbConfigSpi;
import com.clougence.clouddm.ds.cockroachdb.dsconf.CrdbSerializationSpi;
import com.clougence.clouddm.ds.cockroachdb.execute.CrdbSessionFactory;
import com.clougence.clouddm.ds.cockroachdb.i18n.CrdbDsI18nKeys;
import com.clougence.clouddm.ds.cockroachdb.resource.CrdbEditorResourceSpi;
...
@Plugin(name = "i18n::" + CrdbDsI18nKeys.PLUGIN_NAME_COCKROACHDB,               //
        includePackages = { "com.clougence.clouddm.dsfamily.execute.*",         //
                            "com.clougence.clouddm.dsfamily.postgres.execute.*",//
                            "com.clougence.clouddm.ds.cockroachdb.execute.*"    //
        }, dsProduct = DataSourceType.CockroachDB)
public class CrdbDsPlugin implements DsPlugin, SchemaPlugin, DsFeatureIDs {
    ...
    public void init(SchemaBinder binder) {
        ...
        TypeMapUtils.addColumnTypes(DataSourceType.CockroachDB, PostgresTypes.values());
    }
    ...
    private void configBasic(DsPluginBinder dsPlugin) {
        dsPlugin.addPluginSpi(new CrdbConfigSpi());
        dsPlugin.addPluginSpi(new CrdbSerializationSpi(dsPlugin.getPluginClassLoader()));
    }
    ...
    private void configUi(DsPluginBinder dsPlugin) {
        dsPlugin.bindPluginI18n(CrdbDsI18nKeys.class);
        ...
        dsPlugin.addPluginSpi(new CrdbDefService());
        ...
        dsPlugin.addPluginSpi(new CrdbConvertTableDDLSpi());
    ...
    private void configEditor(DsPluginBinder dsPlugin) {
        ...
        dsPlugin.addPluginSpi(new CrdbEditorResourceSpi(dsPlugin.getPluginClassLoader()));
    }

    private void configTeam(DsPluginBinder dsPlugin) {
        dsPlugin.addPluginSpi(new CrdbSecRulesSupportSpi());
    }
