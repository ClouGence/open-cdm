...
@Slf4j
public class CrdbSerializationSpi implements SerializationService {

    public static final String PROVIDER_NAME = "CockroachDB";
    private final ObjectMapper objectMapper;

    public CrdbSerializationSpi(ClassLoader classLoader){
    ...
    public Object decode(String jsonData, Type tryType) {
        try {
            ...
            String msg = "decode CockroachDB datasource config failed";
            log.error(msg, e);
