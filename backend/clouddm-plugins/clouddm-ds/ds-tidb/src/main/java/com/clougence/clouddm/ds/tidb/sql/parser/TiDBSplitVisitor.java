...
public class TiDBSplitVisitor extends TiDBParserBaseVisitor<SplitQueryType> {
    ...
    private void collectNode(ParseTree tree) {
        ...
        if (tree instanceof AlterTableContext ctx) {
            ...
            if (ctx.updateIndexesClause() != null) {
                this.types.add(SplitQueryType.ALTER_PARTITION);
                this.types.add(SplitQueryType.ALTER_INDEX);
            }
        }
    }
    ...
    private void collectDirectActions(ParseTree tree) {
        ...
        if (tree instanceof SelectStatementContext && containsDataExport(tree)) {
            ...
            this.types.add(SplitQueryType.ADMIN_PARTITION);
    ...
    @Override
    public SplitQueryType visitCreateSequence(CreateSequenceContext ctx) {
    ...
    @Override
    public SplitQueryType visitDropSequence(DropSequenceContext ctx) {
    ...
    @Override
    public SplitQueryType visitTidbAdminStatement(TidbAdminStatementContext ctx) {
    ...
    @Override
    public SplitQueryType visitTidbBindingStatement(TidbBindingStatementContext ctx) {
        return SplitQueryType.ADMIN_PERFORMANCE;
    }
    ...
    @Override
    public SplitQueryType visitQueryWatchStatement(QueryWatchStatementContext ctx) {
        return SplitQueryType.ADMIN_RESOURCE_GROUP;
    }

    @Override
    public SplitQueryType visitPlanReplayerStatement(PlanReplayerStatementContext ctx) {
        return SplitQueryType.ADMIN_PERFORMANCE;
    }

    @Override
    public SplitQueryType visitTidbStatsStatement(TidbStatsStatementContext ctx) {
        return SplitQueryType.ADMIN_PERFORMANCE;
    }
    ...
    @Override
    public SplitQueryType visitFlashbackStatement(FlashbackStatementContext ctx) {
        return ctx.TABLE() == null ? SplitQueryType.ADMIN : SplitQueryType.ADMIN_TABLE;
    }
    ...
    @Override
    public SplitQueryType visitCancelDistributionJobStatement(CancelDistributionJobStatementContext ctx) {
        return SplitQueryType.ADMIN_JOB;
    }

    @Override
    public SplitQueryType visitDistributeTableStatement(DistributeTableStatementContext ctx) {
        return SplitQueryType.ADMIN_TABLE;
    }

    @Override
    public SplitQueryType visitCompactTableStatement(CompactTableStatementContext ctx) {
        return SplitQueryType.ADMIN_TABLE;
    }

    @Override
    public SplitQueryType visitAlterRangeStatement(AlterRangeStatementContext ctx) {
        return SplitQueryType.ALTER_POLICY;
    }
    ...
    @Override
    public SplitQueryType visitSplitSyntaxOption(SplitSyntaxOptionContext ctx) {
        return ctx.PARTITION() == null ? null : SplitQueryType.ADMIN_PARTITION;
    }

    @Override
    public SplitQueryType visitSplitPartitionNames(SplitPartitionNamesContext ctx) {
    ...
    @Override
    public SplitQueryType visitImportIntoPath(ImportIntoPathContext ctx) {
        return SplitQueryType.DATA_IMPORT;
    }

    @Override
    public SplitQueryType visitImportIntoSelect(ImportIntoSelectContext ctx) {
        return SplitQueryType.INSERT;
    }

    @Override
    public SplitQueryType visitCancelImportJobStatement(CancelImportJobStatementContext ctx) {
        return SplitQueryType.ADMIN_JOB;
    }

    @Override
    public SplitQueryType visitDropLoadDataJob(DropLoadDataJobContext ctx) {
        return SplitQueryType.DROP_JOB;
    }

    @Override
    public SplitQueryType visitAdminLoadDataJob(AdminLoadDataJobContext ctx) {
        return SplitQueryType.ADMIN_JOB;
    }

    @Override
    public SplitQueryType visitLegacyCreateImportStatement(LegacyCreateImportStatementContext ctx) {
        return SplitQueryType.DATA_IMPORT;
    }

    @Override
    public SplitQueryType visitLegacyAlterImportStatement(LegacyAlterImportStatementContext ctx) {
        return SplitQueryType.ADMIN;
    }

    @Override
    public SplitQueryType visitLegacyDropImportStatement(LegacyDropImportStatementContext ctx) {
        return SplitQueryType.ADMIN;
    }

    @Override
    public SplitQueryType visitLegacyResumeImportStatement(LegacyResumeImportStatementContext ctx) {
        return SplitQueryType.ADMIN;
    }

    @Override
    public SplitQueryType visitLegacyStopImportStatement(LegacyStopImportStatementContext ctx) {
        return SplitQueryType.ADMIN;
    }

    @Override
    public SplitQueryType visitLegacyPurgeImportStatement(LegacyPurgeImportStatementContext ctx) {
        return SplitQueryType.ADMIN;
    }

    @Override
    public SplitQueryType visitLegacyShowImportStatement(LegacyShowImportStatementContext ctx) {
        return SplitQueryType.METADATA;
    }

    @Override
    public SplitQueryType visitLegacyChangePumpStatement(LegacyChangePumpStatementContext ctx) {
    ...
    @Override
    public SplitQueryType visitNonTransactionalDmlStatement(NonTransactionalDmlStatementContext ctx) {
        return ctx.nonTransactionalDryRun() == null ? null : SplitQueryType.PERFORMANCE;
    }

    @Override
    public SplitQueryType visitTrafficCapture(TrafficCaptureContext ctx) {
        return SplitQueryType.DATA_EXPORT;
    }

    @Override
    public SplitQueryType visitTrafficReplay(TrafficReplayContext ctx) {
        return SplitQueryType.DATA_IMPORT;
    }

    @Override
    public SplitQueryType visitTrafficReplaySource(TrafficReplaySourceContext ctx) {
        return SplitQueryType.UNSAFE;
    }

    @Override
    public SplitQueryType visitTrafficShowJobs(TrafficShowJobsContext ctx) {
        return SplitQueryType.ADMIN;
    }

    @Override
    public SplitQueryType visitTrafficCancelJobs(TrafficCancelJobsContext ctx) {
        return SplitQueryType.ADMIN_JOB;
    }
    ...
    @Override
    public SplitQueryType visitCalibrateResourceStatement(CalibrateResourceStatementContext ctx) {
        return SplitQueryType.ADMIN_RESOURCE_GROUP;
    }

    @Override
    public SplitQueryType visitCreateStatisticsStatement(CreateStatisticsStatementContext ctx) {
        return SplitQueryType.ADMIN_PERFORMANCE;
    }

    @Override
    public SplitQueryType visitDropStatisticsStatement(DropStatisticsStatementContext ctx) {
        return SplitQueryType.ADMIN_PERFORMANCE;
    }

    @Override
    public SplitQueryType visitRecommendIndexStatement(RecommendIndexStatementContext ctx) {
        return SplitQueryType.ADMIN_PERFORMANCE;
    }

    @Override
    public SplitQueryType visitFlushStatsDeltaStatement(FlushStatsDeltaStatementContext ctx) {
        return SplitQueryType.ADMIN_PERFORMANCE;
    }
    ...
    @Override
    public SplitQueryType visitEmptyCreateTable(EmptyCreateTableContext ctx) {
        return SplitQueryType.CREATE_TABLE;
    }
    ...
    public SplitQueryType visitFullDescribeStatement(FullDescribeStatementContext ctx) {
        if (ctx.analyze != null) {
            return ctx.describeObjectClause() == null ? SplitQueryType.PERFORMANCE : firstNestedStatement(ctx.describeObjectClause(), false);
        }
        return SplitQueryType.PERFORMANCE;
    }
    ...
    @Override
    public SplitQueryType visitSelectIntoDumpFile(SelectIntoDumpFileContext ctx) {
        return SplitQueryType.DATA_EXPORT;
    }

    @Override
    public SplitQueryType visitSelectIntoTextFile(SelectIntoTextFileContext ctx) {
        return SplitQueryType.DATA_EXPORT;
    }

    @Override
    public SplitQueryType visitSelectIntoRemoteFile(SelectIntoRemoteFileContext ctx) {
        return SplitQueryType.DATA_EXPORT;
    }

    @Override
    public SplitQueryType visitSelectIntoRemoteParameters(SelectIntoRemoteParametersContext ctx) {
        return SplitQueryType.DATA_EXPORT;
    }
    ...
    @Override
    public SplitQueryType visitShowSessionBindings(ShowSessionBindingsContext ctx) {
        return SplitQueryType.METADATA;
    }
    ...
    @Override
    public SplitQueryType visitAlterByStatsExtended(AlterByStatsExtendedContext ctx) {
        return SplitQueryType.ADMIN_PERFORMANCE;
    }
