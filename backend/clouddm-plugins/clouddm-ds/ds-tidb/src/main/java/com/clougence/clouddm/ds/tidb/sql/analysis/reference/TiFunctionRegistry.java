...
public final class TiFunctionRegistry {
    private static final Set<String> EXTENSIONS = Set
        .of("PASSWORD", "CURRENT_RESOURCE_GROUP", "JSON_SUM_CRC32", "APPROX_COUNT_DISTINCT", "APPROX_PERCENTILE", "EMBED_TEXT", "LASTVAL", "NEXTVAL", "SETVAL", "TIDB_BOUNDED_STALENESS", "TIDB_CURRENT_TSO", "TIDB_DECODE_BASE64_KEY", "TIDB_DECODE_BINARY_PLAN", "TIDB_DECODE_KEY", "TIDB_DECODE_PLAN", "TIDB_DECODE_SQL_DIGESTS", "TIDB_ENCODE_INDEX_KEY", "TIDB_ENCODE_RECORD_KEY", "TIDB_ENCODE_SQL_DIGEST", "TIDB_IS_DDL_OWNER", "TIDB_MVCC_INFO", "TIDB_PARSE_TSO", "TIDB_PARSE_TSO_LOGICAL", "TIDB_ROW_CHECKSUM", "TIDB_SHARD", "TIDB_VERSION", "VEC_AS_TEXT", "VEC_COSINE_DISTANCE", "VEC_DIMS", "VEC_EMBED_COSINE_DISTANCE", "VEC_EMBED_L2_DISTANCE", "VEC_FROM_TEXT", "VEC_L1_DISTANCE", "VEC_L2_DISTANCE", "VEC_L2_NORM", "VEC_NEGATIVE_INNER_PRODUCT");
