...
public class CbSplitAnalysisSpi extends PgSplitAnalysisSpi {
    ...
    protected PgSplitVisitor newSplitVisitor() {
        return new CbSplitVisitor(version());
    }
    ...
    public static SplitQueryType classify(CbSqlParser.StatementContext statement) {
