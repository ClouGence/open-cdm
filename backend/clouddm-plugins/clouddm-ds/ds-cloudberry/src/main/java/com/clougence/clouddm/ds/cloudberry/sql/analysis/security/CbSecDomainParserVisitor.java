...
final class CbSecDomainParserVisitor extends PgSqlParserVisitor {

    private final PgBuilderFactory builder;
    private final Parser           parser;

    CbSecDomainParserVisitor(PgBuilderFactory builder, Parser parser){
    ...
    private void visitProtocolPrivilege(CbSqlParser.Protocol_privilege_stmtContext ctx) {
    ...
    private void visitRole(CbSqlParser.Role_stmtContext ctx) {
    ...
    private void visitProtocol(CbSqlParser.Protocol_stmtContext ctx) {
    ...
    private void visitExternal(CbSqlParser.External_stmtContext ctx) {
        ...
        setAction(table, ctx.CREATE() != null, ctx.ALTER() != null, RuleQueryType.CREATE_TABLE, RuleQueryType.ADD_COLUMN, RuleQueryType.DROP_TABLE);
    ...
    private void visitResource(CbSqlParser.Resource_stmtContext ctx) {
