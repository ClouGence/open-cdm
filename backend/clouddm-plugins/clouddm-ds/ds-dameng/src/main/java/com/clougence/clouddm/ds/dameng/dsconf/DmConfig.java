...
public class DmConfig extends DataSourceConfig implements//
    ...
    @ConfigDef(name = Fields.connectTimeoutMs, defaultValue = "5000", //
            group = DsConfigGroup.ADVANCED, labelKey = DmConfigI18nKeys.CONFIG_RDB_CONN_TIMEOUT_MS_LABEL, descKey = DmConfigI18nKeys.CONFIG_RDB_CONN_TIMEOUT_MS_DESC, readOnly = false)
    private Long    connectTimeoutMs;
    @ConfigDef(name = Fields.soTimeoutSec, defaultValue = "10", //
            group = DsConfigGroup.ADVANCED, labelKey = DmConfigI18nKeys.CONFIG_DS_SO_TIMEOUT_MS_LABEL, descKey = DmConfigI18nKeys.CONFIG_DS_SO_TIMEOUT_MS_DESC, readOnly = false)
    ...
    public Properties asDriverProperties() {
        ...
        properties.setProperty(DsConfigKeys.DEFAULT_DATABASE.getConfigKey(), safeStr(getDefaultSchema()));
