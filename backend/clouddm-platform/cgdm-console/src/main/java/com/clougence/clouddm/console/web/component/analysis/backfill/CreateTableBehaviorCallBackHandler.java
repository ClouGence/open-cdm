...
@Component
public class CreateTableBehaviorCallBackHandler extends AbstractBehaviorCallBackHandler {

    @Override
    public void backfill(DmExecSqlAuditDO audit, List<BehaviorRelation> behaviors) {
        for (String tablePath : affectedPaths(behaviors, TargetType.Table, BehaviorAction.CREATE)) {
