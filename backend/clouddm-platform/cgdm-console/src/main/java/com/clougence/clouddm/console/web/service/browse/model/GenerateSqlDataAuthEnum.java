...
public enum GenerateSqlDataAuthEnum {
    ...
    MENU_BROWSE_TRIGGER_CREATE(DsFeatureIDs.MENU_BROWSE_TRIGGER_CREATE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    MENU_BROWSE_TRIGGER_DROP(DsFeatureIDs.MENU_BROWSE_TRIGGER_DROP, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_PROCEDURE_DROP(DsFeatureIDs.MENU_BROWSE_PROCEDURE_DROP, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_FUNCTION_DROP(DsFeatureIDs.MENU_BROWSE_FUNCTION_DROP, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_FUNCTION_ALTER(DsFeatureIDs.MENU_BROWSE_FUNCTION_ALTER, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_FUNCTION_CREATE(DsFeatureIDs.MENU_BROWSE_FUNCTION_CREATE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    MENU_BROWSE_FUNCTION_COMPILE(DsFeatureIDs.MENU_BROWSE_FUNCTION_COMPILE, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    ...
    MENU_BROWSE_TRIGGER_ALTER(DsFeatureIDs.MENU_BROWSE_TRIGGER_ALTER, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_TRIGGER_COMPILE(DsFeatureIDs.MENU_BROWSE_TRIGGER_COMPILE, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_PROCEDURE_CREATE(DsFeatureIDs.MENU_BROWSE_PROCEDURE_CREATE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    MENU_BROWSE_PROCEDURE_ALTER(DsFeatureIDs.MENU_BROWSE_PROCEDURE_ALTER, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_PROCEDURE_COMPILE(DsFeatureIDs.MENU_BROWSE_PROCEDURE_COMPILE, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_DBLINK_CREATE(DsFeatureIDs.MENU_BROWSE_DBLINK_CREATE, SecDataAuthLabel.DM_DAUTH_DCL, true),
    MENU_BROWSE_DBLINK_DROP(DsFeatureIDs.MENU_BROWSE_DBLINK_DROP, SecDataAuthLabel.DM_DAUTH_DCL, true),
    MENU_BROWSE_DBLINK_TEST(DsFeatureIDs.MENU_BROWSE_DBLINK_TEST, SecDataAuthLabel.DM_DAUTH_DCL, true),
    MENU_BROWSE_JOB_CREATE(DsFeatureIDs.MENU_BROWSE_JOB_CREATE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    MENU_BROWSE_JOB_ALTER(DsFeatureIDs.MENU_BROWSE_JOB_ALTER, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_JOB_DROP(DsFeatureIDs.MENU_BROWSE_JOB_DROP, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_JOB_DISABLE(DsFeatureIDs.MENU_BROWSE_JOB_DISABLE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    MENU_BROWSE_JOB_ENABLE(DsFeatureIDs.MENU_BROWSE_JOB_ENABLE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    MENU_BROWSE_JOB_RUN(DsFeatureIDs.MENU_BROWSE_JOB_RUN, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_SCHEDULE_DROP(DsFeatureIDs.MENU_BROWSE_SCHEDULE_DROP, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_SCHEDULE_ENABLE(DsFeatureIDs.MENU_BROWSE_SCHEDULE_ENABLE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    MENU_BROWSE_SCHEDULE_DISABLE(DsFeatureIDs.MENU_BROWSE_SCHEDULE_DISABLE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    MENU_BROWSE_SCHEDULE_RUN(DsFeatureIDs.MENU_BROWSE_SCHEDULE_RUN, SecDataAuthLabel.DM_DAUTH_PROGRAM, true),
    MENU_BROWSE_SCHEDULE_CREATE(DsFeatureIDs.MENU_BROWSE_SCHEDULE_CREATE, SecDataAuthLabel.DM_DAUTH_PROGRAM, false),
    //
