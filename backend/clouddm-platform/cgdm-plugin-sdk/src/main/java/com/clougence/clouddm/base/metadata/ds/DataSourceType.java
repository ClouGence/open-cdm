...
public enum DataSourceType {
    ...
    KingbaseESPostgreSQL("kespg", "KingbaseESPostgreSQL", 0, 75),
    KingbaseESMySQL("kesmy", "KingbaseESMySQL", 0, 76),
    KingbaseESOracle("kesora", "KingbaseESOracle", 0, 77),
    ...
    Db2("db2", "Db2", 0, 110),
    Db2Fori("db24i", "Db2Fori", 0, 120),
    Hana("hana", "Hana", 0, 130),
    GaussDBForOpenGauss("gsog", "GaussDBForOpenGauss", 0, 140),
    GaussDB("gs", "GaussDB", 0, 150),
    PolarDbMySQL("pom", "PolarDbMySQL", 0, 160),
    PolarDbX("pox", "PolarDbX", 0, 170),
    PolarDBPg("popg", "PolarDBPg", 0, 180),
