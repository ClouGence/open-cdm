...
public class OraSecDomainResolve4ConstraintTest extends OraSecDomainTestSupport {

    public OraSecDomainResolve4ConstraintTest(){
    ...
    @Test
    public void alterTableAddPrimaryKey_2() {
        String sql = "alter table \"user_table\" add primary key (\"id\");";
    ...
    @Test
    public void alterTableAddPrimaryKey_3() {
        String sql = "alter table \"test\".\"user_table\" add primary key (\"id\");";
