...
public class MySecDomainResolve4QueryJoin1Test extends MySecDomainTestSupport {

    public MySecDomainResolve4QueryJoin1Test(){
    ...
    public void naturalJoinQuery_3() {
        ...
        assert domainList.size() == 1;
        {
            ...
            assert !domain1_1.isHasWhere() &&      //
                   !domain1_1.isSelectInWhere() && //
                   domain1_1.getOptions().get(MySecDomainOptionKeys.OPT_JOIN_NATURAL).equals("true") &&//
                   !domain1_1.isHasUnion() &&      //
                   !domain1_1.isHasWith();
            assert !domain1_1.isHasLimit();
        }
