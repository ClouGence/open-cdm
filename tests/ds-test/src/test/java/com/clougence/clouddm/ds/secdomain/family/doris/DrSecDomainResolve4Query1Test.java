...
import com.clougence.sql.doris.security.domain.DrSelectDomain;
...
public class DrSecDomainResolve4Query1Test extends DrSecDomainTestSupport {

    public DrSecDomainResolve4Query1Test(){
    ...
    public void selectValues_1() {
        ...
        assert domainList.size() == 1;
        {
            ...
            assert !domain1.isHasWhere() &&      //
                   ...
                   !domain1.isHasUnion() &&      //
                   !domain1.isHasWith();
            assert !domain1.isHasLimit() && domain1.isValuesSelect();
        }
    }

    @Test(expected = UnsupportedOperationException.class)
    public void selectValues_3() {
        String sql = "VALUES(1,(select id from test))";
        ...
        {
            DrSelectDomain domain1 = (DrSelectDomain) domainList.get(1);
    ...
    @Test(expected = UnsupportedOperationException.class)
    public void selectValues_2() {
        String sql = "select * from (VALUES(1)) a";
    ...
    public void selectQuery_2_2() {
        ...
        assert domainList.size() == 1;
        {
            DrSelectDomain domain2 = (DrSelectDomain) domainList.get(0);
    ...
    public void selectQuery_2_3() {
        ...
        assert domainList.size() == 1;
        {
            DrSelectDomain domain3 = (DrSelectDomain) domainList.get(0);
    ...
    public void union_2() {
        ...
        {
            DrSelectDomain domain2 = (DrSelectDomain) domainList.get(2);
            assert domain2.getSqlType() == SecQueryType.SELECT && domain2.getAuditKind() == SecQueryKind.QUERY && domain2.getMode() == RdbQueryMode.SUB_FROM;
            assert domain2.getSelectColumns().isEmpty() &&//
                   domain2.getSelectVariables().isEmpty() &&//
                   domain2.getSelectFunc().isEmpty() &&//
    ...
    public void union_6_1() {
        ...
        {
            DrSelectDomain domain3 = (DrSelectDomain) domainList.get(1);
    ...
    public void with_query_3() {
        ...
        {
            DrSelectDomain domain4 = (DrSelectDomain) domainList.get(4);
            assert domain4.getSqlType() == SecQueryType.SELECT && domain4.getAuditKind() == SecQueryKind.QUERY && domain4.getMode() == RdbQueryMode.SUB_FROM;
            assert domain4.getSelectColumns().isEmpty() &&//
                   domain4.getSelectVariables().isEmpty() &&//
                   domain4.getSelectFunc().isEmpty() &&//
