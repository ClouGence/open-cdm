...
public class MyParseColumnComplexTest extends MySelectColumnTestSupport {

    public MyParseColumnComplexTest(){
    ...
    public void test4() {
        List<SelectItem> selectItems = spi
            .parseSelectColumn("select a.column1,b.column2 from (select * from table1 union select * from table2) a "
                               + "left join (select * from schema2.table1 union select * from schema2.table2) b on a.column1 = b.column1", createContextInfo());
