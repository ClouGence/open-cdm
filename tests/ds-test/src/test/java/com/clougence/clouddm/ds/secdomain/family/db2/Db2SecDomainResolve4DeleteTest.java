...
public class Db2SecDomainResolve4DeleteTest extends Db2SecDomainTestSupport {

    public Db2SecDomainResolve4DeleteTest(){
    ...
    public void delete_from_1() {
        ...
        {
            Db2DeleteDomain domain1 = (Db2DeleteDomain) domainList.get(0);
