...
public class McParseColumnSelectInColumnTest extends McSelectColumnTestSupport {
    ...
    @Test
    public void test1() {
        List<SelectItem> selectItems = spi.parseSelectColumn( "select (select column1 from catalog2.schema1.table2) as ww from table2", contextInfo());
        ...
        assert realColumn.getCatalog().equals("catalog2") &&  realColumn.getColumn().equals("column1") && realColumn.getTable().equals("table2") && realColumn.getSchema().equals("schema1");
    }
