...
public class McSecDomainResolve4ShowTest extends McSecDomainTestSupport {
    ...
    public void showCreateTable1() {
        ...
        assert resList.size() == 1;
        {
            ...
            assert resObject.toDsResPath().getResPath().equals("/test_db/default/aa/") && resObject.getType() == TargetType.Table;
        }
    ...
    public void showCreateTable2() {
        ...
        {
            ResObject resObject = resList.get(0);
            assert resObject.toDsResPath().getResPath().equals("/bb/default/aa/") && resObject.getType() == TargetType.Table;
        }
        ...
        assert domainList.size() == 1;
        {
            RdbResourceDomain domain = (RdbResourceDomain) domainList.get(0);
            assert domain.getSqlType() == SecQueryType.SHOW && domain.getAuditKind() == SecQueryKind.QUERY;
            assert domain.getTarget() == TargetType.Table && domain.getName().equals("aa") && domain.getCatalog().equals("bb") && domain.getSchema().equals("default");
        }
    }
    ...
    public void DescTable2() {
        ...
        assert domainList.size() == 1;
        {
            RdbResourceDomain domain = (RdbResourceDomain) domainList.get(0);
            assert domain.getSqlType() == SecQueryType.SHOW && domain.getAuditKind() == SecQueryKind.QUERY;
            assert domain.getTarget() == TargetType.Table && domain.getName().equals("aa") && domain.getCatalog().equals("bb");
        }
    }
    ...
    public void showColumnsStatistic2() {
        ...
        assert domainList.size() == 1;
        {
            RdbResourceDomain domain = (RdbResourceDomain) domainList.get(0);
            assert domain.getSqlType() == SecQueryType.SHOW && domain.getAuditKind() == SecQueryKind.QUERY;
            assert domain.getTarget() == TargetType.Table && domain.getName().equals("aa") && domain.getSchema().equals("default");
        }
    }
    ...
    public void showHistory() {
        ...
        {
            ResObject resObject = resList.get(0);
            assert resObject.toDsResPath().getResPath().equals("/test_db/default/") && resObject.getType() == TargetType.Table;
        }
