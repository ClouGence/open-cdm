...
public class ChParseColumnFunctionTest extends ChSelectColumnTestSupport {

    public ChParseColumnFunctionTest(){
    ...
    @Test
    public void test2() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select test_function(column1) as x from table1", createContextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
        assert selectItem.getTableAlias() == null && selectItem.getItemAlias().equals("x");
    ...
    @Test
    public void test3() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select test_function(32) as x", createContextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
        assert selectItem.getTableAlias() == null && selectItem.getItemAlias().equals("x");
        assert selectItem.getColumns().isEmpty();
    ...
    @Test
    public void test6() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select test_func((select column1 from table2)) as x from table1", createContextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
        //        assert selectColumn.getTableAlias() == null && selectColumn.getColumnAlias() == null;
        assert selectItem.getColumns().size() == 1;
    ...
    public void test7() {
        List<SelectItem> selectItems = spi
            .parseSelectColumn("select test_func((select test_func1((select column1 from schema2.table1),column1) as x from table2),column1) as x from table1", createContextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
        //        assert selectColumn.getTableAlias() == null && selectColumn.getColumnAlias() == null;
