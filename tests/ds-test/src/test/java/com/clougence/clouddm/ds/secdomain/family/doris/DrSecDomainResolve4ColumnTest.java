...
import com.clougence.sql.doris.security.domain.DrColumnDomain;
...
public class DrSecDomainResolve4ColumnTest extends DrSecDomainTestSupport {

    public DrSecDomainResolve4ColumnTest(){
    ...
    public void alterTableAddColumn_1() {
        ...
        {
            DrColumnDomain domain = (DrColumnDomain) domainList.get(0);
    ...
    public void alterTableRenameColumn_1() {
        String sql = "alter table user_table rename column c1 c2;";
