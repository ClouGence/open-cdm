...
public class SrSecDomainResolve4Query1Test extends SrSecDomainTestSupport {

    public SrSecDomainResolve4Query1Test(){
    ...
    public void selectQuery_1() {
        ...
        {
            SrSelectDomain domain1 = (SrSelectDomain) domainList.get(0);
    ...
    public void selectQuery_2() {
        String sql = "select id,name from catalog1.schema1.abc";

        List<ResObject> resList = parserRes(sql);
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/catalog1/schema1/abc/");
        }
    ...
    public void selectQuery_2_2() {
        ...
        assert domainList.size() == 1;
        {
            SrSelectDomain domain2 = (SrSelectDomain) domainList.get(0);
    ...
    public void selectQuery_2_3() {
        ...
        assert domainList.size() == 1;
        {
            SrSelectDomain domain3 = (SrSelectDomain) domainList.get(0);
    ...
    public void conditionWhere_2() {
        String sql = "select * from `schema1`.table_1 where id is not null";
    ...
    public void union_1() {
        ...
        {
            SrSelectDomain domain1 = (SrSelectDomain) domainList.get(1);
            assert domain1.getSqlType() == SecQueryType.SELECT && domain1.getAuditKind() == SecQueryKind.QUERY && domain1.getMode() == RdbQueryMode.UNION;
            assert domain1.getSelectColumns().isEmpty() &&//
                   domain1.getSelectVariables().isEmpty() &&//
                   domain1.getSelectFunc().isEmpty() &&//
    ...
    public void union_2() {
        ...
        {
            SrSelectDomain domain2 = (SrSelectDomain) domainList.get(2);
            assert domain2.getSqlType() == SecQueryType.SELECT && domain2.getAuditKind() == SecQueryKind.QUERY && domain2.getMode() == RdbQueryMode.SUB_FROM;
            assert domain2.getSelectColumns().isEmpty() &&//
                   domain2.getSelectVariables().isEmpty() &&//
                   domain2.getSelectFunc().isEmpty() &&//
    ...
    public void union_3() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/test_schema/table_0/");
            assert resList.get(1).getType() == TargetType.Table &&//
    ...
    public void union_6_1() {
        ...
        {
            SrSelectDomain domain3 = (SrSelectDomain) domainList.get(1);
    ...
    public void with_query_3() {
        ...
        {
            SrSelectDomain domain4 = (SrSelectDomain) domainList.get(4);
            assert domain4.getSqlType() == SecQueryType.SELECT && domain4.getAuditKind() == SecQueryKind.QUERY && domain4.getMode() == RdbQueryMode.SUB_FROM;
            assert domain4.getSelectColumns().isEmpty() &&//
                   domain4.getSelectVariables().isEmpty() &&//
                   domain4.getSelectFunc().isEmpty() &&//
    ...
    @Test
    public void selectWithCase1() {
        String sql = "SELECT CASE WHEN ID=\"A\" THEN 1 ELSE 2 END FROM SXF TEST";

        List<ResObject> resList = parserRes(sql);
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/test_schema/SXF/");
        }
    ...
    @Test
    public void selectWithCase3() {
        String sql = "SELECT CASE WHEN ID=\"A\" THEN aa ELSE zz END FROM SXF TEST";
        ...
        assert domainList.size() == 1;
        {
            SrSelectDomain domain1 = (SrSelectDomain) domainList.get(0);
            assert domain1.getSqlType() == SecQueryType.SELECT && domain1.getAuditKind() == SecQueryKind.QUERY && domain1.getMode() == RdbQueryMode.NORMAL;
            assert domain1.getSelectColumns().size() == 3 && domain1.getSelectColumns().equals(Arrays.asList("ID", "aa", "zz")) &&//
                   domain1.getSelectVariables().isEmpty() &&//
                   domain1.getSelectFunc().isEmpty() &&//
                   domain1.getWhereColumns().isEmpty() && //
                   domain1.getJoinTypes().isEmpty();
