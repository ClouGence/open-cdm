...
import com.clougence.clouddm.ds.clickhouse.sql.security.domain.ChUpdateDomain;
...
public class ChSecDomainResolve4UpdateTest extends ChSecDomainTestSupport {

    public ChSecDomainResolve4UpdateTest(){
    ...
    public void update_1() {
        String sql = "alter table `table` update  id = 1 where 1=1";
    ...
    public void update_where_using_cast_2() {
        ...
        assert domainList.size() == 2;
        {
            ChUpdateDomain domain1_1 = (ChUpdateDomain) domainList.get(0);
    ...
    public void update_where_using_cast_3() {
        ...
        assert domainList.size() == 2;
        {
            ChUpdateDomain domain2_1 = (ChUpdateDomain) domainList.get(0);
    ...
    public void update_set_include_subquery_1() {
        String sql = "update `table` set id = (select id2 from test limit 1) where 1=1";
