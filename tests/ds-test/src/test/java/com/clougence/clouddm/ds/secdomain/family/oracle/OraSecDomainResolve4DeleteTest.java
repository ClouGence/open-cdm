...
import com.clougence.sql.oracle.security.domain.OraDeleteDomain;
...
public class OraSecDomainResolve4DeleteTest extends OraSecDomainTestSupport {

    public OraSecDomainResolve4DeleteTest(){
    ...
    public void delete_from_1() {
        ...
        {
            OraDeleteDomain domain1 = (OraDeleteDomain) domainList.get(0);
    ...
    public void delete_from_2_2() {
        ...
        assert domainList.size() == 1;
        {
            OraDeleteDomain domain2 = (OraDeleteDomain) domainList.get(0);
    ...
    @Test
    public void delete_from_select_1() {
        String sql = "delete from test1 where id = (select max(id) from test2)";
    ...
    @Test
    public void delete_from_select_2() {
        String sql = "delete from test1 where id = (with test as (select * from test2)select max(id) from test)";
    ...
    @Test
    public void delete_from_select_3() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_schema/product_price_history/");
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_schema/product_price_history1/");
        }
        ...
        assert domainList.size() == 2;
        {
            OraDeleteDomain domain1 = (OraDeleteDomain) domainList.get(0);
            assert domain1.getSqlType() == SecQueryType.DELETE && domain1.getAuditKind() == SecQueryKind.DML;
            assert domain1.getCatalog() == null && domain1.getSchema() == null && domain1.getTable().equals("product_price_history") &&//
                   domain1.getWhereColumns().size() == 3 && domain1.getWhereColumns().containsAll(Arrays.asList("product_id", "currency_code", "effective_from_date"));
            assert !domain1.isHasIgnore() &&    //
                   !domain1.isHasLimit() &&     //
                   !domain1.isMultiDelete();
            assert domain1.isHasWhere() &&      //
        ...
        }
        {
            ...
            assert domain2.getSqlType() == SecQueryType.SELECT && domain2.getAuditKind() == SecQueryKind.QUERY && domain2.getMode() == RdbQueryMode.SUB_WHERE;
            assert domain2.getCatalog() == null && domain2.getSchema() == null && domain2.getTable() == null &&//
                   domain2.getSelectColumns().size() == 3 && domain2.getSelectColumns().containsAll(Arrays.asList("product_id", "currency_code", "effective_from_date")) &&//
                   domain2.getWhereColumns().isEmpty();
            assert !domain2.isHasAs() &&         //
                   !domain2.isHasSelectAll() &&  //
                   !domain2.isSelectInSelect() &&//
