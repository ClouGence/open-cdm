package com.clougence.clouddm.ds.rules.special.postgresql;
...
public class PgRuleNameNotInKeywordsTest extends MyAbstractRuleTest {

    private final String scriptResource = "rule-test/special/postgresql/pg-name-not-in-keywords.txt";
