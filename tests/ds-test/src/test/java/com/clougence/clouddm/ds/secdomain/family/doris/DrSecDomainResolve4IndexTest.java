...
public class DrSecDomainResolve4IndexTest extends DrSecDomainTestSupport {

    public DrSecDomainResolve4IndexTest(){
    ...
    public void addIndex() {
        String sql = "CREATE INDEX test_index ON test (c1, c2 ) comment 'sss';";
