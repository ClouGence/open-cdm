...
import com.clougence.sql.mysql.security.domain.MyDeleteDomain;
...
public class MySecDomainResolve4DeleteTest extends MySecDomainTestSupport {

    public MySecDomainResolve4DeleteTest(){
    ...
    public void delete_from_2_2() {
        ...
        assert domainList.size() == 1;
        {
            MyDeleteDomain domain2 = (MyDeleteDomain) domainList.get(0);
            ...
            assert !domain2.isHasIgnore() &&    //
                   !domain2.isHasLimit() &&     //
                   !domain2.isMultiDelete();
    ...
    @Test
    public void delete_ignore_1() {
        String sql = "delete ignore from test where id = 1";
    ...
    public void delete_hasSubQuery_1() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_schema/test1/");
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_schema/test2/");
            assert resList.get(2).getType() == TargetType.Function &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_schema/max/");
        }
    ...
    public void delete_hasSubQuery_hasLimit_1() {
        String sql = "delete from test1 where id = (select max(id) from test2 limit 2) limit 1";
    ...
    @Test(expected = UnsupportedOperationException.class)
    public void deleteMultiTable_1() {
        String sql = "delete table1, table2, table3 from table1 join table2 join table3 on table1.id = table2.id where table1.id1 = 1 and table2.id2 = 2;";
        ...
        {
            MyDeleteDomain domain2 = (MyDeleteDomain) domainList.get(1);
            assert domain2.getSqlType() == SecQueryType.DELETE && domain2.getAuditKind() == SecQueryKind.DML;
            assert domain2.getCatalog() == null && domain2.getSchema() == null && domain2.getTable().equals("table1") &&//
                   domain2.getWhereColumns().size() == 1 && domain2.getWhereColumns().contains("id1");
            assert !domain2.isHasIgnore() &&    //
                   !domain2.isHasLimit() &&     //
                   !domain2.isMultiDelete();
            assert domain2.isHasWhere() &&      //
        ...
        {
            MyDeleteDomain domain3 = (MyDeleteDomain) domainList.get(2);
            assert domain3.getSqlType() == SecQueryType.DELETE && domain3.getAuditKind() == SecQueryKind.DML;
            assert domain3.getCatalog() == null && domain3.getSchema() == null && domain3.getTable().equals("table2") &&//
                   domain3.getWhereColumns().size() == 1 && domain3.getWhereColumns().contains("id2");
            assert !domain3.isHasIgnore() &&    //
                   !domain3.isHasLimit() &&     //
                   !domain3.isMultiDelete();
            assert domain3.isHasWhere() &&      //
                   !domain3.isSelectInWhere() &&//
                   domain3.getJoinType() == RdbJoinType.NONE &&//
                   !domain3.isHasUnion() &&     //
        ...
        {
            MyDeleteDomain domain4 = (MyDeleteDomain) domainList.get(3);
            assert domain4.getSqlType() == SecQueryType.DELETE && domain4.getAuditKind() == SecQueryKind.DML;
            assert domain4.getCatalog() == null && domain4.getSchema() == null && domain4.getTable().equals("table3") &&//
                   domain4.getWhereColumns().size() == 0;
            assert !domain4.isHasIgnore() &&    //
                   !domain4.isHasLimit() &&     //
                   !domain4.isMultiDelete();
    ...
    @Test(expected = UnsupportedOperationException.class)
    public void deleteMultiTable_2() {
        String sql = "delete t1, t2, t3 from table1 t1 left join table2 t2 on t1.id = t2.id left join table3 t3 on t3.id = t1.id where t1.id1 = 1 and t2.id2 = 3;";
        ...
        assert domainList.size() == 4;
        {
            ...
            assert domain1.isHasWhere() &&      //
                   !domain1.isSelectInWhere() &&//
                   domain1.getJoinType() == RdbJoinType.LEFT_JOIN &&//
                   !domain1.isHasUnion() &&     //
                   !domain1.isHasWith();
        }
        {
    ...
    @Test(expected = UnsupportedOperationException.class)
    public void deleteMultiTable_3() {
        String sql = "delete t1, t2, t3 from table1 t1 join table2 t2 join table3 t3 on t1.id=t2.id where t1.id1 = 1 and t2.id2 = 2;";
