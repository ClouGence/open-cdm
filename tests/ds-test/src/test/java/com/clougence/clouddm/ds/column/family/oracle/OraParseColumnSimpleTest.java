...
public class OraParseColumnSimpleTest extends OraSelectColumnTestSupport {

    public OraParseColumnSimpleTest(){
    ...
    //    @Test
    //    public void test9() {
    //        List<SelectItem> selectItems = spi.parseSelectColumn(null, "select *,test(column1) as s from schema2.table1", 1, levels);
