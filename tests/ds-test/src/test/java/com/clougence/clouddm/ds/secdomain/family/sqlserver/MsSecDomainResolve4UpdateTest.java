...
import com.clougence.sql.sqlserver.security.domain.MsUpdateDomain;
...
public class MsSecDomainResolve4UpdateTest extends MsSecDomainTestSupport {

    public MsSecDomainResolve4UpdateTest(){
    ...
    public void update_1() {
        String sql = "update [table] set id = 1 where id = 2";
        ...
        {
            MsUpdateDomain domain1 = (MsUpdateDomain) domainList.get(0);
    ...
    public void update_where_using_cast_2() {
        ...
        assert domainList.size() == 2;
        {
            MsUpdateDomain domain1_1 = (MsUpdateDomain) domainList.get(0);
    ...
    public void update_set_include_subquery_1() {
        String sql = "update [table] set id = (select top 1 id2 from test)";
    ...
    public void update_where_include_subquery_1() {
        String sql = "update [table] set id = 2 where [table].name = (select top 1 id2 from test)";
    ...
    public void update_using_withQuery_1() {
        ...
        assert resList.size() == 3;
        {
            ...
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/test_schema/table3/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/test_schema/table1/");
        }
        ...
        }
        {
            ...
            assert domain2.getCatalog() == null && domain2.getSchema() == null && domain2.getTable().equals("tab1Cnt") &&//
                   domain2.getSelectColumns().size() == 1 && domain2.getSelectColumns().contains("id_1") &&//
        ...
        }
        {
            ...
            assert domain3.getCatalog() == null && domain3.getSchema() == null && domain3.getTable().equals("table3") &&//
                   domain3.getSelectColumns().size() == 1 && domain3.getSelectColumns().contains("id_2") &&//
        ...
        }
        {
            ...
            assert domain5.getCatalog() == null && domain5.getSchema() == null && domain5.getTable().equals("table1") &&//
