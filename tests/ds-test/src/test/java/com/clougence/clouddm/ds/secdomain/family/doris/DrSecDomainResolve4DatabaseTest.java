...
public class DrSecDomainResolve4DatabaseTest extends DrSecDomainTestSupport {

    public DrSecDomainResolve4DatabaseTest(){
    ...
    public void createDataBase_1() {
        ...
        {
            DrSchemaDomain domain = (DrSchemaDomain) domainList.get(0);
    ...
    public void alterDataBase_1() {
        String sql = "alter DATABASE abc set properties(s=23);";
