...
import com.clougence.sql.doris.security.domain.DrRevokeDomain;
import com.clougence.sql.doris.security.domain.DrUserDomain;
...
public class DrSecDomainResolve4UserAndRoleTest extends DrSecDomainTestSupport {

    public DrSecDomainResolve4UserAndRoleTest(){
    ...
    public void createUser() {
        ...
        {
            DrUserDomain domain = (DrUserDomain) domainList.get(0);
