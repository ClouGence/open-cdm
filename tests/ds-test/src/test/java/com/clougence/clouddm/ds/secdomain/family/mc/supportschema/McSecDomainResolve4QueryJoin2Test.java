...
public class McSecDomainResolve4QueryJoin2Test extends McSecDomainTestSupport {
    ...
    public void join_at_where_1() {
        ...
        }
        {
            ...
            assert domain1_2.getSelectColumns().size() == 1 && domain1_2.getSelectColumns().equals(Collections.singletonList("id")) &&//
                   domain1_2.getSelectVariables().isEmpty() &&//
                   domain1_2.getSelectFunc().isEmpty() &&//
                   domain1_2.getWhereColumns().isEmpty() &&//
                   domain1_2.getJoinTypes().size() == 1 && domain1_2.getJoinTypes().contains(RdbJoinType.LEFT_JOIN);
    ...
    public void subquery_at_select_5_1() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/test_schema/two_pk_table_bak/");
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/test_schema/key_datatime/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/test_schema/two_pk_table/");
        }
