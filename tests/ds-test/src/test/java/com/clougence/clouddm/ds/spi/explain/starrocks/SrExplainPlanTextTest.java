 ...
 */
package com.clougence.clouddm.ds.spi.explain.starrocks;
...
public final class SrExplainPlanTextTest extends ExplainPlanTextTest {
    public SrExplainPlanTextTest(){
        super("spi/explain/starrocks");
    }

    @Override
    protected ExplainPlanSpi explainPlanSpi() {
        return new SrExplainPlanSpi();
    }
}
