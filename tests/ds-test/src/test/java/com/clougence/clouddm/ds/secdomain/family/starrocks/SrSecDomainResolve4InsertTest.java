...
import com.clougence.clouddm.ds.starrocks.sql.security.domain.SrInsertDomain;
...
public class SrSecDomainResolve4InsertTest extends SrSecDomainTestSupport {

    public SrSecDomainResolve4InsertTest(){
    ...
    public void insertInto_1() {
        ...
        {
            SrInsertDomain domain1 = (SrInsertDomain) domainList.get(0);
    ...
    public void insertInto_2() {
        String sql = "insert overwrite `test_schema`.`table2` (`id`, `b`) values (2, 1);";
    ...
    public void insertMultipleValues_1() {
        String sql = "insert into `test_schema`.`table2` (`id`, `b`) values (2, '33'),(3,5),(1,3);";
    ...
    public void insertFromSelect_2() {
        ...
        }
        {
            SrSelectDomain domain2 = (SrSelectDomain) domainList.get(1);
            assert domain2.getSqlType() == SecQueryType.SELECT && domain2.getAuditKind() == SecQueryKind.QUERY && domain2.getMode() == RdbQueryMode.INSERT;
            assert domain2.getSelectColumns().size() == 0 &&//
                   domain2.getSelectVariables().size() == 0 &&//
                   domain2.getSelectFunc().size() == 0 &&//
                   domain2.getWhereColumns().size() == 0;
            assert !domain2.isHasAs() &&         //
    ...
    public void insertFromSelect_3() {
        ...
        {
            SrSelectDomain domain4 = (SrSelectDomain) domainList.get(2);
