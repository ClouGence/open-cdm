...
public class McParseColumnComplexTest extends McSelectColumnTestSupport {

    public McParseColumnComplexTest(){
    ...
    public void test1() {
        ...
        assert selectItem.getTableAlias() == null && selectItem.getItemAlias().equals("main_id");
        assert selectItem.getColumns().size() == 1;
        RealColumn realColumn = selectItem.getColumns().get(0);
        assert realColumn.getCatalog().equals("catalog1") && realColumn.getSchema().equals("schema1") && realColumn.getTable().equals("table1")
               && realColumn.getColumn().equals("column1");

        selectItem = selectItems.get(1);
        assert selectItem.getItemAlias().equals("max_val");
        assert selectItem.getColumns().size() == 1;
        realColumn = selectItem.getColumns().get(0);
        assert realColumn.getCatalog().equals("catalog1") && realColumn.getSchema().equals("schema2") && realColumn.getTable().equals("table2")
               && realColumn.getColumn().equals("column3");
    ...
    public void test2() {
        ...
        SelectItem selectItem = selectItems.get(0);
        assert selectItem.getTableAlias() == null && selectItem.getItemAlias().equals("category");
        assert selectItem.getColumns().size() == 1;
        RealColumn realColumn = selectItem.getColumns().get(0);
        assert realColumn.getCatalog().equals("catalog1") && realColumn.getSchema().equals("schema1") && realColumn.getTable().equals("table1")
               && realColumn.getColumn().equals("column2");

        selectItem = selectItems.get(1);
        assert selectItem.getItemAlias().equals("total_sum");
        assert selectItem.getColumns().size() == 1;
        realColumn = selectItem.getColumns().get(0);
        assert realColumn.getCatalog().equals("catalog1") && realColumn.getSchema().equals("schema2") && realColumn.getTable().equals("table1")
               && realColumn.getColumn().equals("column4");

        selectItem = selectItems.get(2);
        assert selectItem.getItemAlias().equals("avg_value");
        assert selectItem.getColumns().size() == 1;
        realColumn = selectItem.getColumns().get(0);
        assert realColumn.getCatalog().equals("catalog1") && realColumn.getSchema().equals("schema1") && realColumn.getTable().equals("table2")
               && realColumn.getColumn().equals("column5");
    ...
    public void test3() {
        ...
        }
        {
            ...
            RealColumn realColumn = selectItem.getColumns().get(0);
            assert realColumn.getCatalog().equals("catalog1") && realColumn.getSchema().equals("schema1") && realColumn.getTable().equals("table1")
                   && realColumn.getColumn().equals("column6");
        ...
        }
        {
            ...
            realColumn = selectItem.getColumns().get(1);
            assert realColumn.getCatalog().equals("catalog2") && realColumn.getSchema().equals("schema1") && realColumn.getTable().equals("table2")
                   && realColumn.getColumn().equals("column2");
        }
        {
    ...
    public void test4() {
        List<SelectItem> selectItems = spi
            .parseSelectColumn("select a.column1,b.column2 from (select * from table1 union select * from table2) a "
                               + "left join (select * from schema2.table1 union select * from schema2.table2) b on a.column1 = b.column1", contextInfo());
