...
public class OraSecDomainResolve4QueryJoin1Test extends OraSecDomainTestSupport {

    public OraSecDomainResolve4QueryJoin1Test(){
    ...
    public void naturalJoinQuery_2() {
        ...
        //            assert !domain1_1.isHasWhere() &&      //
        //                   !domain1_1.isSelectInWhere() && //
        //                   domain1_1.getJoinType() == RdbJoinType.INNER_JOIN && domain1_1.getOptions().get(OraSecDomainOptionKeys.OPT_JOIN_NATURAL).equals("true") &&//
        //                   !domain1_1.isHasUnion() &&      //
        //                   !domain1_1.isHasWith();
    ...
    //            assert !domain1_1.isHasWhere() &&      //
    //                   !domain1_1.isSelectInWhere() && //
    //                   domain1_1.getJoinType() == RdbJoinType.LEFT_JOIN && domain1_1.getOptions().get(MySecDomainOptionKeys.OPT_JOIN_NATURAL).equals("true") &&//
    //                   !domain1_1.isHasUnion() &&      //
    //                   !domain1_1.isHasWith();
    //            assert !domain1_1.isHasLimit();
    //        }
    ...
    public void naturalJoinQuery_5() {
        ...
        //        assert domain5.getOptions().get(OraSecDomainOptionKeys.OPT_JOIN_NATURAL).equals("true");
    }
    ...
    public void rightJoinQuery_1_2() {
        String sql = "select * from table_1 a right join table_2 b";
