...
import com.clougence.clouddm.ds.maxcompute.sql.security.domain.McSelectDomain;
...
public class McSecDomainResolve4QueryJoin2Test extends McSecDomainTestSupport {

    public McSecDomainResolve4QueryJoin2Test(){
    ...
    public void from_join_1() {
        ...
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table_2/");
        }
        ...
        {
            McSelectDomain domain1 = (McSelectDomain) domainList.get(0);
    ...
    public void from_join_2() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table_1/");
        }
    ...
    public void from_join_3() {
        ...
        assert resList.size() == 2;
        {
            ...
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/table_2/");
        }
    ...
    public void from_innerJoin_1() {
        ...
        assert domainList.size() == 2;
        {
            McSelectDomain domain1_1 = (McSelectDomain) domainList.get(0);
    ...
    public void join_at_where_1() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table_3/");
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/table_1/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/table_2/");
        }
    ...
    public void join_at_where_2() {
        ...
        assert resList.size() == 4;
        {
            ...
            assert resList.get(1).getType() == TargetType.Function &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/CAST/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/table_2/");
            assert resList.get(3).getType() == TargetType.Table &&//
                   resList.get(3).toDsResPath().getResPath().equals("/test_db/default/table_3/");
        }
        ...
        {
            McSelectDomain domain1_3 = (McSelectDomain) domainList.get(2);
    ...
    public void subquery_at_where_2() {
        ...
        assert resList.size() == 3;
        {
            ...
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/table_2/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/table_3/");
        }
    ...
    public void subquery_at_select_3() {
        ...
        assert resList.size() == 4;
        {
            ...
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table_3/");
            assert resList.get(3).getType() == TargetType.Table &&//
                   resList.get(3).toDsResPath().getResPath().equals("/test_db/default/table_4/");
        }
        ...
        {
            McSelectDomain domain4 = (McSelectDomain) domainList.get(3);
    ...
    public void subquery_at_select_4() {
        ...
        //        {
        //            assert resList.get(0).getType() == TargetType.Table &&//
        //                   resList.get(0).toDsResPath().getResPath().equals("/default/table_3/");
        //            assert resList.get(1).getType() == TargetType.Table &&//
        //                   resList.get(1).toDsResPath().getResPath().equals("/default/table_1/");
        //            assert resList.get(2).getType() == TargetType.Table &&//
        //                   resList.get(2).toDsResPath().getResPath().equals("/default/table_2/");
        //        }
        //
    ...
    public void subquery_at_select_5_1() {
        String sql = "select *,(select id from `key_datatime` b join `two_pk_table` a  on a.`id` = b.`a1` where a.id > 1 limit 1)" +//
                     "from two_pk_table_bak where  jk is not null";

        List<ResObject> resList =parserRes(sql);
        assert resList.size() == 3;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/two_pk_table_bak/");
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/key_datatime/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/two_pk_table/");
        }
    ...
    public void subquery_at_select_5_2() {
        String sql = "select *,(select id as id1 from `key_datatime` b join `two_pk_table` a  on a.`id` = b.`a1` where a.id > 1 limit 1)" +//
                     "from two_pk_table_bak where o is not null";
    ...
    public void call_at_select_1() {
        String sql = "select count(*) as c,cast(id AS SIGNED) as b from two_pk_table where  id is not null group by id";

        List<ResObject> resList =parserRes(sql);
        assert resList.size() == 3;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/two_pk_table/");
            assert resList.get(1).getType() == TargetType.Function &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/count/");
            assert resList.get(2).getType() == TargetType.Function &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/cast/");
        }
    ...
    public void call_at_select_2() {
        String sql = "select count(*) as c,CONCAT('1', cast(age AS SIGNED)),cast((select id from table_1 limit 1) AS SIGNED) from two_pk_table where  gh is not null group by rollup (id,name)";
        ...
        assert resList.size() == 5;
        {
            ...
            assert resList.get(1).getType() == TargetType.Function &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/count/");
            assert resList.get(2).getType() == TargetType.Function &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/CONCAT/");
            assert resList.get(3).getType() == TargetType.Function &&//
                   resList.get(3).toDsResPath().getResPath().equals("/test_db/default/cast/");
            assert resList.get(4).getType() == TargetType.Table &&//
                   resList.get(4).toDsResPath().getResPath().equals("/test_db/default/table_1/");
        }
        ...
        {
            McSelectDomain domain6 = (McSelectDomain) domainList.get(5);
