...
public class MsSecDomainResolve4QueryJoin1Test extends MsSecDomainTestSupport {

    public MsSecDomainResolve4QueryJoin1Test(){
    ...
    //        {
    //            MsSelectDomain domain1_1 = (MsSelectDomain) domainList.get(0);
    //            assert domain1_1.getSqlType() == SecQueryType.SELECT && domain1_1.getSqlKind() == SqlKind.QUERY && domain1_1.getMode() == RdbQueryMode.NORMAL;
    //            assert domain1_1.getCatalog() == null && domain1_1.getSchema() == null && domain1_1.getTable() == null &&//
    //                   domain1_1.getSelectColumns().size() == 0 &&//
    //                   domain1_1.getSelectVariables().size() == 0 &&//
    //                   domain1_1.getSelectFunc().size() == 0 &&//
    ...
    //            assert !domain1_1.isHasWhere() &&      //
    //                   !domain1_1.isSelectInWhere() && //
    //                   domain1_1.getJoinType() == RdbJoinType.INNER_JOIN && domain1_1.getOptions().get(OPT_JOIN_NATURAL).equals("true") &&//
    //                   !domain1_1.isHasUnion() &&      //
    //                   !domain1_1.isHasWith();
    //            assert !domain1_1.isHasLimit();
    //        }
    //        {
    //            MsSelectDomain domain1_2 = (MsSelectDomain) domainList.get(1);
    //            assert domain1_2.getSqlType() == SecQueryType.SELECT && domain1_2.getSqlKind() == SqlKind.QUERY && domain1_2.getMode() == RdbQueryMode.JOIN;
    //            assert domain1_2.getCatalog() == null && domain1_2.getSchema() == null && domain1_2.getTable().equals("table_1") &&//
    //                   domain1_2.getSelectColumns().size() == 0 &&//
    //                   domain1_2.getSelectVariables().size() == 0 &&//
    //                   domain1_2.getSelectFunc().size() == 0 &&//
    ...
    //        {
    //            MsSelectDomain domain1_3 = (MsSelectDomain) domainList.get(2);
    //            assert domain1_3.getSqlType() == SecQueryType.SELECT && domain1_3.getSqlKind() == SqlKind.QUERY && domain1_3.getMode() == RdbQueryMode.JOIN;
    //            assert domain1_3.getCatalog() == null && domain1_3.getSchema() == null && domain1_3.getTable().equals("table_2") &&//
    //                   domain1_3.getSelectColumns().size() == 0 &&//
    //                   domain1_3.getSelectVariables().size() == 0 &&//
    //                   domain1_3.getSelectFunc().size() == 0 &&//
    ...
    //            assert !domain1_1.isHasWhere() &&      //
    //                   !domain1_1.isSelectInWhere() && //
    //                   domain1_1.getJoinType() == RdbJoinType.CROSS_JOIN && domain1_1.getOptions().get(OPT_JOIN_NATURAL).equals("true") &&//
    //                   !domain1_1.isHasUnion() &&      //
    //                   !domain1_1.isHasWith();
    //            assert !domain1_1.isHasLimit();
    //        }
    ...
    //            assert !domain1_1.isHasWhere() &&      //
    //                   !domain1_1.isSelectInWhere() && //
    //                   domain1_1.getJoinType() == RdbJoinType.LEFT_JOIN && domain1_1.getOptions().get(OPT_JOIN_NATURAL).equals("true") &&//
    //                   !domain1_1.isHasUnion() &&      //
    //                   !domain1_1.isHasWith();
    //            assert !domain1_1.isHasLimit();
    //        }
    ...
    public void naturalJoinQuery_4() {
        ...
        //        MsQueryDomain domain5 = (MsQueryDomain) list5.get(0);
        ...
        //        assert domain5.getOptions().get(MsSecDomainOptionKeys.OPT_JOIN_NATURAL).equals("true");
    }
