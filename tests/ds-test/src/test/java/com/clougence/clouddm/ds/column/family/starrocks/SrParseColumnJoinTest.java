...
public class SrParseColumnJoinTest extends SrSelectColumnTestSupport {

    public SrParseColumnJoinTest(){
        spi = new SrSelectColumnAnalysisSpi(new TestMetaServiceImpl());
    }

    @Test
    public void test1() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from table1 left join catalog2.schema1.table2 on table1.column1 = table2.column1", contextInfo());
    ...
    public void test1_1() {
        List<SelectItem> selectItems = spi
            .parseSelectColumn("select table1.column1,table2.column2 from table1 left join catalog2.schema1.table2 on table1.column1 = table2.column1", contextInfo());
    ...
    @Test
    public void test2() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from table1 a left join catalog2.schema1.table2 b on a.column1 = b.column1", contextInfo());
        assert selectItems.size() == 12;
        for (int i = 1; i <= 6; i++) {
            SelectItem selectItem = selectItems.get(i - 1);
    ...
    @Test
    public void test4() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from table1 a left join catalog2.schema2.table2 b on a.column1 = b.column1", contextInfo());
        assert selectItems.size() == 12;
        for (int i = 1; i <= 6; i++) {
            SelectItem selectItem = selectItems.get(i - 1);
            assert selectItem.getTableAlias().equals("a") && selectItem.getItemAlias().equals("column" + i);
    ...
    @Test
    public void test5() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select a.*,b.* from table1 a left join catalog2.schema2.table2 b on a.column1 = b.column1", contextInfo());
        assert selectItems.size() == 12;
        for (int i = 1; i <= 6; i++) {
            SelectItem selectItem = selectItems.get(i - 1);
            assert selectItem.getTableAlias().equals("a") && selectItem.getItemAlias().equals("column" + i);
    ...
    @Test
    public void test6() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select a.*,b.column1 from table1 a left join catalog2.schema2.table2 b on a.column1 = b.column1", contextInfo());
    ...
    public void test7() {
        List<SelectItem> selectItems = spi
            .parseSelectColumn("select column1,d from (select a.*,b.column1 as d from table1 a left join catalog2.schema2.table2 b on a.column1 = b.column1)c", contextInfo());
        assert selectItems.size() == 2;
    ...
    public void test8() {
        List<SelectItem> selectItems = spi
            .parseSelectColumn("select a.column1,b.column2,c.column3 from table1 a left join catalog2.schema1.table2 b on a.column1 = b.column1 left join schema2.table1 c on c.column1 = a.column1", contextInfo());
