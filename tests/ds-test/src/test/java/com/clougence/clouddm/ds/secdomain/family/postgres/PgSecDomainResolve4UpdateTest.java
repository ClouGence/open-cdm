...
import com.clougence.sql.postgres.security.domain.PgUpdateDomain;
...
public class PgSecDomainResolve4UpdateTest extends PgSecDomainTestSupport {

    public PgSecDomainResolve4UpdateTest(){
    ...
    public void update_1() {
        ...
        {
            PgUpdateDomain domain1 = (PgUpdateDomain) domainList.get(0);
    ...
    public void update_4() {
        String sql = "update \"table\" set (id,age) = (1,2) where name = 'name'";
    ...
    public void update_5() {
        String sql = "update \"table\" set (id,age) = (select id,age from table1) where name = 'name'";
        ...
        }
        {
            ...
            assert domain3.getSqlType() == SecQueryType.SELECT && domain3.getAuditKind() == SecQueryKind.QUERY && domain3.getMode() == RdbQueryMode.SUB_SET;
            assert domain3.getCatalog() == null && domain3.getSchema() == null && domain3.getTable() == null &&//
                   domain3.getSelectColumns().size() == 2 && domain3.getSelectColumns().containsAll(Arrays.asList("id", "age")) &&//
    ...
    public void update_where_using_cast_2() {
        ...
        assert domainList.size() == 2;
        {
            PgUpdateDomain domain1_1 = (PgUpdateDomain) domainList.get(0);
    ...
    public void update_where_using_func_1() {
        String sql = "update table1 set name = 1 where id = ( select avg(id) from table2 )";
        ...
        assert resList.size() == 3;
        {
            ...
            assert resList.get(2).getType() == TargetType.Function &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/test_schema/avg/");
            assert resList.get(1).getType() == TargetType.Table &&//
        ...
        {
            RdbCallDomain domain2 = (RdbCallDomain) domainList.get(2);
            assert domain2.getSqlType() == SecQueryType.CALL && domain2.getAuditKind() == SecQueryKind.CALL;
    ...
    public void update_using_withQuery_1() {
        ...
        }
        {
            ...
            assert domain4.getCatalog() == null && domain4.getSchema() == null && domain4.getTable() == null &&//
                   domain4.getSelectColumns().size() == 1 && domain4.getSelectColumns().contains("id_2") &&//
