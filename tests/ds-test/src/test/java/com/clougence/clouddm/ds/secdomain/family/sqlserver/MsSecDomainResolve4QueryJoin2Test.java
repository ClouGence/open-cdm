...
import com.clougence.sql.sqlserver.security.domain.MsSelectDomain;
...
public class MsSecDomainResolve4QueryJoin2Test extends MsSecDomainTestSupport {

    public MsSecDomainResolve4QueryJoin2Test(){
    ...
    public void from_innerJoin_1() {
        ...
        assert domainList.size() == 4;
        {
            MsSelectDomain domain1_1 = (MsSelectDomain) domainList.get(0);
        ...
        {
            MsSelectDomain domain1_2 = (MsSelectDomain) domainList.get(1);
        ...
        {
            MsSelectDomain domain1_3 = (MsSelectDomain) domainList.get(2);
        ...
        {
            MsSelectDomain domain1_3 = (MsSelectDomain) domainList.get(3);
    ...
    public void from_innerJoin_2() {
        ...
        {
            MsSelectDomain domain1_4 = (MsSelectDomain) domainList.get(3);
    ...
    public void join_at_where_2() {
        String sql = "select * from table_1 where id = CAST((select top 1 a.id from table_2 a left join table_3 b on a.id = b.id where a.id = 1) as CHAR);";
        ...
        {
            MsSelectDomain domain1_5 = (MsSelectDomain) domainList.get(4);
            ...
            assert domain1_5.isHasWhere() &&       //
                   ...
                   !domain1_5.isHasWith();
            assert !domain1_5.isHasLimit();
        }
    }

    @Test
    public void join_at_select_1() {
        String sql = "select id = (select top 1 a.id from table_1 a left join table_2 b on a.id = b.id) from table_3";
    ...
    public void subquery_at_select_1_1() {
        String sql = "select id = (select top 1 a.id from table_1 a left join (select * from table_2) b on a.id = b.id),few from table_1";
        ...
        assert domainList.size() == 5;
        {
            ...
            assert domain1.getSqlType() == SecQueryType.SELECT && domain1.getAuditKind() == SecQueryKind.QUERY && domain1.getMode() == RdbQueryMode.NORMAL;
            assert domain1.getCatalog() == null && domain1.getSchema() == null && domain1.getTable().equals("table_1") &&//
                   domain1.getSelectColumns().size() == 2 && domain1.getSelectColumns().contains("id") && domain1.getSelectColumns().contains("few") &&//
                   domain1.getSelectVariables().size() == 0 &&//
                   domain1.getSelectFunc().size() == 0 &&//
                   domain1.getWhereColumns().size() == 0;
            assert !domain1.isHasAs() &&         //
    ...
    public void subquery_at_select_1_2() {
        String sql = "select (select  top 1 a.id from table_1 a left join (select * from table_2) b on a.id = b.id)  id from table_1";
    ...
    public void subquery_at_select_1_3() {
        String sql = "select (select  top 1 percent a.id from table_1 a left join (select id as id1, name from table_2) b on a.id = b.id1) as id from table_1";
    ...
    public void subquery_at_select_2_1() {
        String sql = "select id = (select top 1 a.id from table_1 a left join table_2 b on a.id = b.id) from table_1";
    ...
    public void subquery_at_select_3() {
        String sql = "select id = (select top 1 a.id from table_1 a left join table_2 b on a.id = b.id)" +//
    ...
    public void subquery_at_select_5_1() {
        String sql = "select *,(select top 1 id from [key_datatime] b join [two_pk_table] a  on a.[id] = b.[a1] where id > 1)" +//
                     "from two_pk_table where  1=1";
    ...
    public void subquery_at_select_5_2() {
        String sql = "select *,(select top 1 id as id1 from [key_datatime] b join [two_pk_table] a  on a.[id] = b.[a1] where id > 1)" +//
                     "from two_pk_table where  1=1";
    ...
    public void call_at_select_2() {
        String sql = "select sum(id) as c,CONCAT('1', cast(age AS SIGNED)),cast((select top 1 id from table_1) AS SIGNED) from two_pk_table where  1=1";
        ...
        assert domainList.size() == 6;
        {
            ...
            assert domain1.getSqlType() == SecQueryType.SELECT && domain1.getAuditKind() == SecQueryKind.QUERY && domain1.getMode() == RdbQueryMode.NORMAL;
            assert domain1.getCatalog() == null && domain1.getSchema() == null && domain1.getTable().equals("two_pk_table") &&//
                   domain1.getSelectColumns().size() == 2 && domain1.getSelectColumns().contains("age") && domain1.getSelectColumns().contains("id") &&//
                   domain1.getSelectVariables().size() == 0 &&//
