...
import com.clougence.sql.oracle.security.domain.OraSelectDomain;
...
public class OraSecDomainResolve4QueryJoin2Test extends OraSecDomainTestSupport {

    public OraSecDomainResolve4QueryJoin2Test(){
    ...
    public void from_join_1() {
        String sql = "select * from (select 1 id,'name' name from table_1) a join table_2 b on a.id = b.id";
    ...
    public void from_join_2() {
        String sql = "select * from table_1 a join (select 1 id,'name' name from table_2) b on a.id = b.id";
    ...
    public void from_innerJoin_1() {
        String sql = "select * from (select 1 id,'name' name from table_1) a inner join table_2 b on a.id = b.id";
        ...
        assert domainList.size() == 2;
        {
            OraSelectDomain domain1_1 = (OraSelectDomain) domainList.get(0);
    ...
    public void from_innerJoin_2() {
        String sql = "select * from table_1 a inner join (select 1 id,'name' name from table_2) b on a.id = b.id";
    ...
    public void from_crossJoin_1() {
        String sql = "select * from (select 1 id,'name' name from table_1) a cross join table_2 b";
    ...
    public void from_crossJoin_2() {
        String sql = "select * from table_1 a cross join (select 1 id,'name' name from table_2) b";
    ...
    public void from_leftJoin_1_1() {
        String sql = "select * from (select 1 id,'name' name from table_1) a left join table_2 b on a.id = b.id";
    ...
    public void from_leftJoin_1_2() {
        String sql = "select * from table_1 a left join (select 1 id,'name' name from table_2) b on a.id = b.id";
    ...
    public void from_leftJoin_2_1() {
        String sql = "select * from (select 1 id,'name' name from table_1) a left outer join table_2 b on a.id = b.id";
    ...
    public void from_leftJoin_2_2() {
        String sql = "select * from table_1 a left outer join (select 1 id,'name' name from table_2) b on a.id = b.id";
    ...
    public void from_rightJoin_1_1() {
        String sql = "select * from (select 1 id,'name' name from \"table_1\") a right join table_2 b on a.id = b.id";
    ...
    public void from_rightJoin_1_2() {
        String sql = "select * from table_1 a right join (select 1 id,'name' name from table_2) b on a.id = b.id";
    ...
    public void from_rightJoin_2_1() {
        String sql = "select * from (select 1 id,'name' name from table_1) a right outer join table_2 b on a.id = b.id";
    ...
    public void from_rightJoin_2_2() {
        String sql = "select * from table_1 a right outer join (select 1 id,'name' name from table_2) b on a.id = b.id";
    ...
    public void join_at_where_2() {
        String sql = "select * from table_1 where id = CAST((select a.id from table_2 a left join table_3 b on a.id = b.id where a.id = 1) as CHAR);";
        ...
        {
            OraSelectDomain domain1_3 = (OraSelectDomain) domainList.get(2);
    ...
    public void join_at_select_1() {
        String sql = "select id = (select a.id from table_1 a left join table_2 b on a.id = b.id ) from table_3";
    ...
    public void subquery_at_select_1_1() {
        String sql = "select id = (select a.id from table_1 a left join (select * from table_2) b on a.id = b.id) from table_3";
    ...
    public void subquery_at_select_1_2() {
        String sql = "select (select a.id from table_1 a left join (select * from table_2) b on a.id = b.id) = id from table_3";
    ...
    public void subquery_at_select_1_3() {
        String sql = "select (select a.id from table_1 a left join (select id as id1, name from table_2) b on a.id = b.id1) = id from table_3";
    ...
    public void subquery_at_select_2_2() {
        String sql = "select (select a.id from table_1 a left join table_2 b on a.id = b.id) = id from table_3";
    ...
    public void subquery_at_select_3() {
        String sql = "select t1.id = (select a.id from table_1 a left join table_2 b on a.id = b.id)" +//
    ...
    public void call_at_select_1() {
        String sql = "select sum(id) as c,cast(id AS SIGNED) as b from two_pk_table where  1=1";
        ...
        assert resList.size() == 3;
        {
            ...
            assert resList.get(1).getType() == TargetType.Function &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_schema/sum/");
        ...
        }
        {
            ...
            //                    &&//
            //  todo                 domain3.getArgs().get(0).contains("id");
        }
    }

    @Test
    public void call_at_select_2() {
        String sql = "select sum(id) as c,CONCAT('1', cast(age AS SIGNED)),cast((select id from table_1) AS SIGNED) from two_pk_table where  1=1";
        ...
        assert domainList.size() == 6;
        {
            OraSelectDomain domain1 = (OraSelectDomain) domainList.get(0);
            assert domain1.getSqlType() == SecQueryType.SELECT && domain1.getAuditKind() == SecQueryKind.QUERY && domain1.getMode() == RdbQueryMode.NORMAL;
            assert domain1.getSelectColumns().size() == 2 && domain1.getSelectColumns().contains("age") &&//
                   domain1.getSelectVariables().isEmpty() &&//
        ...
        {
            OraSelectDomain domain6 = (OraSelectDomain) domainList.get(5);
