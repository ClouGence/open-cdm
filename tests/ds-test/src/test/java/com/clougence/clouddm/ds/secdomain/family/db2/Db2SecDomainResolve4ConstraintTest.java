...
public class Db2SecDomainResolve4ConstraintTest extends Db2SecDomainTestSupport {

    public Db2SecDomainResolve4ConstraintTest(){
    ...
    public void alterTableDropUnique_1() {
        String sql = "alter table abc drop unique SQL250126102859120";
        ...
        assert domainList.size() == 1;
        {
            ...
            assert domain1.getTableCatalog() == null && domain1.getTableSchema() == null &&//
                   domain1.getType() == SqlConstraintType.ByName &&//
                   domain1.getTableName().equals("abc") && domain1.getName().equals("SQL250126102859120");
        }
    }

    @Test
    public void alterTableDropUnique_2() {
        String sql = "alter table abc drop constraint SQL250126102859120";
