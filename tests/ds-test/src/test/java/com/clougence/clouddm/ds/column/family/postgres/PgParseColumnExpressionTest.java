...
public class PgParseColumnExpressionTest extends PgSelectColumnTestSupport {

    public PgParseColumnExpressionTest(){
    ...
    @Test
    public void test2() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select 1 + column1 as qq from table1", contextInfo());
    ...
    @Test
    public void test3() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select 1 + column1 + (select column1 from table2 limit 1) as \"xx\" from table1", contextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
    ...
    @Test
    public void test4() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select 1 + column1 + (select column1 from table2 limit 1) + test(column2) as mbdv from table1", contextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
