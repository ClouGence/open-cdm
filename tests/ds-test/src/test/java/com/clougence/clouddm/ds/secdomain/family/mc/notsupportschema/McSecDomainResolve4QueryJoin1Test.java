...
import com.clougence.sql.mysql.security.MySecDomainOptionKeys;
...
public class McSecDomainResolve4QueryJoin1Test extends McSecDomainTestSupport {

    public McSecDomainResolve4QueryJoin1Test(){
    ...
    public void naturalJoinQuery_1() {
        ...
        String sql2 = "select * from table_1 a natural join table_2 b";
        ...
        assert domainList.size() == 1;
        {
            ...
            assert !domain1_1.isHasWhere() &&      //
                   !domain1_1.isSelectInWhere() && //
                   domain1_1.getOptions().get(MySecDomainOptionKeys.OPT_JOIN_NATURAL).equals("true") && !domain1_1.isHasUnion() &&      //
                   !domain1_1.isHasWith();
            assert !domain1_1.isHasLimit();
        }
    ...
    //        {
    //            assert resList.get(0).getType() == TargetType.Table &&//
    //                   resList.get(0).toDsResPath().getResPath().equals("/default/table_1/");
    //            assert resList.get(1).getType() == TargetType.Table &&//
    //                   resList.get(1).toDsResPath().getResPath().equals("/default/table_2/");
    //        }
    //
    //        List<SplitScript> splitScripts = this.splitAnalysisSpi.splitScript(sql, null, 0, 0);
    //        assert splitScripts.size() == 1;
