...
public class McSecDomainResolve4Query1Test extends McSecDomainTestSupport {

    public McSecDomainResolve4Query1Test(){
    ...
    public void selectQuery_2_2() {
        ...
        assert domainList.size() == 1;
        {
            McSelectDomain domain2 = (McSelectDomain) domainList.get(0);
    ...
    public void selectQuery_2_3() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/users/");
        }
        ...
        assert domainList.size() == 1;
        {
            McSelectDomain domain3 = (McSelectDomain) domainList.get(0);
    ...
    public void selectQuery_4() {
        ...
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Function &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/ads_version/");
        }
    ...
    public void selectQuery_5() {
        String sql = "select * from a.table_1";

        List<ResObject> resList = parserRes(sql);
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/a/default/table_1/");
        }
    ...
    public void conditionWhere_4() {
        ...
        assert resList.size() == 2;
        {
            ...
            assert resList.get(1).getType() == TargetType.Function &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/length/");
        }
    ...
    public void union_2() {
        ...
        {
            McSelectDomain domain2 = (McSelectDomain) domainList.get(2);
            assert domain2.getSqlType() == SecQueryType.SELECT && domain2.getAuditKind() == SecQueryKind.QUERY && domain2.getMode() == RdbQueryMode.SUB_FROM;
            assert domain2.getSelectColumns().isEmpty() &&//
                   domain2.getSelectVariables().isEmpty() &&//
                   domain2.getSelectFunc().isEmpty() &&//
    ...
    public void union_3() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table_0/");
            assert resList.get(1).getType() == TargetType.Table &&//
    ...
    public void union_6_1() {
        ...
        assert resList.size() == 2;
        {
            ...
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/table2/");
        }
    ...
    public void union_6_2() {
        ...
        assert resList.size() == 4;
        {
            ...
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/table2/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/table3/");
            assert resList.get(3).getType() == TargetType.Table &&//
                   resList.get(3).toDsResPath().getResPath().equals("/test_db/default/table4/");
        }
    ...
    public void with_query_3() {
        ...
        {
            McSelectDomain domain4 = (McSelectDomain) domainList.get(4);
            assert domain4.getSqlType() == SecQueryType.SELECT && domain4.getAuditKind() == SecQueryKind.QUERY && domain4.getMode() == RdbQueryMode.SUB_FROM;
            assert domain4.getSelectColumns().isEmpty() &&//
                   domain4.getSelectVariables().isEmpty() &&//
                   domain4.getSelectFunc().isEmpty() &&//
