...
import com.clougence.clouddm.ds.starrocks.sql.security.domain.SrSelectDomain;
import com.clougence.clouddm.ds.starrocks.sql.security.domain.SrUpdateDomain;
...
public class SrSecDomainResolve4UpdateTest extends SrSecDomainTestSupport {

    public SrSecDomainResolve4UpdateTest(){
    ...
    public void update_1() {
        ...
        {
            SrUpdateDomain domain1 = (SrUpdateDomain) domainList.get(0);
    ...
    public void update_3() {
        ...
        assert domainList.size() == 1;
        {
            ...
            assert domain1.getCatalog() == null && domain1.getSchema() == null && domain1.getTable().equals("table") &&//
                   ...
                   domain1.getWhereColumns().size() == 1 && domain1.getWhereColumns().equals(Collections.singletonList("name"));
            assert !domain1.isSelectInSet() &&  //
                   !domain1.isMultiUpdate();
            assert domain1.isHasWhere() &&      //
                   !domain1.isSelectInWhere() &&//
    ...
    public void update_where_using_cast_1() {
        ...
        assert domainList.size() == 2;
        {
            ...
            assert domain1.getCatalog() == null && domain1.getSchema() == null && domain1.getTable().equals("table1") &&//
                   domain1.getSetColumns().size() == 1 && domain1.getSetColumns().equals(Collections.singletonList("name")) &&//
                   domain1.getWhereColumns().size() == 1 && domain1.getWhereColumns().equals(Collections.singletonList("id"));
            assert !domain1.isSelectInSet() &&  //
                   !domain1.isMultiUpdate();
            assert domain1.isHasWhere() &&      //
                   !domain1.isSelectInWhere() &&//
    ...
    public void update_where_using_cast_2() {
        ...
        assert domainList.size() == 2;
        {
            SrUpdateDomain domain1_1 = (SrUpdateDomain) domainList.get(0);
            ...
            assert domain1_1.getCatalog() == null && domain1_1.getSchema() == null && domain1_1.getTable().equals("table1") &&//
                   domain1_1.getSetColumns().size() == 1 && domain1_1.getSetColumns().equals(Collections.singletonList("name")) &&//
                   domain1_1.getWhereColumns().size() == 1 && domain1_1.getWhereColumns().equals(Collections.singletonList("id"));
    ...
    public void update_where_using_cast_3() {
        ...
        assert domainList.size() == 2;
        {
            SrUpdateDomain domain2_1 = (SrUpdateDomain) domainList.get(0);
            ...
            assert domain2_1.getCatalog() == null && domain2_1.getSchema() == null && domain2_1.getTable().equals("table1") &&//
                   domain2_1.getSetColumns().size() == 1 && domain2_1.getSetColumns().equals(Collections.singletonList("name")) &&//
                   domain2_1.getWhereColumns().size() == 1 && domain2_1.getWhereColumns().equals(Collections.singletonList("id"));
    ...
    public void update_where_using_func_1() {
        ...
        {
            SrSelectDomain domain3 = (SrSelectDomain) domainList.get(2);
    ...
    public void update_set_include_subquery_1() {
        ...
        assert domainList.size() == 2;
        {
            ...
            assert domain1.getSqlType() == SecQueryType.UPDATE && domain1.getAuditKind() == SecQueryKind.DML;
            assert domain1.getCatalog() == null && domain1.getSchema() == null && domain1.getTable().equals("table") &&//
                   domain1.getSetColumns().size() == 1 && domain1.getSetColumns().equals(Collections.singletonList("id")) &&//
                   domain1.getWhereColumns().isEmpty();
            assert domain1.isSelectInSet() &&   //
                   !domain1.isMultiUpdate();
            assert !domain1.isHasWhere() &&      //
    ...
    public void update_using_withQuery_1() {
        ...
        assert domainList.size() == 4;
        {
            ...
            assert domain1.getCatalog() == null && domain1.getSchema() == null && domain1.getTable().equals("table2") &&//
                   domain1.getSetColumns().size() == 1 && domain1.getSetColumns().equals(Collections.singletonList("cc")) &&//
        ...
        {
            SrSelectDomain domain4 = (SrSelectDomain) domainList.get(3);
