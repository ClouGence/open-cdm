package com.clougence.clouddm.ds.secdomain.family.starrocks;//package com.clougence.clouddm.ds.secdomain.family.doris;
//
...
//
///**
// * doris not support procedure
// */
//public class DrSecDomainResolve4CallTest extends DrSecDomainTestSupport {
//
//    public DrSecDomainResolve4CallTest(){
//        this.analysisSpi = new DrResAnalysisSpi();
//        this.resolveSpi = new DrSecDomainResolveSpi();
...
//            assert domain.getSqlType() == SecQueryType.CALL && domain.getSqlKind() == SqlKind.CALL;
