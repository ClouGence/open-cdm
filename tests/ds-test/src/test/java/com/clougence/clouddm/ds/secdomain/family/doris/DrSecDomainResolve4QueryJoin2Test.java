...
public class DrSecDomainResolve4QueryJoin2Test extends DrSecDomainTestSupport {

    public DrSecDomainResolve4QueryJoin2Test(){
    ...
    public void join_at_where_2() {
        ...
        {
            DrSelectDomain domain1_3 = (DrSelectDomain) domainList.get(2);
    ...
    public void call_at_select_2() {
        ...
        {
            DrSelectDomain domain6 = (DrSelectDomain) domainList.get(5);
