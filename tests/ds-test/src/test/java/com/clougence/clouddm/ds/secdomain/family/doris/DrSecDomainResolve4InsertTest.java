...
import com.clougence.sql.doris.security.domain.DrInsertDomain;
...
public class DrSecDomainResolve4InsertTest extends DrSecDomainTestSupport {

    public DrSecDomainResolve4InsertTest(){
    ...
    public void insertInto_1() {
        ...
        {
            DrInsertDomain domain1 = (DrInsertDomain) domainList.get(0);
    ...
    public void insertInto_2() {
        String sql = "insert overwrite table `test_schema`.`table2` (`id`, `b`) values (2, 1);";
    ...
    public void insertFromSelect_3() {
        ...
        {
            DrSelectDomain domain4 = (DrSelectDomain) domainList.get(2);
