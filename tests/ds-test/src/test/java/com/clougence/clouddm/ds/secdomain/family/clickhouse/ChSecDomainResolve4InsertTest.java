...
import com.clougence.clouddm.ds.clickhouse.sql.security.domain.ChInsertDomain;
...
public class ChSecDomainResolve4InsertTest extends ChSecDomainTestSupport {

    public ChSecDomainResolve4InsertTest(){
    ...
    public void insertInto_1() {
        ...
        {
            ChInsertDomain domain1 = (ChInsertDomain) domainList.get(0);
    ...
    public void insertMultipleValues_2() {
        String sql = "insert into table `test_schema`.`table2` (`id`, `b`) values (2, 1),(3,5),(1,null);";
    ...
    public void insertFromSelect_3() {
        ...
        {
            ChSelectDomain domain4 = (ChSelectDomain) domainList.get(2);
