 ...
 */
package com.clougence.clouddm.ds.spi.explain.clickhouse;
...
public final class ChExplainPlanTextTest extends ExplainPlanTextTest {
    public ChExplainPlanTextTest(){
        super("spi/explain/clickhouse");
    }

    @Override
    protected ExplainPlanSpi explainPlanSpi() {
        return new ChExplainPlanSpi();
    }
}
