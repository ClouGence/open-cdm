...
import com.clougence.clouddm.ds.maxcompute.sql.security.domain.McUpdateDomain;
...
public class McSecDomainResolve4UpdateTest extends McSecDomainTestSupport {

    public McSecDomainResolve4UpdateTest(){
    ...
    public void update_1() {
        ...
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table/");
        }
        ...
        {
            McUpdateDomain domain1 = (McUpdateDomain) domainList.get(0);
    ...
    public void update_where_using_cast_1() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table1/");
    ...
    public void update_where_using_cast_2() {
        ...
        assert domainList.size() == 2;
        {
            McUpdateDomain domain1_1 = (McUpdateDomain) domainList.get(0);
    ...
    public void update_where_using_cast_3() {
        ...
        assert domainList.size() == 2;
        {
            McUpdateDomain domain2_1 = (McUpdateDomain) domainList.get(0);
    ...
    public void update_where_using_func_1() {
        ...
        assert resList.size() == 3;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table1/");
            assert resList.get(1).getType() == TargetType.Function &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/avg/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/table2/");
        }
    ...
    @Test
    public void ignoreUpdate_1() {
        String sql = "update ignore `table` set id = 1";
    ...
    public void update_set_include_subquery_1() {
        ...
        assert resList.size() == 2;
        {
            ...
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/test/");
        }
    ...
    @Test
    public void update_using_lowPriority_1() {
        String sql1 = "update `table` set id = 2 where table.name = (select id2 from test limit 1)";
        ...
        String sql2 = "update low_priority table1 set name = 1 where id = 1";
    ...
    //        {
    //            assert resList.get(0).getType() == TargetType.Table &&//
    //                   resList.get(0).toDsResPath().getResPath().equals("/default/table2/");
    //            assert resList.get(2).getType() == TargetType.Table &&//
    //                   resList.get(2).toDsResPath().getResPath().equals("/default/table3/");
    //            assert resList.get(1).getType() == TargetType.Table &&//
    //                   resList.get(1).toDsResPath().getResPath().equals("/default/table1/");
    //        }
    //
    //        List<SplitScript> splitScripts = this.splitAnalysisSpi.splitScript(sql, null, 0, 0);
    //        assert splitScripts.size() == 1;
    ...
    //            assert domain2.getSqlType() == SecQueryType.SELECT && domain2.getSqlKind() == SqlKind.QUERY && domain2.getMode() == RdbQueryMode.SUB_WHERE;
    ...
    //            assert domain3.getSqlType() == SecQueryType.SELECT && domain3.getSqlKind() == SqlKind.QUERY && domain3.getMode() == RdbQueryMode.SUB_FROM;
    ...
    //            assert domain4.getSqlType() == SecQueryType.SELECT && domain4.getSqlKind() == SqlKind.QUERY && domain4.getMode() == RdbQueryMode.SUB_WHERE;
