...
public class SrSecDomainResolve4QueryJoin2Test extends SrSecDomainTestSupport {

    public SrSecDomainResolve4QueryJoin2Test(){
    ...
    public void from_innerJoin_1() {
        ...
        assert domainList.size() == 2;
        {
            SrSelectDomain domain1_1 = (SrSelectDomain) domainList.get(0);
    ...
    public void join_at_where_2() {
        ...
        {
            SrSelectDomain domain1_3 = (SrSelectDomain) domainList.get(2);
    ...
    public void subquery_at_select_4() {
        ...
        //        }
        //
        //        List<RuleDomain> domainList = resolveSpi.resolveDomain(dataSourceType, codeInfo(sql));
        // assert list1.size() == 6;
        // TODO
    }
    ...
    public void call_at_select_2() {
        ...
        {
            SrSelectDomain domain6 = (SrSelectDomain) domainList.get(5);
