package com.clougence.clouddm.ds.secdomain.family.mc.notsupportschema;// package com.clougence.clouddm.dsfamily.mysql.secdomain;
...
public class McSecDomainResolve4OtherTest extends McSecDomainTestSupport {
    ...
    public void createView() {
        ...
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.View &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/sale_detail_view/");
        }
    ...
    public void createView2() {
        ...
        {
            assert resList.get(0).getType() == TargetType.View &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/sales_mv/");
        }
    ...
    public void alterMView() {
        ...
        {
            assert resList.get(0).getType() == TargetType.View &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/mf_mv_blank_pts/");
        }
    ...
    public void analyzeTable1() {
        ...
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/srcpart_test/");
        }
        ...
        assert domainList.size() == 1;
        {
            ...
            assert domain.getCatalog() == null && domain.getSchema().equals("default") && domain.getName().equals("srcpart_test");
        }
    }

    @Test
    public void analyzeTable2() {
        String sql = "analyze table a.srcpart_test partition(ds='20201221') compute statistics for columns (key , value);";

        List<ResObject> resList = parserRes(sql);
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/a/default/srcpart_test/");
        }
        ...
        assert domainList.size() == 1;
        {
            RdbResourceDomain domain = (RdbResourceDomain) domainList.get(0);
            assert domain.getSqlType() == SecQueryType.SHOW && domain.getAuditKind() == SecQueryKind.QUERY;
            assert domain.getCatalog().equals("a") && domain.getSchema().equals("default") && domain.getName().equals("srcpart_test");
        }
    }
