...
import com.clougence.clouddm.ds.maxcompute.sql.security.domain.McInsertDomain;
import com.clougence.clouddm.ds.maxcompute.sql.security.domain.McSelectDomain;
import com.clougence.clouddm.sdk.sql.secrules.rdb.RdbInsertConflictStrategy;
...
public class McSecDomainResolve4InsertTest extends McSecDomainTestSupport {
    ...
    public void insertInto_2() {
        String sql = "insert into `default`.`table2` (`id`, `b`) values (2, 1);";

        List<ResObject> resList = parserRes(sql);
        assert resList.size() == 1;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table2/");
        }
        ...
        assert domainList.size() == 1;
        {
            McInsertDomain domain1 = (McInsertDomain) domainList.get(0);
            assert domain1.getSqlType() == SecQueryType.INSERT && domain1.getAuditKind() == SecQueryKind.DML;
            assert domain1.getCatalog() == null && domain1.getSchema().equals("default") && domain1.getTable().equals("table2");
            assert domain1.getColumns().contains("id") && domain1.getColumns().contains("b");
            assert !domain1.isFromSelect() &&   //
                   domain1.getConflict() == RdbInsertConflictStrategy.NONE &&//
                   !domain1.isHasSubQuery() &&  //
    ...
    public void insertInto_3() {
        String sql = "insert into `default`.`table2` PARTITION (sale_date='2013', region='china') (`id`, `b`) values (2, 1) ZORDER BY customer_id, total_price;";
    ...
    public void insertValueSelect() {
        String sql = "insert into `default`.`table2` (`id`, `b`) values ((select id from table1 limit 1), 1);";
        ...
        assert resList.size() == 2;
        {
            ...
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/table1/");
        }
    ...
    public void insertMultipleValues_1() {
        String sql = "insert into `default`.`table2` (`id`, `b`) values (2, 1),(3,5),(1,3);";
    ...
    public void insertMultipleValues_2() {
        String sql = "insert into `default`.`table2` (`id`, `b`) values (2, 1),(3,5),(1,null);";
    ...
    public void insertInto_NullValue_1() {
        String sql = "insert into `default`.`table2` (`id`, `b`) values (null, 1);";
    ...
    public void insertFromSelect_1() {
        ...
        assert resList.size() == 2;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/test_sch/table2/");
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/table/");
        }
    ...
    public void insertFromSelect_3() {
        ...
        assert resList.size() == 3;
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/table2/");
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/orders1/");
            assert resList.get(2).getType() == TargetType.Table &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/orders2/");
        }
