...
public class ChSecDomainResolve4QueryJoin2Test extends ChSecDomainTestSupport {

    public ChSecDomainResolve4QueryJoin2Test(){
    ...
    public void join_at_where_2() {
        ...
        {
            ChSelectDomain domain1_3 = (ChSelectDomain) domainList.get(2);
    ...
    public void call_at_select_2() {
        ...
        {
            ChSelectDomain domain6 = (ChSelectDomain) domainList.get(5);
