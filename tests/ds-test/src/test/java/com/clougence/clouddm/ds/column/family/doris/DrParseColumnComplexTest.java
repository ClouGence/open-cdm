...
public class DrParseColumnComplexTest extends DrSelectColumnTestSupport {

    public DrParseColumnComplexTest(){
    ...
    public void test1() {
        List<SelectItem> selectItems = spi.parseSelectColumn("-- 包含子查询的跨Schema三表连接[1,7](@ref)\n" //
                                                             ...
                                                             "       (SELECT MAX(s2t2.column3) as m \n"//
                                                             + "        FROM catalog2.schema2.table2 s2t2 \n" + //
    ...
    public void test2() {
        List<SelectItem> selectItems = spi.parseSelectColumn("SELECT s1t1.column2 AS category,\n" +//
                                                             ...
                                                             "       (SELECT COUNT(*) as c \n" +//
                                                             "        FROM catalog2.schema2.table2 \n" +//
                                                             "        WHERE column3 = s1t1.column3) AS related_count\n" +//
                                                             "FROM schema1.table1 s1t1\n" +//
                                                             "LEFT JOIN catalog2.schema1.table2 s1t2 \n" +//
    ...
    public void test3() {
        List<SelectItem> selectItems = spi.parseSelectColumn("(\n" +//
                                                             ...
                                                             "    FROM schema1.table1 s1t1\n" +//
                                                             "    LEFT JOIN catalog2.schema2.table2 s2t2 \n" +//
    ...
    public void test4() {
        List<SelectItem> selectItems = spi
            .parseSelectColumn("select a.column1,b.column2 from (select * from table1 union select * from catalog2.schema1.table2) a "
                               + "left join (select * from schema2.table1 union select * from catalog2.schema2.table2) b on a.column1 = b.column1", createContextInfo());
