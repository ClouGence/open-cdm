package com.clougence.clouddm.ds.rules.special.greenplum;
...
public class GpRuleNameNotInKeywordsTest extends MyAbstractRuleTest {
    ...
    private final String scriptResource = "rule-test/special/greenplum/gp-name-not-in-keywords.txt";
...
//        assert !runScript(scriptResource, sql, null);
        ...
        assert runScript(scriptResource, sql, null);
//        sql = "create schema test.abc_test";
//        assert runScript(scriptResource, sql, null);
