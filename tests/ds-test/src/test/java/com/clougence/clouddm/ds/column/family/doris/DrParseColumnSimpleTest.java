...
public class DrParseColumnSimpleTest extends DrSelectColumnTestSupport {

    public DrParseColumnSimpleTest(){
        spi = new DrSelectColumnAnalysisSpi(new TestMetaServiceImpl());
    }

    @Test
    public void test1() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from table1", createContextInfo());
    ...
    @Test
    public void test1_1() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from (select * from table1)", createContextInfo());
        assert selectItems.size() == 6;
        for (int i = 1; i <= selectItems.size(); i++) {
            SelectItem selectItem = selectItems.get(i - 1);
    ...
    @Test
    public void test1_2() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from (select * from table1) c", createContextInfo());
        assert selectItems.size() == 6;
        for (int i = 1; i <= selectItems.size(); i++) {
            SelectItem selectItem = selectItems.get(i - 1);
    ...
    @Test
    public void test2() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from table1 a", createContextInfo());
        assert selectItems.size() == 6;
        for (int i = 1; i <= selectItems.size(); i++) {
            SelectItem selectItem = selectItems.get(i - 1);
    ...
    @Test
    public void test3() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select column1 from table1", createContextInfo());
    ...
    @Test
    public void test4() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select column1 as test from table1 a", createContextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
    ...
    @Test
    public void test5() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from schema2.table1", createContextInfo());
        assert selectItems.size() == 6;
        for (int i = 1; i <= selectItems.size(); i++) {
            SelectItem selectItem = selectItems.get(i - 1);
            assert selectItem.getTableAlias().equals("table1") && selectItem.getItemAlias().equals("column" + i);
    ...
    @Test
    public void test6() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select * from schema2.table1 a", createContextInfo());
        assert selectItems.size() == 6;
        for (int i = 1; i <= selectItems.size(); i++) {
            SelectItem selectItem = selectItems.get(i - 1);
            assert selectItem.getTableAlias().equals("a") && selectItem.getItemAlias().equals("column" + i);
    ...
    @Test
    public void test7() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select column1 from schema2.table1", createContextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
        assert selectItem.getTableAlias() == null && selectItem.getItemAlias().equals("column1");
        RealColumn column = selectItem.getColumns().get(0);
    ...
    @Test
    public void test8() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select column1 as test from schema2.table1 a", createContextInfo());
        assert selectItems.size() == 1;
        SelectItem selectItem = selectItems.get(0);
        assert selectItem.getItemAlias().equals("test");
        RealColumn column = selectItem.getColumns().get(0);
    ...
    @Test
    public void test9() {
        List<SelectItem> selectItems = spi.parseSelectColumn("select *,test(column1) as s from schema2.table1", createContextInfo());
