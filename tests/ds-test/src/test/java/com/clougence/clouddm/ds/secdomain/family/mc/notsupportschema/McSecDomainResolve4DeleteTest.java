...
import com.clougence.clouddm.ds.maxcompute.sql.security.domain.McDeleteDomain;
...
public class McSecDomainResolve4DeleteTest extends McSecDomainTestSupport {

    public McSecDomainResolve4DeleteTest(){
    ...
    public void delete_from_1() {
        ...
        {
            McDeleteDomain domain1 = (McDeleteDomain) domainList.get(0);
    ...
    public void delete_from_2_2() {
        ...
        assert domainList.size() == 1;
        {
            McDeleteDomain domain2 = (McDeleteDomain) domainList.get(0);
    ...
    public void delete_hasSubQuery_1() {
        ...
        {
            assert resList.get(0).getType() == TargetType.Table &&//
                   resList.get(0).toDsResPath().getResPath().equals("/test_db/default/test1/");
            assert resList.get(1).getType() == TargetType.Table &&//
                   resList.get(1).toDsResPath().getResPath().equals("/test_db/default/test2/");
            assert resList.get(2).getType() == TargetType.Function &&//
                   resList.get(2).toDsResPath().getResPath().equals("/test_db/default/max/");
        }
