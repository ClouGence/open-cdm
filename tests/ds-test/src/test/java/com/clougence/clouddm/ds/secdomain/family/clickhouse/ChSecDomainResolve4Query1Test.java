...
import com.clougence.clouddm.ds.clickhouse.sql.security.domain.ChSelectDomain;
...
public class ChSecDomainResolve4Query1Test extends ChSecDomainTestSupport {

    public ChSecDomainResolve4Query1Test(){
    ...
    public void selectQuery_1() {
        String sql = "select id,name from abc order by id";
    ...
    public void selectQuery_2() {
        String sql = "select id,name from abc x";
    ...
    public void selectQuery_2_2() {
        ...
        assert domainList.size() == 1;
        {
            ChSelectDomain domain2 = (ChSelectDomain) domainList.get(0);
    ...
    public void selectQuery_2_3() {
        ...
        assert domainList.size() == 1;
        {
            ChSelectDomain domain3 = (ChSelectDomain) domainList.get(0);
    ...
    public void selectQuery_8() {
        ...
        {
            ChSelectDomain domain1 = (ChSelectDomain) domainList.get(3);
    ...
    public void whereBetween1() {
        ...
        {
            ChSelectDomain domain1 = (ChSelectDomain) domainList.get(1);
    ...
    public void conditionIn_3() {
        ...
        {
            ChSelectDomain domain2 = (ChSelectDomain) domainList.get(1);
    ...
    @Test
    public void union_1() {
        String sql = "select * from table_1 union all select * from table_2";
    ...
    @Test
    public void union_2() {
        String sql = "select * from (select * from table_1 union all select * from table_2) t";
        ...
        {
            ChSelectDomain domain2 = (ChSelectDomain) domainList.get(2);
            assert domain2.getSqlType() == SecQueryType.SELECT && domain2.getAuditKind() == SecQueryKind.QUERY && domain2.getMode() == RdbQueryMode.SUB_FROM;
            assert domain2.getSelectColumns().isEmpty() &&//
                   domain2.getSelectVariables().isEmpty() &&//
                   domain2.getSelectFunc().isEmpty() &&//
    ...
    @Test
    public void union_3() {
        String sql = "select * from table_0 a join (select * from table_1 union all select * from table_2) b on 1=1";
        ...
        {
            ChSelectDomain domain3 = (ChSelectDomain) domainList.get(2);
    ...
    @Test
    public void union_4() {
        String sql = "select id, name from table_1 where id in (select a.id from table_1 a left join (select * from table_1 union all select * from table_2) b on a.id = b.id)";
        ...
        {
            ChSelectDomain domain4 = (ChSelectDomain) domainList.get(3);
    ...
    public void union_5_1() {
        String sql = "select id = (select a.id from table_1 a left join (select * from table_1 union all select * from table_2) b on a.id = b.id limit 1) from table_1";
    ...
    public void union_5_2() {
        String sql = "select (select a.id from table_1 a left join (select * from table_1 union all select * from table_2) b on a.id = b.id limit 1) = id from table_1";
    ...
    public void union_6_1() {
        ...
        {
            ChSelectDomain domain3 = (ChSelectDomain) domainList.get(1);
    ...
    public void with_query_3() {
        ...
        {
            ChSelectDomain domain4 = (ChSelectDomain) domainList.get(4);
            assert domain4.getSqlType() == SecQueryType.SELECT && domain4.getAuditKind() == SecQueryKind.QUERY && domain4.getMode() == RdbQueryMode.SUB_FROM;
            assert domain4.getSelectColumns().isEmpty() &&//
                   domain4.getSelectVariables().isEmpty() &&//
                   domain4.getSelectFunc().isEmpty() &&//
    ...
    public void with_query_4() {
        String sql = "select * from table_1 a join (with one as (select 1) select * from table_1) b on 1=1";
