export const queryApi = {
  ...
  dmQueryDownloadResult: '/clouddm/console/api/v1/query/downloadResult',
  dmQueryFetchResultPage: '/clouddm/console/api/v1/query/fetchResultPage',
  dmQueryFetchResultData: '/clouddm/console/api/v1/query/fetchResultData'
};
