...
public class RagApiExtraConfig extends DsExtraConfig {

    @DsConfigDef(name = "dbsJson", defaultValue = "[{\"table\":\"my_first_knowledge\"}]", descKey = I18nDsConfigMsgKeys.DS_CONFIG_VIRTUAL_DBS, readOnly = false, kvConfWebOp = KvConfValType.JSON)
