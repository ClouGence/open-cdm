package com.clougence.rdp.component.mcp.json;

import static com.clougence.rdp.component.mcp.utils.RagUtils.copy;
import static com.clougence.rdp.component.mcp.utils.RagUtils.quoted;
...
public class JsonObjectSchema implements JsonSchemaElement {
    ...
    public Builder toBuilder() {
        return builder().description(this.description)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.description, that.description) && Objects.equals(this.properties, that.properties) && Objects.equals(this.required, that.required)
               && Objects.equals(this.additionalProperties, that.additionalProperties) && Objects.equals(this.definitions, that.definitions);
    }
    ...
    public String toString() {
        return "JsonObjectSchema {" + "description = " + quoted(description) + ", properties = " + properties + ", required = " + required + ", additionalProperties = "
               + additionalProperties + ", definitions = " + definitions + " }";
    }
}
