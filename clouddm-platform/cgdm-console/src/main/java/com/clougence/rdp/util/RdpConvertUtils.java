...
public class RdpConvertUtils {
    ...
    public static ResAuthVO convertToResAuthVO(RdpResAuthDO dsAuthDO) {
    ...
    public static RdpResAuthDO convertToAuthDOFromInsert(String targetUid, ModifyAuthForAppend info, String instId, String instDesc, AuthKind authKind) {
        RdpResAuthDO dsAuthDO = new RdpResAuthDO();
    ...
    public static RdpResAuthDO convertToAuthDOFromApply(String targetUid, ApplyAuth info, AuthKind authKind) {
        RdpResAuthDO dsAuthDO = new RdpResAuthDO();
        dsAuthDO.setResId(info.getResId());
    ...
    public static RdpResAuthDO convertToAuthDOFromUpdate(String targetUid, ModifyAuthForUpdate info, String instId, String instDesc, AuthKind authKind) {
        RdpResAuthDO dsAuthDO = new RdpResAuthDO();
    ...
    private static void fillResPath(RdpResAuthDO dsAuthDO, List<String> resPaths) {
    ...
    public static RdpResAuthDO convertToAuthDOFromUpdate(String targetUid, RdpResAuthDO info, AuthKind authKind, RdpDataSourceMapper rdpDsMapper) {
    ...
    public static RdpResAuthDO convertToAuthDOFromDelete(String targetUid, ModifyAuthForDelete info, AuthKind authKind) {
        RdpResAuthDO dsAuthDO = new RdpResAuthDO();
        dsAuthDO.setId(info.getAuthId());
        dsAuthDO.setResId(info.getResId());
        //dsAuthDO.setResInstId(dsDO.getInstanceId());
    ...
    public static RdpResAuthDO convertToAuthDOByDataSource(RdpDataSourceDO rdpDatasourceDo, List<String> authLabels) {
        RdpResAuthDO rdpResAuthDO = new RdpResAuthDO();
        rdpResAuthDO.setResId(rdpDatasourceDo.getId());
        rdpResAuthDO.setResInstId(rdpDatasourceDo.getInstanceId());
        rdpResAuthDO.setResDesc(rdpDatasourceDo.getInstanceDesc());
        rdpResAuthDO.setKindType(AuthKind.DataSource);
        rdpResAuthDO.setAuthLabels(authLabels);
        return rdpResAuthDO;
    }
