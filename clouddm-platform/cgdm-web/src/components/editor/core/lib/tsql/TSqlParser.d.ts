...
export declare class TSqlParser extends Parser {
    ...
    static readonly SEMICOLON = 1208;
    static readonly RULE_program = 0;
    static readonly RULE_tsql_file = 1;
    static readonly RULE_batch = 2;
    static readonly RULE_batch_level_statement = 3;
    static readonly RULE_sql_clauses = 4;
    static readonly RULE_dml_clause = 5;
    static readonly RULE_ddl_clause = 6;
    static readonly RULE_backup_statement = 7;
    static readonly RULE_cfl_statement = 8;
    static readonly RULE_block_statement = 9;
    static readonly RULE_break_statement = 10;
    static readonly RULE_continue_statement = 11;
    static readonly RULE_goto_statement = 12;
    static readonly RULE_return_statement = 13;
    static readonly RULE_if_statement = 14;
    static readonly RULE_throw_statement = 15;
    static readonly RULE_throw_error_number = 16;
    static readonly RULE_throw_message = 17;
    static readonly RULE_throw_state = 18;
    static readonly RULE_try_catch_statement = 19;
    static readonly RULE_waitfor_statement = 20;
    static readonly RULE_while_statement = 21;
    static readonly RULE_print_statement = 22;
    static readonly RULE_raiseerror_statement = 23;
    static readonly RULE_empty_statement = 24;
    static readonly RULE_another_statement = 25;
    static readonly RULE_alter_application_role = 26;
    static readonly RULE_alter_xml_schema_collection = 27;
    static readonly RULE_create_application_role = 28;
    static readonly RULE_drop_aggregate = 29;
    static readonly RULE_drop_application_role = 30;
    static readonly RULE_alter_assembly = 31;
    static readonly RULE_alter_assembly_start = 32;
    static readonly RULE_alter_assembly_clause = 33;
    static readonly RULE_alter_assembly_from_clause = 34;
    static readonly RULE_alter_assembly_from_clause_start = 35;
    static readonly RULE_alter_assembly_drop_clause = 36;
    static readonly RULE_alter_assembly_drop_multiple_files = 37;
    static readonly RULE_alter_assembly_drop = 38;
    static readonly RULE_alter_assembly_add_clause = 39;
    static readonly RULE_alter_asssembly_add_clause_start = 40;
    static readonly RULE_alter_assembly_client_file_clause = 41;
    static readonly RULE_alter_assembly_file_name = 42;
    static readonly RULE_alter_assembly_file_bits = 43;
    static readonly RULE_alter_assembly_as = 44;
    static readonly RULE_alter_assembly_with_clause = 45;
    static readonly RULE_alter_assembly_with = 46;
    static readonly RULE_client_assembly_specifier = 47;
    static readonly RULE_assembly_option = 48;
    static readonly RULE_network_file_share = 49;
    static readonly RULE_network_computer = 50;
    static readonly RULE_network_file_start = 51;
    static readonly RULE_file_path = 52;
    static readonly RULE_file_directory_path_separator = 53;
    static readonly RULE_local_file = 54;
    static readonly RULE_local_drive = 55;
    static readonly RULE_multiple_local_files = 56;
    static readonly RULE_multiple_local_file_start = 57;
    static readonly RULE_create_assembly = 58;
    static readonly RULE_drop_assembly = 59;
    static readonly RULE_alter_asymmetric_key = 60;
    static readonly RULE_alter_asymmetric_key_start = 61;
    static readonly RULE_asymmetric_key_option = 62;
    static readonly RULE_asymmetric_key_option_start = 63;
    static readonly RULE_asymmetric_key_password_change_option = 64;
    static readonly RULE_create_asymmetric_key = 65;
    static readonly RULE_drop_asymmetric_key = 66;
    static readonly RULE_alter_authorization = 67;
    static readonly RULE_authorization_grantee = 68;
    static readonly RULE_entity_to = 69;
    static readonly RULE_colon_colon = 70;
    static readonly RULE_alter_authorization_start = 71;
    static readonly RULE_alter_authorization_for_sql_database = 72;
    static readonly RULE_alter_authorization_for_azure_dw = 73;
    static readonly RULE_alter_authorization_for_parallel_dw = 74;
    static readonly RULE_class_type = 75;
    static readonly RULE_class_type_for_sql_database = 76;
    static readonly RULE_class_type_for_azure_dw = 77;
    static readonly RULE_class_type_for_parallel_dw = 78;
    static readonly RULE_class_type_for_grant = 79;
    static readonly RULE_drop_availability_group = 80;
    static readonly RULE_alter_availability_group = 81;
    static readonly RULE_alter_availability_group_start = 82;
    static readonly RULE_alter_availability_group_options = 83;
    static readonly RULE_ip_v4_failover = 84;
    static readonly RULE_ip_v6_failover = 85;
    static readonly RULE_create_or_alter_broker_priority = 86;
    static readonly RULE_drop_broker_priority = 87;
    static readonly RULE_alter_certificate = 88;
    static readonly RULE_alter_column_encryption_key = 89;
    static readonly RULE_create_column_encryption_key = 90;
    static readonly RULE_drop_certificate = 91;
    static readonly RULE_drop_column_encryption_key = 92;
    static readonly RULE_drop_column_master_key = 93;
    static readonly RULE_drop_contract = 94;
    static readonly RULE_drop_credential = 95;
    static readonly RULE_drop_cryptograhic_provider = 96;
    static readonly RULE_drop_database = 97;
    static readonly RULE_drop_database_audit_specification = 98;
    static readonly RULE_drop_database_encryption_key = 99;
    static readonly RULE_drop_database_scoped_credential = 100;
    static readonly RULE_drop_default = 101;
    static readonly RULE_drop_endpoint = 102;
    static readonly RULE_drop_external_data_source = 103;
    static readonly RULE_drop_external_file_format = 104;
    static readonly RULE_drop_external_library = 105;
    static readonly RULE_drop_external_resource_pool = 106;
    static readonly RULE_drop_external_table = 107;
    static readonly RULE_drop_event_notifications = 108;
    static readonly RULE_drop_event_session = 109;
    static readonly RULE_drop_fulltext_catalog = 110;
    static readonly RULE_drop_fulltext_index = 111;
    static readonly RULE_drop_fulltext_stoplist = 112;
    static readonly RULE_drop_login = 113;
    static readonly RULE_drop_master_key = 114;
    static readonly RULE_drop_message_type = 115;
    static readonly RULE_drop_partition_function = 116;
    static readonly RULE_drop_partition_scheme = 117;
    static readonly RULE_drop_queue = 118;
    static readonly RULE_drop_remote_service_binding = 119;
    static readonly RULE_drop_resource_pool = 120;
    static readonly RULE_drop_db_role = 121;
    static readonly RULE_drop_route = 122;
    static readonly RULE_drop_rule = 123;
    static readonly RULE_drop_schema = 124;
    static readonly RULE_drop_search_property_list = 125;
    static readonly RULE_drop_security_policy = 126;
    static readonly RULE_drop_sequence = 127;
    static readonly RULE_drop_server_audit = 128;
    static readonly RULE_drop_server_audit_specification = 129;
    static readonly RULE_drop_server_role = 130;
    static readonly RULE_drop_service = 131;
    static readonly RULE_drop_signature = 132;
    static readonly RULE_drop_statistics_name_azure_dw_and_pdw = 133;
    static readonly RULE_drop_symmetric_key = 134;
    static readonly RULE_drop_synonym = 135;
    static readonly RULE_drop_user = 136;
    static readonly RULE_drop_workload_group = 137;
    static readonly RULE_drop_xml_schema_collection = 138;
    static readonly RULE_disable_trigger = 139;
    static readonly RULE_enable_trigger = 140;
    static readonly RULE_lock_table = 141;
    static readonly RULE_truncate_table = 142;
    static readonly RULE_create_column_master_key = 143;
    static readonly RULE_alter_credential = 144;
    static readonly RULE_create_credential = 145;
    static readonly RULE_alter_cryptographic_provider = 146;
    static readonly RULE_create_cryptographic_provider = 147;
    static readonly RULE_create_endpoint = 148;
    static readonly RULE_endpoint_encryption_alogorithm_clause = 149;
    static readonly RULE_endpoint_authentication_clause = 150;
    static readonly RULE_endpoint_listener_clause = 151;
    static readonly RULE_create_event_notification = 152;
    static readonly RULE_create_or_alter_event_session = 153;
    static readonly RULE_event_session_predicate_expression = 154;
    static readonly RULE_event_session_predicate_factor = 155;
    static readonly RULE_event_session_predicate_leaf = 156;
    static readonly RULE_alter_external_data_source = 157;
    static readonly RULE_alter_external_library = 158;
    static readonly RULE_create_external_library = 159;
    static readonly RULE_alter_external_resource_pool = 160;
    static readonly RULE_create_external_resource_pool = 161;
    static readonly RULE_alter_fulltext_catalog = 162;
    static readonly RULE_create_fulltext_catalog = 163;
    static readonly RULE_alter_fulltext_stoplist = 164;
    static readonly RULE_create_fulltext_stoplist = 165;
    static readonly RULE_alter_login_sql_server = 166;
    static readonly RULE_create_login_sql_server = 167;
    static readonly RULE_alter_login_azure_sql = 168;
    static readonly RULE_create_login_azure_sql = 169;
    static readonly RULE_alter_login_azure_sql_dw_and_pdw = 170;
    static readonly RULE_create_login_pdw = 171;
    static readonly RULE_alter_master_key_sql_server = 172;
    static readonly RULE_create_master_key_sql_server = 173;
    static readonly RULE_alter_master_key_azure_sql = 174;
    static readonly RULE_create_master_key_azure_sql = 175;
    static readonly RULE_alter_message_type = 176;
    static readonly RULE_alter_partition_function = 177;
    static readonly RULE_alter_partition_scheme = 178;
    static readonly RULE_alter_remote_service_binding = 179;
    static readonly RULE_create_remote_service_binding = 180;
    static readonly RULE_create_resource_pool = 181;
    static readonly RULE_alter_resource_governor = 182;
    static readonly RULE_alter_database_audit_specification = 183;
    static readonly RULE_audit_action_spec_group = 184;
    static readonly RULE_audit_action_specification = 185;
    static readonly RULE_action_specification = 186;
    static readonly RULE_audit_class_name = 187;
    static readonly RULE_audit_securable = 188;
    static readonly RULE_alter_db_role = 189;
    static readonly RULE_create_database_audit_specification = 190;
    static readonly RULE_create_db_role = 191;
    static readonly RULE_create_route = 192;
    static readonly RULE_create_rule = 193;
    static readonly RULE_alter_schema_sql = 194;
    static readonly RULE_create_schema = 195;
    static readonly RULE_create_schema_azure_sql_dw_and_pdw = 196;
    static readonly RULE_alter_schema_azure_sql_dw_and_pdw = 197;
    static readonly RULE_create_search_property_list = 198;
    static readonly RULE_create_security_policy = 199;
    static readonly RULE_alter_sequence = 200;
    static readonly RULE_create_sequence = 201;
    static readonly RULE_alter_server_audit = 202;
    static readonly RULE_create_server_audit = 203;
    static readonly RULE_alter_server_audit_specification = 204;
    static readonly RULE_create_server_audit_specification = 205;
    static readonly RULE_alter_server_configuration = 206;
    static readonly RULE_alter_server_role = 207;
    static readonly RULE_create_server_role = 208;
    static readonly RULE_alter_server_role_pdw = 209;
    static readonly RULE_alter_service = 210;
    static readonly RULE_opt_arg_clause = 211;
    static readonly RULE_create_service = 212;
    static readonly RULE_alter_service_master_key = 213;
    static readonly RULE_alter_symmetric_key = 214;
    static readonly RULE_create_synonym = 215;
    static readonly RULE_alter_user = 216;
    static readonly RULE_create_user = 217;
    static readonly RULE_create_user_azure_sql_dw = 218;
    static readonly RULE_alter_user_azure_sql = 219;
    static readonly RULE_alter_workload_group = 220;
    static readonly RULE_create_workload_group = 221;
    static readonly RULE_create_xml_schema_collection = 222;
    static readonly RULE_create_partition_function = 223;
    static readonly RULE_create_partition_scheme = 224;
    static readonly RULE_create_queue = 225;
    static readonly RULE_queue_settings = 226;
    static readonly RULE_alter_queue = 227;
    static readonly RULE_queue_action = 228;
    static readonly RULE_queue_rebuild_options = 229;
    static readonly RULE_create_contract = 230;
    static readonly RULE_conversation_statement = 231;
    static readonly RULE_message_statement = 232;
    static readonly RULE_merge_statement = 233;
    static readonly RULE_when_matches = 234;
    static readonly RULE_merge_matched = 235;
    static readonly RULE_merge_not_matched = 236;
    static readonly RULE_delete_statement = 237;
    static readonly RULE_delete_statement_from = 238;
    static readonly RULE_insert_statement = 239;
    static readonly RULE_insert_statement_value = 240;
    static readonly RULE_receive_statement = 241;
    static readonly RULE_select_statement_standalone = 242;
    static readonly RULE_select_statement = 243;
    static readonly RULE_time = 244;
    static readonly RULE_update_statement = 245;
    static readonly RULE_output_clause = 246;
    static readonly RULE_output_dml_list_elem = 247;
    static readonly RULE_create_database = 248;
    static readonly RULE_create_index = 249;
    static readonly RULE_create_index_options = 250;
    static readonly RULE_relational_index_option = 251;
    static readonly RULE_alter_index = 252;
    static readonly RULE_resumable_index_options = 253;
    static readonly RULE_resumable_index_option = 254;
    static readonly RULE_reorganize_partition = 255;
    static readonly RULE_reorganize_options = 256;
    static readonly RULE_reorganize_option = 257;
    static readonly RULE_set_index_options = 258;
    static readonly RULE_set_index_option = 259;
    static readonly RULE_rebuild_partition = 260;
    static readonly RULE_rebuild_index_options = 261;
    static readonly RULE_rebuild_index_option = 262;
    static readonly RULE_single_partition_rebuild_index_options = 263;
    static readonly RULE_single_partition_rebuild_index_option = 264;
    static readonly RULE_on_partitions = 265;
    static readonly RULE_create_columnstore_index = 266;
    static readonly RULE_create_columnstore_index_options = 267;
    static readonly RULE_columnstore_index_option = 268;
    static readonly RULE_create_nonclustered_columnstore_index = 269;
    static readonly RULE_create_xml_index = 270;
    static readonly RULE_xml_index_options = 271;
    static readonly RULE_xml_index_option = 272;
    static readonly RULE_create_or_alter_procedure = 273;
    static readonly RULE_as_external_name = 274;
    static readonly RULE_create_or_alter_trigger = 275;
    static readonly RULE_create_or_alter_dml_trigger = 276;
    static readonly RULE_dml_trigger_option = 277;
    static readonly RULE_dml_trigger_operation = 278;
    static readonly RULE_create_or_alter_ddl_trigger = 279;
    static readonly RULE_ddl_trigger_operation = 280;
    static readonly RULE_create_or_alter_function = 281;
    static readonly RULE_func_body_returns_select = 282;
    static readonly RULE_func_body_returns_table = 283;
    static readonly RULE_func_body_returns_scalar = 284;
    static readonly RULE_procedure_param_default_value = 285;
    static readonly RULE_procedure_param = 286;
    static readonly RULE_procedure_option = 287;
    static readonly RULE_function_option = 288;
    static readonly RULE_create_statistics = 289;
    static readonly RULE_update_statistics = 290;
    static readonly RULE_update_statistics_options = 291;
    static readonly RULE_update_statistics_option = 292;
    static readonly RULE_create_table = 293;
    static readonly RULE_table_indices = 294;
    static readonly RULE_table_options = 295;
    static readonly RULE_table_option = 296;
    static readonly RULE_create_table_index_options = 297;
    static readonly RULE_create_table_index_option = 298;
    static readonly RULE_create_view = 299;
    static readonly RULE_view_attribute = 300;
    static readonly RULE_alter_table = 301;
    static readonly RULE_switch_partition = 302;
    static readonly RULE_low_priority_lock_wait = 303;
    static readonly RULE_alter_database = 304;
    static readonly RULE_add_or_modify_files = 305;
    static readonly RULE_filespec = 306;
    static readonly RULE_add_or_modify_filegroups = 307;
    static readonly RULE_filegroup_updatability_option = 308;
    static readonly RULE_database_optionspec = 309;
    static readonly RULE_auto_option = 310;
    static readonly RULE_change_tracking_option = 311;
    static readonly RULE_change_tracking_option_list = 312;
    static readonly RULE_containment_option = 313;
    static readonly RULE_cursor_option = 314;
    static readonly RULE_alter_endpoint = 315;
    static readonly RULE_database_mirroring_option = 316;
    static readonly RULE_mirroring_set_option = 317;
    static readonly RULE_mirroring_partner = 318;
    static readonly RULE_mirroring_witness = 319;
    static readonly RULE_witness_partner_equal = 320;
    static readonly RULE_partner_option = 321;
    static readonly RULE_witness_option = 322;
    static readonly RULE_witness_server = 323;
    static readonly RULE_partner_server = 324;
    static readonly RULE_mirroring_host_port_seperator = 325;
    static readonly RULE_partner_server_tcp_prefix = 326;
    static readonly RULE_port_number = 327;
    static readonly RULE_host = 328;
    static readonly RULE_date_correlation_optimization_option = 329;
    static readonly RULE_db_encryption_option = 330;
    static readonly RULE_db_state_option = 331;
    static readonly RULE_db_update_option = 332;
    static readonly RULE_db_user_access_option = 333;
    static readonly RULE_delayed_durability_option = 334;
    static readonly RULE_external_access_option = 335;
    static readonly RULE_hadr_options = 336;
    static readonly RULE_mixed_page_allocation_option = 337;
    static readonly RULE_parameterization_option = 338;
    static readonly RULE_recovery_option = 339;
    static readonly RULE_service_broker_option = 340;
    static readonly RULE_snapshot_option = 341;
    static readonly RULE_sql_option = 342;
    static readonly RULE_target_recovery_time_option = 343;
    static readonly RULE_termination = 344;
    static readonly RULE_drop_index = 345;
    static readonly RULE_drop_relational_or_xml_or_spatial_index = 346;
    static readonly RULE_drop_backward_compatible_index = 347;
    static readonly RULE_drop_procedure = 348;
    static readonly RULE_drop_trigger = 349;
    static readonly RULE_drop_dml_trigger = 350;
    static readonly RULE_drop_ddl_trigger = 351;
    static readonly RULE_drop_function = 352;
    static readonly RULE_drop_statistics = 353;
    static readonly RULE_drop_table = 354;
    static readonly RULE_drop_view = 355;
    static readonly RULE_create_type = 356;
    static readonly RULE_drop_type = 357;
    static readonly RULE_rowset_function_limited = 358;
    static readonly RULE_openquery = 359;
    static readonly RULE_opendatasource = 360;
    static readonly RULE_declare_statement = 361;
    static readonly RULE_xml_declaration = 362;
    static readonly RULE_cursor_statement = 363;
    static readonly RULE_backup_database = 364;
    static readonly RULE_backup_log = 365;
    static readonly RULE_backup_certificate = 366;
    static readonly RULE_backup_master_key = 367;
    static readonly RULE_backup_service_master_key = 368;
    static readonly RULE_kill_statement = 369;
    static readonly RULE_kill_process = 370;
    static readonly RULE_kill_query_notification = 371;
    static readonly RULE_kill_stats_job = 372;
    static readonly RULE_execute_statement = 373;
    static readonly RULE_execute_body_batch = 374;
    static readonly RULE_execute_body = 375;
    static readonly RULE_execute_statement_arg = 376;
    static readonly RULE_execute_statement_arg_named = 377;
    static readonly RULE_execute_statement_arg_unnamed = 378;
    static readonly RULE_execute_parameter = 379;
    static readonly RULE_execute_var_string = 380;
    static readonly RULE_security_statement = 381;
    static readonly RULE_principal_id = 382;
    static readonly RULE_create_certificate = 383;
    static readonly RULE_existing_keys = 384;
    static readonly RULE_private_key_options = 385;
    static readonly RULE_generate_new_keys = 386;
    static readonly RULE_date_options = 387;
    static readonly RULE_open_key = 388;
    static readonly RULE_close_key = 389;
    static readonly RULE_create_key = 390;
    static readonly RULE_key_options = 391;
    static readonly RULE_algorithm = 392;
    static readonly RULE_encryption_mechanism = 393;
    static readonly RULE_decryption_mechanism = 394;
    static readonly RULE_grant_permission = 395;
    static readonly RULE_set_statement = 396;
    static readonly RULE_transaction_statement = 397;
    static readonly RULE_go_statement = 398;
    static readonly RULE_use_statement = 399;
    static readonly RULE_setuser_statement = 400;
    static readonly RULE_reconfigure_statement = 401;
    static readonly RULE_shutdown_statement = 402;
    static readonly RULE_checkpoint_statement = 403;
    static readonly RULE_dbcc_checkalloc_option = 404;
    static readonly RULE_dbcc_checkalloc = 405;
    static readonly RULE_dbcc_checkcatalog = 406;
    static readonly RULE_dbcc_checkconstraints_option = 407;
    static readonly RULE_dbcc_checkconstraints = 408;
    static readonly RULE_dbcc_checkdb_table_option = 409;
    static readonly RULE_dbcc_checkdb = 410;
    static readonly RULE_dbcc_checkfilegroup_option = 411;
    static readonly RULE_dbcc_checkfilegroup = 412;
    static readonly RULE_dbcc_checktable = 413;
    static readonly RULE_dbcc_cleantable = 414;
    static readonly RULE_dbcc_clonedatabase_option = 415;
    static readonly RULE_dbcc_clonedatabase = 416;
    static readonly RULE_dbcc_pdw_showspaceused = 417;
    static readonly RULE_dbcc_proccache = 418;
    static readonly RULE_dbcc_showcontig_option = 419;
    static readonly RULE_dbcc_showcontig = 420;
    static readonly RULE_dbcc_shrinklog = 421;
    static readonly RULE_dbcc_dbreindex = 422;
    static readonly RULE_dbcc_dll_free = 423;
    static readonly RULE_dbcc_dropcleanbuffers = 424;
    static readonly RULE_dbcc_clause = 425;
    static readonly RULE_execute_clause = 426;
    static readonly RULE_declare_local = 427;
    static readonly RULE_table_type_definition = 428;
    static readonly RULE_table_type_indices = 429;
    static readonly RULE_xml_type_definition = 430;
    static readonly RULE_xml_schema_collection = 431;
    static readonly RULE_column_def_table_constraints = 432;
    static readonly RULE_column_def_table_constraint = 433;
    static readonly RULE_column_definition = 434;
    static readonly RULE_column_definition_element = 435;
    static readonly RULE_column_modifier = 436;
    static readonly RULE_materialized_column_definition = 437;
    static readonly RULE_column_constraint = 438;
    static readonly RULE_column_index = 439;
    static readonly RULE_on_partition_or_filegroup = 440;
    static readonly RULE_table_constraint = 441;
    static readonly RULE_connection_node = 442;
    static readonly RULE_primary_key_options = 443;
    static readonly RULE_foreign_key_options = 444;
    static readonly RULE_check_constraint = 445;
    static readonly RULE_on_delete = 446;
    static readonly RULE_on_update = 447;
    static readonly RULE_alter_table_index_options = 448;
    static readonly RULE_alter_table_index_option = 449;
    static readonly RULE_declare_cursor = 450;
    static readonly RULE_declare_set_cursor_common = 451;
    static readonly RULE_declare_set_cursor_common_partial = 452;
    static readonly RULE_fetch_cursor = 453;
    static readonly RULE_set_special = 454;
    static readonly RULE_special_list = 455;
    static readonly RULE_constant_LOCAL_ID = 456;
    static readonly RULE_expression = 457;
    static readonly RULE_parameter = 458;
    static readonly RULE_time_zone = 459;
    static readonly RULE_primitive_expression = 460;
    static readonly RULE_case_expression = 461;
    static readonly RULE_unary_operator_expression = 462;
    static readonly RULE_bracket_expression = 463;
    static readonly RULE_subquery = 464;
    static readonly RULE_with_expression = 465;
    static readonly RULE_common_table_expression = 466;
    static readonly RULE_update_elem = 467;
    static readonly RULE_update_elem_merge = 468;
    static readonly RULE_search_condition = 469;
    static readonly RULE_predicate = 470;
    static readonly RULE_query_expression = 471;
    static readonly RULE_sql_union = 472;
    static readonly RULE_query_specification = 473;
    static readonly RULE_top_clause = 474;
    static readonly RULE_top_percent = 475;
    static readonly RULE_top_count = 476;
    static readonly RULE_order_by_clause = 477;
    static readonly RULE_select_order_by_clause = 478;
    static readonly RULE_for_clause = 479;
    static readonly RULE_xml_common_directives = 480;
    static readonly RULE_order_by_expression = 481;
    static readonly RULE_grouping_sets_item = 482;
    static readonly RULE_group_by_item = 483;
    static readonly RULE_option_clause = 484;
    static readonly RULE_option = 485;
    static readonly RULE_optimize_for_arg = 486;
    static readonly RULE_select_list = 487;
    static readonly RULE_udt_method_arguments = 488;
    static readonly RULE_asterisk = 489;
    static readonly RULE_udt_elem = 490;
    static readonly RULE_expression_elem = 491;
    static readonly RULE_select_list_elem = 492;
    static readonly RULE_table_sources = 493;
    static readonly RULE_non_ansi_join = 494;
    static readonly RULE_table_source = 495;
    static readonly RULE_table_source_item = 496;
    static readonly RULE_open_xml = 497;
    static readonly RULE_open_json = 498;
    static readonly RULE_json_declaration = 499;
    static readonly RULE_json_column_declaration = 500;
    static readonly RULE_schema_declaration = 501;
    static readonly RULE_column_declaration = 502;
    static readonly RULE_change_table = 503;
    static readonly RULE_change_table_changes = 504;
    static readonly RULE_change_table_version = 505;
    static readonly RULE_join_part = 506;
    static readonly RULE_join_on = 507;
    static readonly RULE_cross_join = 508;
    static readonly RULE_apply_ = 509;
    static readonly RULE_pivot = 510;
    static readonly RULE_unpivot = 511;
    static readonly RULE_pivot_clause = 512;
    static readonly RULE_unpivot_clause = 513;
    static readonly RULE_full_column_name_list = 514;
    static readonly RULE_rowset_function = 515;
    static readonly RULE_bulk_option = 516;
    static readonly RULE_derived_table = 517;
    static readonly RULE_function_call = 518;
    static readonly RULE_partition_function = 519;
    static readonly RULE_freetext_function = 520;
    static readonly RULE_freetext_predicate = 521;
    static readonly RULE_json_key_value = 522;
    static readonly RULE_json_null_clause = 523;
    static readonly RULE_built_in_functions = 524;
    static readonly RULE_xml_data_type_methods = 525;
    static readonly RULE_dateparts_9 = 526;
    static readonly RULE_dateparts_12 = 527;
    static readonly RULE_dateparts_15 = 528;
    static readonly RULE_dateparts_datetrunc = 529;
    static readonly RULE_value_method = 530;
    static readonly RULE_value_call = 531;
    static readonly RULE_query_method = 532;
    static readonly RULE_query_call = 533;
    static readonly RULE_exist_method = 534;
    static readonly RULE_exist_call = 535;
    static readonly RULE_modify_method = 536;
    static readonly RULE_modify_call = 537;
    static readonly RULE_hierarchyid_call = 538;
    static readonly RULE_hierarchyid_static_method = 539;
    static readonly RULE_nodes_method = 540;
    static readonly RULE_switch_section = 541;
    static readonly RULE_switch_search_condition_section = 542;
    static readonly RULE_as_column_alias = 543;
    static readonly RULE_as_table_alias = 544;
    static readonly RULE_table_alias = 545;
    static readonly RULE_with_table_hints = 546;
    static readonly RULE_deprecated_table_hint = 547;
    static readonly RULE_sybase_legacy_hints = 548;
    static readonly RULE_sybase_legacy_hint = 549;
    static readonly RULE_table_hint = 550;
    static readonly RULE_index_value = 551;
    static readonly RULE_column_alias_list = 552;
    static readonly RULE_column_alias = 553;
    static readonly RULE_table_value_constructor = 554;
    static readonly RULE_expression_list_ = 555;
    static readonly RULE_ranking_windowed_function = 556;
    static readonly RULE_aggregate_windowed_function = 557;
    static readonly RULE_analytic_windowed_function = 558;
    static readonly RULE_all_distinct_expression = 559;
    static readonly RULE_over_clause = 560;
    static readonly RULE_row_or_range_clause = 561;
    static readonly RULE_window_frame_extent = 562;
    static readonly RULE_window_frame_bound = 563;
    static readonly RULE_window_frame_preceding = 564;
    static readonly RULE_window_frame_following = 565;
    static readonly RULE_create_database_option = 566;
    static readonly RULE_database_filestream_option = 567;
    static readonly RULE_database_file_spec = 568;
    static readonly RULE_file_group = 569;
    static readonly RULE_file_spec = 570;
    static readonly RULE_entity_name = 571;
    static readonly RULE_entity_name_for_azure_dw = 572;
    static readonly RULE_entity_name_for_parallel_dw = 573;
    static readonly RULE_full_table_name = 574;
    static readonly RULE_table_name = 575;
    static readonly RULE_simple_name = 576;
    static readonly RULE_func_proc_name_schema = 577;
    static readonly RULE_func_proc_name_database_schema = 578;
    static readonly RULE_func_proc_name_server_database_schema = 579;
    static readonly RULE_ddl_object = 580;
    static readonly RULE_full_column_name = 581;
    static readonly RULE_column_name_list_with_order = 582;
    static readonly RULE_insert_column_name_list = 583;
    static readonly RULE_insert_column_id = 584;
    static readonly RULE_column_name_list = 585;
    static readonly RULE_cursor_name = 586;
    static readonly RULE_on_off = 587;
    static readonly RULE_clustered = 588;
    static readonly RULE_null_notnull = 589;
    static readonly RULE_scalar_function_name = 590;
    static readonly RULE_begin_conversation_timer = 591;
    static readonly RULE_begin_conversation_dialog = 592;
    static readonly RULE_contract_name = 593;
    static readonly RULE_service_name = 594;
    static readonly RULE_end_conversation = 595;
    static readonly RULE_waitfor_conversation = 596;
    static readonly RULE_get_conversation = 597;
    static readonly RULE_queue_id = 598;
    static readonly RULE_send_conversation = 599;
    static readonly RULE_data_type = 600;
    static readonly RULE_constant = 601;
    static readonly RULE_primitive_constant = 602;
    static readonly RULE_keyword = 603;
    static readonly RULE_id_ = 604;
    static readonly RULE_simple_id = 605;
    static readonly RULE_id_or_string = 606;
    static readonly RULE_comparison_operator = 607;
    static readonly RULE_assignment_operator = 608;
    static readonly RULE_file_size = 609;
...
export declare class ProgramContext extends ParserRuleContext {
    ...
    accept<Result>(visitor: TSqlParserVisitor<Result>): Result;
}
