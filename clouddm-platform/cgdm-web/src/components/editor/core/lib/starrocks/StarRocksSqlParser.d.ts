...
export declare class StarRocksSqlParser extends Parser {
    ...
    static readonly LEFT_PARENpropertyRIGHT_PAREN = 468;
    ...
    static readonly RULE_materializedColumnDesc = 19;
    ...
    static readonly RULE_taskExecSql = 59;
    static readonly RULE_dropTaskStatement = 60;
    static readonly RULE_createMaterializedViewStatement = 61;
    static readonly RULE_materializedViewDesc = 62;
    static readonly RULE_showMaterializedViewsStatement = 63;
    static readonly RULE_dropMaterializedViewStatement = 64;
    static readonly RULE_alterMaterializedViewStatement = 65;
    static readonly RULE_refreshMaterializedViewStatement = 66;
    static readonly RULE_cancelRefreshMaterializedViewStatement = 67;
    static readonly RULE_adminSetConfigStatement = 68;
    static readonly RULE_adminSetReplicaStatusStatement = 69;
    static readonly RULE_adminShowConfigStatement = 70;
    static readonly RULE_adminShowReplicaDistributionStatement = 71;
    static readonly RULE_adminShowReplicaStatusStatement = 72;
    static readonly RULE_adminRepairTableStatement = 73;
    static readonly RULE_adminCancelRepairTableStatement = 74;
    static readonly RULE_adminCheckTabletsStatement = 75;
    static readonly RULE_killStatement = 76;
    static readonly RULE_syncStatement = 77;
    static readonly RULE_alterSystemStatement = 78;
    static readonly RULE_cancelAlterSystemStatement = 79;
    static readonly RULE_showComputeNodesStatement = 80;
    static readonly RULE_createExternalCatalogStatement = 81;
    static readonly RULE_showCreateExternalCatalogStatement = 82;
    static readonly RULE_dropExternalCatalogStatement = 83;
    static readonly RULE_showCatalogsStatement = 84;
    ...
    static readonly RULE_alterClause = 103;
    static readonly RULE_addFrontendClause = 104;
    static readonly RULE_dropFrontendClause = 105;
    static readonly RULE_modifyFrontendHostClause = 106;
    static readonly RULE_addBackendClause = 107;
    static readonly RULE_dropBackendClause = 108;
    static readonly RULE_decommissionBackendClause = 109;
    static readonly RULE_modifyBackendHostClause = 110;
    static readonly RULE_addComputeNodeClause = 111;
    static readonly RULE_dropComputeNodeClause = 112;
    static readonly RULE_modifyBrokerClause = 113;
    static readonly RULE_alterLoadErrorUrlClause = 114;
    static readonly RULE_createImageClause = 115;
    static readonly RULE_cleanTabletSchedQClause = 116;
    static readonly RULE_createIndexClause = 117;
    static readonly RULE_dropIndexClause = 118;
    static readonly RULE_tableRenameClause = 119;
    static readonly RULE_swapTableClause = 120;
    static readonly RULE_modifyTablePropertiesClause = 121;
    static readonly RULE_modifyCommentClause = 122;
    static readonly RULE_addColumnClause = 123;
    static readonly RULE_addColumnsClause = 124;
    static readonly RULE_dropColumnClause = 125;
    static readonly RULE_modifyColumnClause = 126;
    static readonly RULE_columnRenameClause = 127;
    static readonly RULE_reorderColumnsClause = 128;
    static readonly RULE_rollupRenameClause = 129;
    static readonly RULE_compactionClause = 130;
    static readonly RULE_applyMaskingPolicyClause = 131;
    static readonly RULE_applyRowAccessPolicyClause = 132;
    static readonly RULE_addPartitionClause = 133;
    static readonly RULE_dropPartitionClause = 134;
    static readonly RULE_truncatePartitionClause = 135;
    static readonly RULE_modifyPartitionClause = 136;
    static readonly RULE_replacePartitionClause = 137;
    static readonly RULE_partitionRenameClause = 138;
    static readonly RULE_insertStatement = 139;
    static readonly RULE_updateStatement = 140;
    static readonly RULE_deleteStatement = 141;
    static readonly RULE_createRoutineLoadStatement = 142;
    static readonly RULE_alterRoutineLoadStatement = 143;
    static readonly RULE_dataSource = 144;
    static readonly RULE_loadPropertiesExpr = 145;
    static readonly RULE_loadProperties = 146;
    static readonly RULE_colSeparatorProperty = 147;
    static readonly RULE_rowDelimiterProperty = 148;
    static readonly RULE_importColumns = 149;
    static readonly RULE_columnProperties = 150;
    static readonly RULE_jobProperties = 151;
    static readonly RULE_dataSourceProperties = 152;
    static readonly RULE_stopRoutineLoadStatement = 153;
    static readonly RULE_resumeRoutineLoadStatement = 154;
    static readonly RULE_pauseRoutineLoadStatement = 155;
    static readonly RULE_showRoutineLoadStatement = 156;
    static readonly RULE_showRoutineLoadTaskStatement = 157;
    static readonly RULE_showStreamLoadStatement = 158;
    static readonly RULE_analyzeStatement = 159;
    static readonly RULE_dropStatsStatement = 160;
    static readonly RULE_analyzeHistogramStatement = 161;
    static readonly RULE_dropHistogramStatement = 162;
    static readonly RULE_createAnalyzeStatement = 163;
    static readonly RULE_dropAnalyzeJobStatement = 164;
    static readonly RULE_showAnalyzeStatement = 165;
    static readonly RULE_showStatsMetaStatement = 166;
    static readonly RULE_showHistogramMetaStatement = 167;
    static readonly RULE_killAnalyzeStatement = 168;
    static readonly RULE_analyzeProfileStatement = 169;
    static readonly RULE_createResourceGroupStatement = 170;
    static readonly RULE_dropResourceGroupStatement = 171;
    static readonly RULE_alterResourceGroupStatement = 172;
    static readonly RULE_showResourceGroupStatement = 173;
    static readonly RULE_createResourceStatement = 174;
    static readonly RULE_alterResourceStatement = 175;
    static readonly RULE_dropResourceStatement = 176;
    static readonly RULE_showResourceStatement = 177;
    static readonly RULE_classifier = 178;
    static readonly RULE_showFunctionsStatement = 179;
    static readonly RULE_dropFunctionStatement = 180;
    static readonly RULE_createFunctionStatement = 181;
    static readonly RULE_typeList = 182;
    static readonly RULE_loadStatement = 183;
    static readonly RULE_labelName = 184;
    static readonly RULE_dataDescList = 185;
    static readonly RULE_dataDesc = 186;
    static readonly RULE_formatProps = 187;
    static readonly RULE_brokerDesc = 188;
    static readonly RULE_resourceDesc = 189;
    static readonly RULE_showLoadStatement = 190;
    static readonly RULE_showLoadWarningsStatement = 191;
    static readonly RULE_cancelLoadStatement = 192;
    static readonly RULE_alterLoadStatement = 193;
    static readonly RULE_cancelCompactionStatement = 194;
    static readonly RULE_showAuthorStatement = 195;
    static readonly RULE_showBackendsStatement = 196;
    static readonly RULE_showBrokerStatement = 197;
    static readonly RULE_showCharsetStatement = 198;
    static readonly RULE_showCollationStatement = 199;
    static readonly RULE_showDeleteStatement = 200;
    static readonly RULE_showDynamicPartitionStatement = 201;
    static readonly RULE_showEventsStatement = 202;
    static readonly RULE_showEnginesStatement = 203;
    static readonly RULE_showFrontendsStatement = 204;
    static readonly RULE_showPluginsStatement = 205;
    static readonly RULE_showRepositoriesStatement = 206;
    static readonly RULE_showOpenTableStatement = 207;
    static readonly RULE_showPrivilegesStatement = 208;
    static readonly RULE_showProcedureStatement = 209;
    static readonly RULE_showProcStatement = 210;
    static readonly RULE_showProcesslistStatement = 211;
    static readonly RULE_showProfilelistStatement = 212;
    static readonly RULE_showStatusStatement = 213;
    static readonly RULE_showTabletStatement = 214;
    static readonly RULE_showTransactionStatement = 215;
    static readonly RULE_showTriggersStatement = 216;
    static readonly RULE_showUserPropertyStatement = 217;
    static readonly RULE_showVariablesStatement = 218;
    static readonly RULE_showWarningStatement = 219;
    static readonly RULE_helpStatement = 220;
    static readonly RULE_createUserStatement = 221;
    static readonly RULE_dropUserStatement = 222;
    static readonly RULE_alterUserStatement = 223;
    static readonly RULE_showUserStatement = 224;
    static readonly RULE_showAuthenticationStatement = 225;
    static readonly RULE_executeAsStatement = 226;
    static readonly RULE_createRoleStatement = 227;
    static readonly RULE_alterRoleStatement = 228;
    static readonly RULE_dropRoleStatement = 229;
    static readonly RULE_showRolesStatement = 230;
    static readonly RULE_grantRoleStatement = 231;
    static readonly RULE_revokeRoleStatement = 232;
    static readonly RULE_setRoleStatement = 233;
    static readonly RULE_setDefaultRoleStatement = 234;
    static readonly RULE_grantRevokeClause = 235;
    static readonly RULE_grantPrivilegeStatement = 236;
    static readonly RULE_revokePrivilegeStatement = 237;
    static readonly RULE_showGrantsStatement = 238;
    static readonly RULE_createSecurityIntegrationStatement = 239;
    static readonly RULE_alterSecurityIntegrationStatement = 240;
    static readonly RULE_dropSecurityIntegrationStatement = 241;
    static readonly RULE_showSecurityIntegrationStatement = 242;
    static readonly RULE_showCreateSecurityIntegrationStatement = 243;
    static readonly RULE_createRoleMappingStatement = 244;
    static readonly RULE_alterRoleMappingStatement = 245;
    static readonly RULE_dropRoleMappingStatement = 246;
    static readonly RULE_showRoleMappingStatement = 247;
    static readonly RULE_refreshRoleMappingStatement = 248;
    static readonly RULE_authOption = 249;
    static readonly RULE_privObjectName = 250;
    static readonly RULE_privObjectNameList = 251;
    static readonly RULE_privFunctionObjectNameList = 252;
    static readonly RULE_privilegeTypeList = 253;
    static readonly RULE_privilegeType = 254;
    static readonly RULE_privObjectType = 255;
    static readonly RULE_privObjectTypePlural = 256;
    static readonly RULE_createMaskingPolicyStatement = 257;
    static readonly RULE_dropMaskingPolicyStatement = 258;
    static readonly RULE_alterMaskingPolicyStatement = 259;
    static readonly RULE_showMaskingPolicyStatement = 260;
    static readonly RULE_showCreateMaskingPolicyStatement = 261;
    static readonly RULE_createRowAccessPolicyStatement = 262;
    static readonly RULE_dropRowAccessPolicyStatement = 263;
    static readonly RULE_alterRowAccessPolicyStatement = 264;
    static readonly RULE_showRowAccessPolicyStatement = 265;
    static readonly RULE_showCreateRowAccessPolicyStatement = 266;
    static readonly RULE_policySignature = 267;
    static readonly RULE_backupStatement = 268;
    static readonly RULE_cancelBackupStatement = 269;
    static readonly RULE_showBackupStatement = 270;
    static readonly RULE_restoreStatement = 271;
    static readonly RULE_cancelRestoreStatement = 272;
    static readonly RULE_showRestoreStatement = 273;
    static readonly RULE_showSnapshotStatement = 274;
    static readonly RULE_createRepositoryStatement = 275;
    static readonly RULE_dropRepositoryStatement = 276;
    static readonly RULE_addSqlBlackListStatement = 277;
    static readonly RULE_delSqlBlackListStatement = 278;
    static readonly RULE_showSqlBlackListStatement = 279;
    static readonly RULE_showWhiteListStatement = 280;
    static readonly RULE_exportStatement = 281;
    static readonly RULE_cancelExportStatement = 282;
    static readonly RULE_showExportStatement = 283;
    static readonly RULE_installPluginStatement = 284;
    static readonly RULE_uninstallPluginStatement = 285;
    static readonly RULE_createFileStatement = 286;
    static readonly RULE_dropFileStatement = 287;
    static readonly RULE_showSmallFilesStatement = 288;
    static readonly RULE_setStatement = 289;
    static readonly RULE_setVar = 290;
    static readonly RULE_transaction_characteristics = 291;
    static readonly RULE_transaction_access_mode = 292;
    static readonly RULE_isolation_level = 293;
    static readonly RULE_isolation_types = 294;
    static readonly RULE_setExprOrDefault = 295;
    static readonly RULE_setUserPropertyStatement = 296;
    static readonly RULE_roleList = 297;
    static readonly RULE_executeScriptStatement = 298;
    static readonly RULE_unsupportedStatement = 299;
    static readonly RULE_lock_item = 300;
    static readonly RULE_lock_type = 301;
    static readonly RULE_queryStatement = 302;
    static readonly RULE_queryRelation = 303;
    static readonly RULE_withClause = 304;
    static readonly RULE_queryNoWith = 305;
    static readonly RULE_temporalClause = 306;
    static readonly RULE_queryPrimary = 307;
    static readonly RULE_subquery = 308;
    static readonly RULE_rowConstructor = 309;
    static readonly RULE_sortItem = 310;
    static readonly RULE_limitElement = 311;
    static readonly RULE_querySpecification = 312;
    static readonly RULE_fromClause = 313;
    static readonly RULE_groupingElement = 314;
    static readonly RULE_groupingSet = 315;
    static readonly RULE_commonTableExpression = 316;
    static readonly RULE_setQuantifier = 317;
    static readonly RULE_selectItem = 318;
    static readonly RULE_relations = 319;
    static readonly RULE_relation = 320;
    static readonly RULE_relationPrimary = 321;
    static readonly RULE_joinRelation = 322;
    static readonly RULE_crossOrInnerJoinType = 323;
    static readonly RULE_outerAndSemiJoinType = 324;
    static readonly RULE_bracketHint = 325;
    static readonly RULE_setVarHint = 326;
    static readonly RULE_hintMap = 327;
    static readonly RULE_joinCriteria = 328;
    static readonly RULE_columnAliases = 329;
    static readonly RULE_partitionNames = 330;
    static readonly RULE_keyPartitions = 331;
    static readonly RULE_tabletList = 332;
    static readonly RULE_expressionsWithDefault = 333;
    static readonly RULE_expressionOrDefault = 334;
    static readonly RULE_mapExpressionList = 335;
    static readonly RULE_mapExpression = 336;
    static readonly RULE_expressionSingleton = 337;
    static readonly RULE_expression = 338;
    static readonly RULE_expressionList = 339;
    static readonly RULE_booleanExpression = 340;
    static readonly RULE_predicate = 341;
    static readonly RULE_tupleInSubquery = 342;
    static readonly RULE_predicateOperations = 343;
    static readonly RULE_valueExpression = 344;
    static readonly RULE_primaryExpression = 345;
    static readonly RULE_literalExpression = 346;
    static readonly RULE_functionCall = 347;
    static readonly RULE_aggregationFunction = 348;
    static readonly RULE_userVariable = 349;
    static readonly RULE_systemVariable = 350;
    static readonly RULE_columnReference = 351;
    static readonly RULE_informationFunctionExpression = 352;
    static readonly RULE_specialDateTimeExpression = 353;
    static readonly RULE_specialFunctionExpression = 354;
    static readonly RULE_windowFunction = 355;
    static readonly RULE_whenClause = 356;
    static readonly RULE_over = 357;
    static readonly RULE_ignoreNulls = 358;
    static readonly RULE_tableDesc = 359;
    static readonly RULE_restoreTableDesc = 360;
    static readonly RULE_explainDesc = 361;
    static readonly RULE_optimizerTrace = 362;
    static readonly RULE_partitionDesc = 363;
    static readonly RULE_listPartitionDesc = 364;
    static readonly RULE_singleItemListPartitionDesc = 365;
    static readonly RULE_multiItemListPartitionDesc = 366;
    static readonly RULE_stringList = 367;
    static readonly RULE_rangePartitionDesc = 368;
    static readonly RULE_singleRangePartition = 369;
    static readonly RULE_multiRangePartition = 370;
    static readonly RULE_partitionRangeDesc = 371;
    static readonly RULE_partitionKeyDesc = 372;
    static readonly RULE_partitionValueList = 373;
    static readonly RULE_keyPartition = 374;
    static readonly RULE_partitionValue = 375;
    static readonly RULE_distributionClause = 376;
    static readonly RULE_distributionDesc = 377;
    static readonly RULE_refreshSchemeDesc = 378;
    static readonly RULE_statusDesc = 379;
    static readonly RULE_properties = 380;
    static readonly RULE_extProperties = 381;
    static readonly RULE_propertyList = 382;
    static readonly RULE_userPropertyList = 383;
    static readonly RULE_property = 384;
    static readonly RULE_varType = 385;
    static readonly RULE_comment = 386;
    static readonly RULE_outfile = 387;
    static readonly RULE_fileFormat = 388;
    static readonly RULE_string = 389;
    static readonly RULE_binary = 390;
    static readonly RULE_comparisonOperator = 391;
    static readonly RULE_booleanValue = 392;
    static readonly RULE_interval = 393;
    static readonly RULE_unitIdentifier = 394;
    static readonly RULE_unitBoundary = 395;
    static readonly RULE_type = 396;
    static readonly RULE_arrayType = 397;
    static readonly RULE_mapType = 398;
    static readonly RULE_subfieldDesc = 399;
    static readonly RULE_subfieldDescs = 400;
    static readonly RULE_structType = 401;
    static readonly RULE_typeParameter = 402;
    static readonly RULE_baseType = 403;
    static readonly RULE_decimalType = 404;
    static readonly RULE_qualifiedName = 405;
    static readonly RULE_identifier = 406;
    static readonly RULE_identifierList = 407;
    static readonly RULE_identifierOrString = 408;
    static readonly RULE_identifierOrStringList = 409;
    static readonly RULE_identifierOrStringOrStar = 410;
    static readonly RULE_user = 411;
    static readonly RULE_assignment = 412;
    static readonly RULE_assignmentList = 413;
    static readonly RULE_number = 414;
    static readonly RULE_nonReserved = 415;
    ...
    materializedColumnDesc(): MaterializedColumnDescContext;
    ...
    taskExecSql(): TaskExecSqlContext;
    ...
    modifyTablePropertiesClause(): ModifyTablePropertiesClauseContext;
    ...
    loadPropertiesExpr(): LoadPropertiesExprContext;
...
export declare class ProgramContext extends ParserRuleContext {
    ...
    enterRule(listener: StarRocksSqlParserListener): void;
    exitRule(listener: StarRocksSqlParserListener): void;
    accept<Result>(visitor: StarRocksSqlParserVisitor<Result>): Result;
}
...
export declare class StatementContext extends ParserRuleContext {
    ...
    createWarehouseStatement(): CreateWarehouseStatementContext | undefined;
    dropWarehouseStatement(): DropWarehouseStatementContext | undefined;
    showWarehousesStatement(): ShowWarehousesStatementContext | undefined;
    alterWarehouseStatement(): AlterWarehouseStatementContext | undefined;
    showClustersStatement(): ShowClustersStatementContext | undefined;
    suspendWarehouseStatement(): SuspendWarehouseStatementContext | undefined;
    resumeWarehouseStatement(): ResumeWarehouseStatementContext | undefined;
...
export declare class ColumnDescContext extends ParserRuleContext {
    ...
    materializedColumnDesc(): MaterializedColumnDescContext | undefined;
...
export declare class MaterializedColumnDescContext extends ParserRuleContext {
    AS(): TerminalNode;
    expression(): ExpressionContext;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
...
export declare class TaskExecSqlContext extends ParserRuleContext {
    createTableAsSelectStatement(): CreateTableAsSelectStatementContext | undefined;
    insertStatement(): InsertStatementContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
...
export declare class AlterMaterializedViewStatementContext extends ParserRuleContext {
    ...
    modifyTablePropertiesClause(): ModifyTablePropertiesClauseContext | undefined;
...
export declare class AdminCheckTabletsStatementContext extends ParserRuleContext {
    ...
    LEFT_PARENpropertyRIGHT_PAREN(): TerminalNode;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: StarRocksSqlParserListener): void;
    exitRule(listener: StarRocksSqlParserListener): void;
...
export declare class ModifyTablePropertiesClauseContext extends ParserRuleContext {
    SET(): TerminalNode;
    propertyList(): PropertyListContext;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
...
export declare class LoadPropertiesExprContext extends ParserRuleContext {
    loadProperties(): LoadPropertiesContext[];
...
export declare class OdbcFunctionCallExpressionContext extends PrimaryExpressionContext {
    LEFT_BRACE(): TerminalNode;
    FN(): TerminalNode;
    functionCall(): FunctionCallContext;
    RIGHT_BRACE(): TerminalNode;
    constructor(ctx: PrimaryExpressionContext);
    enterRule(listener: StarRocksSqlParserListener): void;
    exitRule(listener: StarRocksSqlParserListener): void;
    accept<Result>(visitor: StarRocksSqlParserVisitor<Result>): Result;
