...
import { RedisParserListener } from "./RedisParserListener";
import { RedisParserVisitor } from "./RedisParserVisitor";
export declare class RedisParser extends Parser {
...
export declare class ProgramContext extends ParserRuleContext {
    ...
    enterRule(listener: RedisParserListener): void;
    exitRule(listener: RedisParserListener): void;
    accept<Result>(visitor: RedisParserVisitor<Result>): Result;
}
