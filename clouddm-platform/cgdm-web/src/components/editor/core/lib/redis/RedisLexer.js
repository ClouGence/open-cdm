// Generated from dt-sql-parser/src/grammar/redis/RedisLexer.g4 by ANTLR 4.9.0-SNAPSHOT
import { ATNDeserializer } from "antlr4ts/atn/ATNDeserializer";
import { Lexer } from "antlr4ts/Lexer";
import { LexerATNSimulator } from "antlr4ts/atn/LexerATNSimulator";
import { VocabularyImpl } from "antlr4ts/VocabularyImpl";
import * as Utils from "antlr4ts/misc/Utils";
export class RedisLexer extends Lexer {
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator(RedisLexer._ATN, this);
    }
    // @Override
    get grammarFileName() { return "RedisLexer.g4"; }
    // @Override
    get ruleNames() { return RedisLexer.ruleNames; }
    // @Override
    get serializedATN() { return RedisLexer._serializedATN; }
    // @Override
    get channelNames() { return RedisLexer.channelNames; }
    // @Override
    get modeNames() { return RedisLexer.modeNames; }
    static get _ATN() {
        if (!RedisLexer.__ATN) {
            RedisLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(RedisLexer._serializedATN));
        }
        return RedisLexer.__ATN;
    }
}
RedisLexer.SPACE = 1;
RedisLexer.SPEC_MYSQL_COMMENT = 2;
RedisLexer.COMMENT_INPUT = 3;
RedisLexer.LINE_COMMENT = 4;
RedisLexer.COPY = 5;
RedisLexer.DEL = 6;
RedisLexer.DUMP = 7;
RedisLexer.EXISTS = 8;
RedisLexer.EXPIRE = 9;
RedisLexer.EXPIREAT = 10;
RedisLexer.EXPIRETIME = 11;
RedisLexer.KEYS = 12;
RedisLexer.MOVE = 13;
RedisLexer.OBJECT = 14;
RedisLexer.PERSIST = 15;
RedisLexer.PEXPIRE = 16;
RedisLexer.PEXPIREAT = 17;
RedisLexer.PEXPIRETIME = 18;
RedisLexer.TTL = 19;
RedisLexer.PTTL = 20;
RedisLexer.RANDOMKEY = 21;
RedisLexer.RENAME = 22;
RedisLexer.RENAMENX = 23;
RedisLexer.RESTORE = 24;
RedisLexer.SCAN = 25;
RedisLexer.SORT = 26;
RedisLexer.SORT_RO = 27;
RedisLexer.TOUCH = 28;
RedisLexer.TYPE = 29;
RedisLexer.UNLINK = 30;
RedisLexer.WAIT = 31;
RedisLexer.APPEND = 32;
RedisLexer.DECR = 33;
RedisLexer.DECRBY = 34;
RedisLexer.GET = 35;
RedisLexer.GETDEL = 36;
RedisLexer.GETEX = 37;
RedisLexer.GETRANGE = 38;
RedisLexer.GETSET = 39;
RedisLexer.GETBIT = 40;
RedisLexer.INCR = 41;
RedisLexer.INCRBY = 42;
RedisLexer.INCRBYFLOAT = 43;
RedisLexer.LCS = 44;
RedisLexer.MGET = 45;
RedisLexer.MSET = 46;
RedisLexer.MSETNX = 47;
RedisLexer.SETEX = 48;
RedisLexer.PSETEX = 49;
RedisLexer.SET = 50;
RedisLexer.SETNX = 51;
RedisLexer.SETRANGE = 52;
RedisLexer.SETBIT = 53;
RedisLexer.STRLEN = 54;
RedisLexer.SUBSTR = 55;
RedisLexer.HDEL = 56;
RedisLexer.HEXISTS = 57;
RedisLexer.HGET = 58;
RedisLexer.HGETALL = 59;
RedisLexer.HINCRBY = 60;
RedisLexer.HINCRBYFLOAT = 61;
RedisLexer.HKEYS = 62;
RedisLexer.HLEN = 63;
RedisLexer.HMGET = 64;
RedisLexer.HMSET = 65;
RedisLexer.HRANDFIELD = 66;
RedisLexer.HSCAN = 67;
RedisLexer.HSET = 68;
RedisLexer.HSETNX = 69;
RedisLexer.HSTRLEN = 70;
RedisLexer.HVALS = 71;
RedisLexer.BLMOVE = 72;
RedisLexer.BLMPOP = 73;
RedisLexer.BLPOP = 74;
RedisLexer.BRPOP = 75;
RedisLexer.BRPOPLPUSH = 76;
RedisLexer.LINDEX = 77;
RedisLexer.LINSERT = 78;
RedisLexer.LLEN = 79;
RedisLexer.LMOVE = 80;
RedisLexer.LMPOP = 81;
RedisLexer.LPOP = 82;
RedisLexer.LPOS = 83;
RedisLexer.LPUSH = 84;
RedisLexer.LPUSHX = 85;
RedisLexer.LRANGE = 86;
RedisLexer.LREM = 87;
RedisLexer.LSET = 88;
RedisLexer.LTRIM = 89;
RedisLexer.RPOP = 90;
RedisLexer.RPOPLPUSH = 91;
RedisLexer.RPUSH = 92;
RedisLexer.RPUSHX = 93;
RedisLexer.SADD = 94;
RedisLexer.SCARD = 95;
RedisLexer.SDIFF = 96;
RedisLexer.SDIFFSTORE = 97;
RedisLexer.SINTER = 98;
RedisLexer.SINTERCARD = 99;
RedisLexer.SINTERSTORE = 100;
RedisLexer.SISMEMBER = 101;
RedisLexer.SMEMBERS = 102;
RedisLexer.SMISMEMBER = 103;
RedisLexer.SMOVE = 104;
RedisLexer.SPOP = 105;
RedisLexer.SRANDMEMBER = 106;
RedisLexer.SREM = 107;
RedisLexer.SSCAN = 108;
RedisLexer.SUNION = 109;
RedisLexer.SUNIONSTORE = 110;
RedisLexer.BZMPOP = 111;
RedisLexer.BZPOPMAX = 112;
RedisLexer.BZPOPMIN = 113;
RedisLexer.ZADD = 114;
RedisLexer.ZCARD = 115;
RedisLexer.ZCOUNT = 116;
RedisLexer.ZDIFF = 117;
RedisLexer.ZDIFFSTORE = 118;
RedisLexer.ZINCRBY = 119;
RedisLexer.ZINTER = 120;
RedisLexer.ZINTERCARD = 121;
RedisLexer.ZINTERSTORE = 122;
RedisLexer.ZLEXCOUNT = 123;
RedisLexer.ZMPOP = 124;
RedisLexer.ZMSCORE = 125;
RedisLexer.ZPOPMAX = 126;
RedisLexer.ZPOPMIN = 127;
RedisLexer.ZRANDMEMBER = 128;
RedisLexer.ZRANGE = 129;
RedisLexer.ZRANGEBYLEX = 130;
RedisLexer.ZRANGEBYSCORE = 131;
RedisLexer.ZRANGESTORE = 132;
RedisLexer.ZRANK = 133;
RedisLexer.ZREM = 134;
RedisLexer.ZREMRANGEBYLEX = 135;
RedisLexer.ZREMRANGEBYRANK = 136;
RedisLexer.ZREMRANGEBYSCORE = 137;
RedisLexer.ZREVRANGE = 138;
RedisLexer.ZREVRANGEBYLEX = 139;
RedisLexer.ZREVRANGEBYSCORE = 140;
RedisLexer.ZREVRANK = 141;
RedisLexer.ZSCAN = 142;
RedisLexer.ZSCORE = 143;
RedisLexer.ZUNION = 144;
RedisLexer.ZUNIONSTORE = 145;
RedisLexer.PSUBSCRIBE = 146;
RedisLexer.PUBSUB = 147;
RedisLexer.PUBLISH = 148;
RedisLexer.CHANNELS = 149;
RedisLexer.NUMSUB = 150;
RedisLexer.NUMPAT = 151;
RedisLexer.SHARDCHANNELS = 152;
RedisLexer.SHARDNUMSUB = 153;
RedisLexer.PUNSUBSCRIBE = 154;
RedisLexer.SPUBLISH = 155;
RedisLexer.SUBSCRIBE = 156;
RedisLexer.UNSUBSCRIBE = 157;
RedisLexer.SSUBSCRIBE = 158;
RedisLexer.SUNSUBSCRIBE = 159;
RedisLexer.SERVER = 160;
RedisLexer.CLIENTS = 161;
RedisLexer.MEMORY = 162;
RedisLexer.PERSISTENCE = 163;
RedisLexer.STATS = 164;
RedisLexer.REPLICATION = 165;
RedisLexer.CPU = 166;
RedisLexer.COMMANDSTATS = 167;
RedisLexer.LATENCYSTATS = 168;
RedisLexer.SENTINEL = 169;
RedisLexer.MODULES = 170;
RedisLexer.KEYSPACE = 171;
RedisLexer.ERRORSTATS = 172;
RedisLexer.ALL = 173;
RedisLexer.DEFAULT = 174;
RedisLexer.EVERYTHING = 175;
RedisLexer.ASKING = 176;
RedisLexer.CLUSTER = 177;
RedisLexer.ADDSLOTS = 178;
RedisLexer.DELSLOTS = 179;
RedisLexer.ADDSLOTSRANGE = 180;
RedisLexer.BUMPEPOCH = 181;
RedisLexer.COUNTKEYSINSLOT = 182;
RedisLexer.DELSLOTSRANGE = 183;
RedisLexer.FAILOVER = 184;
RedisLexer.FLUSHSLOTS = 185;
RedisLexer.FORGET = 186;
RedisLexer.GETKEYSINSLOT = 187;
RedisLexer.KEYSLOT = 188;
RedisLexer.LINKS = 189;
RedisLexer.MEET = 190;
RedisLexer.MYID = 191;
RedisLexer.MYSHARDID = 192;
RedisLexer.FORCE = 193;
RedisLexer.TAKEOVER = 194;
RedisLexer.NODE = 195;
RedisLexer.NODES = 196;
RedisLexer.REPLICAS = 197;
RedisLexer.REPLICATE = 198;
RedisLexer.RESET = 199;
RedisLexer.HARD = 200;
RedisLexer.SOFT = 201;
RedisLexer.SAVECONFIG = 202;
RedisLexer.SETSLOT = 203;
RedisLexer.IMPORTING = 204;
RedisLexer.MIGRATING = 205;
RedisLexer.STABLE = 206;
RedisLexer.SHARDS = 207;
RedisLexer.SLAVES = 208;
RedisLexer.READONLY = 209;
RedisLexer.READWRITE = 210;
RedisLexer.FLUSHDB = 211;
RedisLexer.SCRIPT = 212;
RedisLexer.EVAL = 213;
RedisLexer.EVALSHA = 214;
RedisLexer.EXEC = 215;
RedisLexer.WATCH = 216;
RedisLexer.DISCARD = 217;
RedisLexer.UNWATCH = 218;
RedisLexer.MULTI = 219;
RedisLexer.PFMERGE = 220;
RedisLexer.PFADD = 221;
RedisLexer.PFCOUNT = 222;
RedisLexer.ECHO = 223;
RedisLexer.PING = 224;
RedisLexer.SAVE = 225;
RedisLexer.SLOWLOG = 226;
RedisLexer.LASTSAVE = 227;
RedisLexer.CONFIG = 228;
RedisLexer.CLIENT = 229;
RedisLexer.SHUTDOWN = 230;
RedisLexer.SYNC = 231;
RedisLexer.ROLE = 232;
RedisLexer.MONITOR = 233;
RedisLexer.SLAVEOF = 234;
RedisLexer.FLUSHALL = 235;
RedisLexer.SELECT = 236;
RedisLexer.QUIT = 237;
RedisLexer.AUTH = 238;
RedisLexer.DBSIZE = 239;
RedisLexer.BGREWRITEAOF = 240;
RedisLexer.TIME = 241;
RedisLexer.INFO = 242;
RedisLexer.BGSAVE = 243;
RedisLexer.COMMAND = 244;
RedisLexer.DEBUG = 245;
RedisLexer.DB = 246;
RedisLexer.NX = 247;
RedisLexer.XX = 248;
RedisLexer.GT = 249;
RedisLexer.LT = 250;
RedisLexer.ENCODING = 251;
RedisLexer.FREQ = 252;
RedisLexer.IDLETIME = 253;
RedisLexer.REFCOUNT = 254;
RedisLexer.ABSTTL = 255;
RedisLexer.BY = 256;
RedisLexer.ASC = 257;
RedisLexer.DESC = 258;
RedisLexer.ALPHA = 259;
RedisLexer.STORE = 260;
RedisLexer.REPLACE = 261;
RedisLexer.EX = 262;
RedisLexer.PX = 263;
RedisLexer.EXAT = 264;
RedisLexer.PXAT = 265;
RedisLexer.LEN = 266;
RedisLexer.IDX = 267;
RedisLexer.MINMATCHLEN = 268;
RedisLexer.WITHMATCHLEN = 269;
RedisLexer.KEEPTTL = 270;
RedisLexer.WITHSCORES = 271;
RedisLexer.LIMIT = 272;
RedisLexer.BEFORE = 273;
RedisLexer.AFTER = 274;
RedisLexer.FLUSH = 275;
RedisLexer.RESETSTAT = 276;
RedisLexer.REWRITE = 277;
RedisLexer.PAUSE = 278;
RedisLexer.SETNAME = 279;
RedisLexer.GETNAME = 280;
RedisLexer.LIST = 281;
RedisLexer.NOSAVE = 282;
RedisLexer.SLOTS = 283;
RedisLexer.GETKEYS = 284;
RedisLexer.COUNT = 285;
RedisLexer.SEGFAULT = 286;
RedisLexer.KILL = 287;
RedisLexer.LOAD = 288;
RedisLexer.WITHVALUES = 289;
RedisLexer.MATCH = 290;
RedisLexer.MIN = 291;
RedisLexer.MAX = 292;
RedisLexer.CH = 293;
RedisLexer.WEIGHTS = 294;
RedisLexer.AGGREGATE = 295;
RedisLexer.SUM = 296;
RedisLexer.BYSCORE = 297;
RedisLexer.BYLEX = 298;
RedisLexer.REV = 299;
RedisLexer.LEFT = 300;
RedisLexer.RIGHT = 301;
RedisLexer.RANK = 302;
RedisLexer.MAXLEN = 303;
RedisLexer.ASYNC = 304;
RedisLexer.HEX_NUM = 305;
RedisLexer.OCT_NUM = 306;
RedisLexer.BIT_NUM = 307;
RedisLexer.INTEGER_NUM = 308;
RedisLexer.DECIMAL_NUM = 309;
RedisLexer.STRING = 310;
RedisLexer.HOST = 311;
RedisLexer.HOST_PORT = 312;
RedisLexer.NAME_TOKEN = 313;
RedisLexer.MYSQLCOMMENT = 2;
RedisLexer.ERRORCHANNEL = 3;
// tslint:disable:no-trailing-whitespace
RedisLexer.channelNames = [
    "DEFAULT_TOKEN_CHANNEL", "HIDDEN", "MYSQLCOMMENT", "ERRORCHANNEL",
];
// tslint:disable:no-trailing-whitespace
RedisLexer.modeNames = [
    "DEFAULT_MODE",
];
RedisLexer.ruleNames = [
...
RedisLexer.VOCABULARY = new VocabularyImpl(RedisLexer._LITERAL_NAMES, RedisLexer._SYMBOLIC_NAMES, []);
RedisLexer._serializedATNSegments = 6;
RedisLexer._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\u013B\u0C26\b" +
...
RedisLexer._serializedATNSegment1 = "\x03\xE4\x03\xE4\x03\xE4\x03\xE5\x03\xE5\x03\xE5\x03\xE5\x03\xE5\x03\xE5" +
...
RedisLexer._serializedATNSegment2 = "\u066F\x03\x02\x02\x02\u010D\u0675\x03\x02\x02\x02\u010F\u067A\x03\x02" +
...
RedisLexer._serializedATNSegment3 = "G\x02\x02\u04FB\u04FC\x07V\x02\x02\u04FC\xB2\x03\x02\x02\x02\u04FD\u04FE" +
...
RedisLexer._serializedATNSegment4 = "\x02\u083C\u083D\x07F\x02\x02\u083D\u083E\x07F\x02\x02\u083E\u083F\x07" +
    ...
    "\u0B7C\u0B7D\x07E\x02\x02\u0B7D";
RedisLexer._serializedATNSegment5 = "\u0B7E\x07Q\x02\x02\u0B7E\u0B7F\x07T\x02\x02\u0B7F\u0B80\x07G\x02\x02" +
...
RedisLexer._serializedATN = Utils.join([
    RedisLexer._serializedATNSegment0,
    RedisLexer._serializedATNSegment1,
    RedisLexer._serializedATNSegment2,
    RedisLexer._serializedATNSegment3,
    RedisLexer._serializedATNSegment4,
    RedisLexer._serializedATNSegment5,
], "");
