...
export class ImpalaSqlParser extends Parser {
    ...
    // @RuleVersion(0)
    createTableSelect() {
        let _localctx = new CreateTableSelectContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    createTableLike() {
        let _localctx = new CreateTableLikeContext(this._ctx, this.state);
    ...
    createKuduTableAsSelect() {
        let _localctx = new CreateKuduTableAsSelectContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    createSchema() {
        let _localctx = new CreateSchemaContext(this._ctx, this.state);
    ...
    createAggregateFunction() {
        let _localctx = new CreateAggregateFunctionContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    alterStatsKey() {
        let _localctx = new AlterStatsKeyContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    alterPartitionCache() {
        let _localctx = new AlterPartitionCacheContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    changeColumnDefine() {
        let _localctx = new ChangeColumnDefineContext(this._ctx, this.state);
    ...
    alterDropSingleColumn() {
        let _localctx = new AlterDropSingleColumnContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    alterTableOwner() {
        let _localctx = new AlterTableOwnerContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    replaceOrAddColumns() {
        let _localctx = new ReplaceOrAddColumnsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    addSingleColumn() {
        let _localctx = new AddSingleColumnContext(this._ctx, this.state);
    ...
    alterTableNonKuduOrKuduOnly() {
        let _localctx = new AlterTableNonKuduOrKuduOnlyContext(this._ctx, this.state);
    ...
    addPartitionByRangeOrValue() {
        let _localctx = new AddPartitionByRangeOrValueContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    alterFormat() {
        let _localctx = new AlterFormatContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    recoverPartitions() {
        let _localctx = new RecoverPartitionsContext(this._ctx, this.state);
    ...
    dropPartitionByRangeOrValue() {
        let _localctx = new DropPartitionByRangeOrValueContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    renameView() {
        let _localctx = new RenameViewContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    alterViewOwner() {
        let _localctx = new AlterViewOwnerContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    renameTable() {
        let _localctx = new RenameTableContext(this._ctx, this.state);
    ...
    alterUnSetOrSetViewTblproperties() {
        let _localctx = new AlterUnSetOrSetViewTblpropertiesContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    computeStatement() {
        let _localctx = new ComputeStatementContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    computeStats() {
        let _localctx = new ComputeStatsContext(this._ctx, this.state);
    ...
    computeIncrementalStats() {
        let _localctx = new ComputeIncrementalStatsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    dropSchema() {
        let _localctx = new DropSchemaContext(this._ctx, this.state);
    ...
    dropIncrementalStats() {
        let _localctx = new DropIncrementalStatsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    grantStatement() {
        let _localctx = new GrantStatementContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    grantRole() {
        let _localctx = new GrantRoleContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    revokeStatement() {
        let _localctx = new RevokeStatementContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    revokeRole() {
        let _localctx = new RevokeRoleContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    delete() {
        let _localctx = new DeleteContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    deleteTableRef() {
        let _localctx = new DeleteTableRefContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showSchemas() {
        let _localctx = new ShowSchemasContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showTables() {
        let _localctx = new ShowTablesContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showFunctions() {
        let _localctx = new ShowFunctionsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showCreateTable() {
        let _localctx = new ShowCreateTableContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showCreateView() {
        let _localctx = new ShowCreateViewContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showTableStats() {
        let _localctx = new ShowTableStatsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showColumnStats() {
        let _localctx = new ShowColumnStatsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showPartitions() {
        let _localctx = new ShowPartitionsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showFiles() {
        let _localctx = new ShowFilesContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showRoles() {
        let _localctx = new ShowRolesContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showRoleGrant() {
        let _localctx = new ShowRoleGrantContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showGrants() {
        let _localctx = new ShowGrantsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showDatabaseGrant() {
        let _localctx = new ShowDatabaseGrantContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showTableGrant() {
        let _localctx = new ShowTableGrantContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    showColumnGrant() {
        let _localctx = new ShowColumnGrantContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    addCommentStatement() {
        let _localctx = new AddCommentStatementContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    addDatabaseComments() {
        let _localctx = new AddDatabaseCommentsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    addTableComments() {
        let _localctx = new AddTableCommentsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    addColumnComments() {
        let _localctx = new AddColumnCommentsContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    shutdownStatement() {
        let _localctx = new ShutdownStatementContext(this._ctx, this.state);
    ...
    invalidateMetaStatement() {
        let _localctx = new InvalidateMetaStatementContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    loadDataStatement() {
        let _localctx = new LoadDataStatementContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    refreshStatement() {
        let _localctx = new RefreshStatementContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    refreshMeta() {
        let _localctx = new RefreshMetaContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    refreshAuth() {
        let _localctx = new RefreshAuthContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    refreshFunction() {
        let _localctx = new RefreshFunctionContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    databaseNameCreate() {
        let _localctx = new DatabaseNameCreateContext(this._ctx, this.state);
    ...
    columnNamePathCreate() {
        let _localctx = new ColumnNamePathCreateContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    databaseNamePath() {
        let _localctx = new DatabaseNamePathContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    tableNamePath() {
        let _localctx = new TableNamePathContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    viewNamePath() {
        let _localctx = new ViewNamePathContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    functionNamePath() {
        let _localctx = new FunctionNamePathContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    columnNamePath() {
        let _localctx = new ColumnNamePathContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    tableOrViewPath() {
        let _localctx = new TableOrViewPathContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    createCommonItem() {
        let _localctx = new CreateCommonItemContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    assignmentItem() {
        let _localctx = new AssignmentItemContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    viewColumns() {
        let _localctx = new ViewColumnsContext(this._ctx, this.state);
    ...
    constraintSpecification() {
        let _localctx = new ConstraintSpecificationContext(this._ctx, this.state);
    ...
    foreignKeySpecification() {
        let _localctx = new ForeignKeySpecificationContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    kuduTableElement() {
        let _localctx = new KuduTableElementContext(this._ctx, this.state);
    ...
    kuduColumnDefinition() {
        let _localctx = new KuduColumnDefinitionContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    columnSpecWithKudu() {
        let _localctx = new ColumnSpecWithKuduContext(this._ctx, this.state);
    ...
    createColumnSpecWithKudu() {
        let _localctx = new CreateColumnSpecWithKuduContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    kuduAttributes() {
        let _localctx = new KuduAttributesContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    kuduStorageAttr() {
        let _localctx = new KuduStorageAttrContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    statsKey() {
        let _localctx = new StatsKeyContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    fileFormat() {
        let _localctx = new FileFormatContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    kuduPartitionClause() {
        let _localctx = new KuduPartitionClauseContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    hashClause() {
        let _localctx = new HashClauseContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    rangeClause() {
        let _localctx = new RangeClauseContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    kuduPartitionSpec() {
        let _localctx = new KuduPartitionSpecContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    cacheSpec() {
        let _localctx = new CacheSpecContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    rangeOperator() {
        let _localctx = new RangeOperatorContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    partitionCol() {
        let _localctx = new PartitionColContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    partitionedBy() {
        let _localctx = new PartitionedByContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    sortedBy() {
        let _localctx = new SortedByContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    rowFormat() {
        let _localctx = new RowFormatContext(this._ctx, this.state);
                                ...
                                case 1:
                                    {
                                        ...
                                        this.state = 1881;
                                        _localctx._operator = this.match(ImpalaSqlParser.KW_INTERSECT);
                                        this.state = 1883;
                                        this._errHandler.sync(this);
                                        _la = this._input.LA(1);
    ...
    // @RuleVersion(0)
    createColumnAliases() {
        let _localctx = new CreateColumnAliasesContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    subQueryRelation() {
        let _localctx = new SubQueryRelationContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    unnest() {
        let _localctx = new UnnestContext(this._ctx, this.state);
    ...
    parenthesizedRelation() {
        let _localctx = new ParenthesizedRelationContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    columnItem() {
        let _localctx = new ColumnItemContext(this._ctx, this.state);
                                ...
                                case 1:
                                    {
                                        ...
                                        this.state = 2178;
                                        _localctx._operator = this.match(ImpalaSqlParser.KW_AND);
                                        this.state = 2179;
                                ...
                                case 2:
                                    {
                                        ...
                                        this.state = 2181;
                                        _localctx._operator = this.match(ImpalaSqlParser.KW_OR);
                                        this.state = 2182;
                    ...
                    case 25:
                        {
                            ...
                            _prevctx = _localctx;
                            this.state = 2443;
                            _localctx._name = this.match(ImpalaSqlParser.KW_CURRENT_DATE);
                        }
                        break;
                    case 26:
                        {
                            ...
                            _prevctx = _localctx;
                            this.state = 2444;
                            _localctx._name = this.match(ImpalaSqlParser.KW_CURRENT_TIME);
                            this.state = 2448;
                            this._errHandler.sync(this);
                                ...
                                case 1:
                                    {
                                        ...
                                        this.match(ImpalaSqlParser.LPAREN);
                                        this.state = 2446;
                                        _localctx._precision = this.match(ImpalaSqlParser.INTEGER_VALUE);
                                        this.state = 2447;
                                        this.match(ImpalaSqlParser.RPAREN);
                                    }
                                    break;
                    ...
                    case 27:
                        {
                            ...
                            _prevctx = _localctx;
                            this.state = 2450;
                            _localctx._name = this.match(ImpalaSqlParser.KW_CURRENT_TIMESTAMP);
                            this.state = 2454;
                            this._errHandler.sync(this);
                    ...
                    case 28:
                        {
                            ...
                            _prevctx = _localctx;
                            this.state = 2456;
                            _localctx._name = this.match(ImpalaSqlParser.KW_LOCALTIME);
                            this.state = 2460;
                            this._errHandler.sync(this);
                    ...
                    case 29:
                        {
                            ...
                            _prevctx = _localctx;
                            this.state = 2462;
                            _localctx._name = this.match(ImpalaSqlParser.KW_LOCALTIMESTAMP);
                            this.state = 2466;
                            this._errHandler.sync(this);
                    ...
                    case 30:
                        {
                            ...
                            _prevctx = _localctx;
                            this.state = 2468;
                            _localctx._name = this.match(ImpalaSqlParser.KW_CURRENT_USER);
                        }
                        break;
                    case 31:
                        {
                            ...
                            _prevctx = _localctx;
                            this.state = 2469;
                            _localctx._name = this.match(ImpalaSqlParser.KW_CURRENT_PATH);
                        }
                        break;
                    case 32:
                        {
            ...
            switch (this.interpreter.adaptivePredict(this._input, 339, this._ctx)) {
                case 1:
                    ...
                    this.enterOuterAlt(_localctx, 1);
                    {
                        ...
                        this.state = 2687;
                        _localctx._boundType = this.match(ImpalaSqlParser.KW_PRECEDING);
                    }
                    break;
                case 2:
                    _localctx = new UnboundedFrameContext(_localctx);
                    this.enterOuterAlt(_localctx, 2);
                    {
                        ...
                        this.match(ImpalaSqlParser.KW_UNBOUNDED);
                        this.state = 2689;
                        _localctx._boundType = this.match(ImpalaSqlParser.KW_FOLLOWING);
                    }
                    break;
                case 3:
...
ImpalaSqlParser.KW_MAP = 122;
ImpalaSqlParser.KW_MINUTE = 123;
ImpalaSqlParser.KW_MINUTES = 124;
ImpalaSqlParser.KW_MONTH = 125;
ImpalaSqlParser.KW_MONTHS = 126;
ImpalaSqlParser.KW_MERGE_FN = 127;
ImpalaSqlParser.KW_NFC = 128;
ImpalaSqlParser.KW_NFD = 129;
ImpalaSqlParser.KW_NFKC = 130;
ImpalaSqlParser.KW_NFKD = 131;
ImpalaSqlParser.KW_NORMALIZE = 132;
ImpalaSqlParser.KW_NOT = 133;
ImpalaSqlParser.KW_NULL = 134;
ImpalaSqlParser.KW_NULLS = 135;
ImpalaSqlParser.KW_OFFSET = 136;
ImpalaSqlParser.KW_ON = 137;
ImpalaSqlParser.KW_OPTION = 138;
ImpalaSqlParser.KW_OR = 139;
ImpalaSqlParser.KW_ORDER = 140;
ImpalaSqlParser.KW_ORDINALITY = 141;
ImpalaSqlParser.KW_OUTER = 142;
ImpalaSqlParser.KW_OWNER = 143;
ImpalaSqlParser.KW_OVER = 144;
ImpalaSqlParser.KW_OVERWRITE = 145;
ImpalaSqlParser.KW_PARTITION = 146;
ImpalaSqlParser.KW_PARTITIONS = 147;
ImpalaSqlParser.KW_PARQUET = 148;
ImpalaSqlParser.KW_POSITION = 149;
ImpalaSqlParser.KW_PRECEDING = 150;
ImpalaSqlParser.KW_PRIMARY = 151;
ImpalaSqlParser.KW_REPLICATION = 152;
ImpalaSqlParser.KW_PRIVILEGES = 153;
ImpalaSqlParser.KW_PROPERTIES = 154;
ImpalaSqlParser.KW_RANGE = 155;
ImpalaSqlParser.KW_RECOVER = 156;
ImpalaSqlParser.KW_RENAME = 157;
ImpalaSqlParser.KW_REPEATABLE = 158;
ImpalaSqlParser.KW_REPLACE = 159;
ImpalaSqlParser.KW_RESTRICT = 160;
ImpalaSqlParser.KW_RETURNS = 161;
ImpalaSqlParser.KW_REVOKE = 162;
ImpalaSqlParser.KW_REFRESH = 163;
ImpalaSqlParser.KW_REGEXP = 164;
ImpalaSqlParser.KW_RLIKE = 165;
ImpalaSqlParser.KW_RIGHT = 166;
ImpalaSqlParser.KW_ROLE = 167;
ImpalaSqlParser.KW_ROLES = 168;
ImpalaSqlParser.KW_ROW = 169;
ImpalaSqlParser.KW_ROWS = 170;
ImpalaSqlParser.KW_SCHEMA = 171;
ImpalaSqlParser.KW_SCHEMAS = 172;
ImpalaSqlParser.KW_SECOND = 173;
ImpalaSqlParser.KW_SECONDS = 174;
ImpalaSqlParser.KW_SELECT = 175;
ImpalaSqlParser.KW_SERDEPROPERTIES = 176;
ImpalaSqlParser.KW_SET = 177;
ImpalaSqlParser.KW_SEMI = 178;
ImpalaSqlParser.KW_SERVER = 179;
ImpalaSqlParser.KW_SHOW = 180;
ImpalaSqlParser.KW_SHUTDOWN = 181;
ImpalaSqlParser.KW_SOME = 182;
ImpalaSqlParser.KW_STATS = 183;
ImpalaSqlParser.KW_STRUCT = 184;
ImpalaSqlParser.KW_STRAIGHT_JOIN = 185;
ImpalaSqlParser.KW_SUBSTRING = 186;
ImpalaSqlParser.KW_SYSTEM = 187;
ImpalaSqlParser.KW_SYMBOL = 188;
ImpalaSqlParser.KW_SERIALIZE_FN = 189;
ImpalaSqlParser.KW_TABLE = 190;
ImpalaSqlParser.KW_TABLES = 191;
ImpalaSqlParser.KW_TABLESAMPLE = 192;
ImpalaSqlParser.KW_TERMINATED = 193;
ImpalaSqlParser.KW_THEN = 194;
ImpalaSqlParser.KW_TO = 195;
ImpalaSqlParser.KW_TRUE = 196;
ImpalaSqlParser.KW_TRY_CAST = 197;
ImpalaSqlParser.KW_TRUNCATE = 198;
ImpalaSqlParser.KW_UNCACHED = 199;
ImpalaSqlParser.KW_UESCAPE = 200;
ImpalaSqlParser.KW_UNBOUNDED = 201;
ImpalaSqlParser.KW_UNION = 202;
ImpalaSqlParser.KW_UNNEST = 203;
ImpalaSqlParser.KW_UNSET = 204;
ImpalaSqlParser.KW_USE = 205;
ImpalaSqlParser.KW_USER = 206;
ImpalaSqlParser.KW_USING = 207;
ImpalaSqlParser.KW_UPDATE_FN = 208;
ImpalaSqlParser.KW_UPSERT = 209;
ImpalaSqlParser.KW_UNKNOWN = 210;
ImpalaSqlParser.KW_URI = 211;
ImpalaSqlParser.KW_VALUE = 212;
ImpalaSqlParser.KW_VALUES = 213;
ImpalaSqlParser.KW_VIEW = 214;
ImpalaSqlParser.KW_VIEWS = 215;
ImpalaSqlParser.KW_WHEN = 216;
ImpalaSqlParser.KW_WHERE = 217;
ImpalaSqlParser.KW_WITH = 218;
ImpalaSqlParser.KW_YEAR = 219;
ImpalaSqlParser.KW_YEARS = 220;
ImpalaSqlParser.KW_TEXTFILE = 221;
ImpalaSqlParser.KW_ORC = 222;
ImpalaSqlParser.KW_AVRO = 223;
ImpalaSqlParser.KW_SEQUENCEFILE = 224;
ImpalaSqlParser.KW_RCFILE = 225;
ImpalaSqlParser.KW_REFERENCES = 226;
ImpalaSqlParser.KW_NOVALIDATE = 227;
ImpalaSqlParser.KW_RELY = 228;
ImpalaSqlParser.STATS_NUMDVS = 229;
ImpalaSqlParser.STATS_NUMNULLS = 230;
ImpalaSqlParser.STATS_AVGSIZE = 231;
ImpalaSqlParser.STATS_MAXSIZE = 232;
ImpalaSqlParser.EQ = 233;
ImpalaSqlParser.NEQ = 234;
ImpalaSqlParser.LT = 235;
ImpalaSqlParser.LTE = 236;
ImpalaSqlParser.GT = 237;
ImpalaSqlParser.GTE = 238;
ImpalaSqlParser.PLUS = 239;
ImpalaSqlParser.MINUS = 240;
ImpalaSqlParser.ASTERISK = 241;
ImpalaSqlParser.SLASH = 242;
ImpalaSqlParser.PERCENT = 243;
ImpalaSqlParser.CONCAT = 244;
ImpalaSqlParser.DOT = 245;
ImpalaSqlParser.SEMICOLON = 246;
ImpalaSqlParser.COMMA = 247;
ImpalaSqlParser.COLON = 248;
ImpalaSqlParser.LPAREN = 249;
ImpalaSqlParser.RPAREN = 250;
ImpalaSqlParser.LSQUARE = 251;
ImpalaSqlParser.RSQUARE = 252;
ImpalaSqlParser.LCURLY = 253;
ImpalaSqlParser.RCURLY = 254;
ImpalaSqlParser.BITWISEOR = 255;
ImpalaSqlParser.QUESTION = 256;
ImpalaSqlParser.RIGHT_ARROW = 257;
ImpalaSqlParser.STRING = 258;
ImpalaSqlParser.UNICODE_STRING = 259;
ImpalaSqlParser.BINARY_LITERAL = 260;
ImpalaSqlParser.INTEGER_VALUE = 261;
ImpalaSqlParser.DECIMAL_VALUE = 262;
ImpalaSqlParser.DOUBLE_VALUE = 263;
ImpalaSqlParser.IDENTIFIER = 264;
ImpalaSqlParser.DIGIT_IDENTIFIER = 265;
ImpalaSqlParser.QUOTED_IDENTIFIER = 266;
ImpalaSqlParser.BACKQUOTED_IDENTIFIER = 267;
ImpalaSqlParser.TIME_WITH_TIME_ZONE = 268;
ImpalaSqlParser.TIMESTAMP_WITH_TIME_ZONE = 269;
ImpalaSqlParser.DOUBLE_PRECISION = 270;
ImpalaSqlParser.SIMPLE_COMMENT = 271;
ImpalaSqlParser.BRACKETED_COMMENT = 272;
ImpalaSqlParser.WS = 273;
...
ImpalaSqlParser.RULE_columnDefinition = 106;
ImpalaSqlParser.RULE_kuduTableElement = 107;
ImpalaSqlParser.RULE_kuduColumnDefinition = 108;
ImpalaSqlParser.RULE_columnSpecWithKudu = 109;
ImpalaSqlParser.RULE_createColumnSpecWithKudu = 110;
ImpalaSqlParser.RULE_kuduAttributes = 111;
ImpalaSqlParser.RULE_kuduStorageAttr = 112;
ImpalaSqlParser.RULE_statsKey = 113;
ImpalaSqlParser.RULE_fileFormat = 114;
ImpalaSqlParser.RULE_kuduPartitionClause = 115;
ImpalaSqlParser.RULE_hashClause = 116;
ImpalaSqlParser.RULE_rangeClause = 117;
ImpalaSqlParser.RULE_kuduPartitionSpec = 118;
ImpalaSqlParser.RULE_cacheSpec = 119;
ImpalaSqlParser.RULE_rangeOperator = 120;
ImpalaSqlParser.RULE_partitionCol = 121;
ImpalaSqlParser.RULE_likeClause = 122;
ImpalaSqlParser.RULE_properties = 123;
ImpalaSqlParser.RULE_partitionedBy = 124;
ImpalaSqlParser.RULE_sortedBy = 125;
ImpalaSqlParser.RULE_rowFormat = 126;
ImpalaSqlParser.RULE_property = 127;
ImpalaSqlParser.RULE_queryNoWith = 128;
ImpalaSqlParser.RULE_queryTerm = 129;
ImpalaSqlParser.RULE_queryPrimary = 130;
ImpalaSqlParser.RULE_sortItem = 131;
ImpalaSqlParser.RULE_querySpecification = 132;
ImpalaSqlParser.RULE_groupBy = 133;
ImpalaSqlParser.RULE_groupingElement = 134;
ImpalaSqlParser.RULE_groupingSet = 135;
ImpalaSqlParser.RULE_namedQuery = 136;
ImpalaSqlParser.RULE_setQuantifier = 137;
ImpalaSqlParser.RULE_selectItem = 138;
ImpalaSqlParser.RULE_relation = 139;
ImpalaSqlParser.RULE_joinType = 140;
ImpalaSqlParser.RULE_joinCriteria = 141;
ImpalaSqlParser.RULE_sampledRelation = 142;
ImpalaSqlParser.RULE_sampleType = 143;
ImpalaSqlParser.RULE_aliasedRelation = 144;
ImpalaSqlParser.RULE_columnAliases = 145;
ImpalaSqlParser.RULE_createColumnAliases = 146;
...
ImpalaSqlParser.RULE_typeParameter = 165;
ImpalaSqlParser.RULE_baseType = 166;
ImpalaSqlParser.RULE_whenClause = 167;
ImpalaSqlParser.RULE_filter = 168;
ImpalaSqlParser.RULE_over = 169;
ImpalaSqlParser.RULE_windowFrame = 170;
ImpalaSqlParser.RULE_frameBound = 171;
ImpalaSqlParser.RULE_pathElement = 172;
ImpalaSqlParser.RULE_pathSpecification = 173;
ImpalaSqlParser.RULE_privilege = 174;
ImpalaSqlParser.RULE_objectType = 175;
ImpalaSqlParser.RULE_qualifiedName = 176;
ImpalaSqlParser.RULE_principal = 177;
ImpalaSqlParser.RULE_identifier = 178;
ImpalaSqlParser.RULE_number = 179;
ImpalaSqlParser.RULE_reservedKeywordsUsedAsFuncName = 180;
ImpalaSqlParser.RULE_nonReserved = 181;
...
ImpalaSqlParser._SYMBOLIC_NAMES = [
...
ImpalaSqlParser.VOCABULARY = new VocabularyImpl(ImpalaSqlParser._LITERAL_NAMES, ImpalaSqlParser._SYMBOLIC_NAMES, []);
ImpalaSqlParser._serializedATNSegments = 6;
ImpalaSqlParser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\u0113\u0AD5\x04" +
...
ImpalaSqlParser._serializedATNSegment2 = ".\x18\x02\u02A0\u02A8\x05,\x17\x02\u02A1\u02A8\x05*\x16\x02\u02A2\u02A8" +
...
ImpalaSqlParser._serializedATNSegment3 = "\x02\u055A\u055B\x07\"\x02\x02\u055B\u055C\x05\xC2b\x02\u055C\u055F\x07" +
...
ImpalaSqlParser._serializedATNSegment4 = "\u080B\x03\x02\x02\x02\u0811\u080D\x03\x02\x02\x02\u0811\u080F\x03\x02" +
...
ImpalaSqlParser._serializedATNSegment5 = "\u010B\x02\x02\u0AC0\u0ABB\x03\x02\x02\x02\u0AC0\u0ABC\x03\x02\x02\x02" +
    ...
    "\u0A2F\u0A31\u0A37\u0A3C\u0A42\u0A58\u0A5B\u0A64\u0A67\u0A6A\u0A7E\u0A89" +
    "\u0A90\u0A97\u0AA5\u0AA7\u0AB0\u0AB9\u0AC0\u0AC3\u0AC7\u0ACB\u0ACE";
ImpalaSqlParser._serializedATN = Utils.join([
...
export class ProgramContext extends ParserRuleContext {
    EOF() { return this.getToken(ImpalaSqlParser.EOF, 0); }
    singleStatement(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_program; }
    // @Override
    enterRule(listener) {
...
export class SingleStatementContext extends ParserRuleContext {
    ...
    SEMICOLON() { return this.tryGetToken(ImpalaSqlParser.SEMICOLON, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_singleStatement; }
    // @Override
    enterRule(listener) {
...
export class SqlStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_sqlStatement; }
    // @Override
    enterRule(listener) {
...
export class UseStatementContext extends ParserRuleContext {
    KW_USE() { return this.getToken(ImpalaSqlParser.KW_USE, 0); }
    databaseNamePath() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_useStatement; }
    // @Override
    enterRule(listener) {
...
export class CreateStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createStatement; }
    // @Override
    enterRule(listener) {
...
export class CreateTableSelectContext extends ParserRuleContext {
    KW_CREATE() { return this.getToken(ImpalaSqlParser.KW_CREATE, 0); }
    KW_TABLE() { return this.getToken(ImpalaSqlParser.KW_TABLE, 0); }
    tableNameCreate() {
    ...
    KW_EXTERNAL() { return this.tryGetToken(ImpalaSqlParser.KW_EXTERNAL, 0); }
    ifNotExists() {
        return this.tryGetRuleContext(0, IfNotExistsContext);
    }
    LPAREN() { return this.tryGetToken(ImpalaSqlParser.LPAREN, 0); }
    columnDefinition(i) {
        if (i === undefined) {
    ...
    RPAREN() { return this.tryGetToken(ImpalaSqlParser.RPAREN, 0); }
    KW_PARTITIONED() { return this.tryGetToken(ImpalaSqlParser.KW_PARTITIONED, 0); }
    KW_BY() { return this.tryGetToken(ImpalaSqlParser.KW_BY, 0); }
    KW_AS() { return this.tryGetToken(ImpalaSqlParser.KW_AS, 0); }
    queryStatement() {
        return this.tryGetRuleContext(0, QueryStatementContext);
    }
    partitionedBy() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createTableSelect; }
    // @Override
    enterRule(listener) {
...
export class CreateTableLikeContext extends ParserRuleContext {
    ...
    KW_LIKE() { return this.getToken(ImpalaSqlParser.KW_LIKE, 0); }
    createCommonItem() {
        return this.getRuleContext(0, CreateCommonItemContext);
    }
    tableNamePath() {
    ...
    KW_PARQUET() { return this.tryGetToken(ImpalaSqlParser.KW_PARQUET, 0); }
    KW_EXTERNAL() { return this.tryGetToken(ImpalaSqlParser.KW_EXTERNAL, 0); }
    ifNotExists() {
        return this.tryGetRuleContext(0, IfNotExistsContext);
    }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createTableLike; }
    // @Override
    enterRule(listener) {
...
export class CreateKuduTableAsSelectContext extends ParserRuleContext {
    ...
    KW_STORED() { return this.getToken(ImpalaSqlParser.KW_STORED, 0); }
    KW_AS(i) {
        if (i === undefined) {
    ...
    KW_KUDU() { return this.getToken(ImpalaSqlParser.KW_KUDU, 0); }
    KW_EXTERNAL() { return this.tryGetToken(ImpalaSqlParser.KW_EXTERNAL, 0); }
    ifNotExists() {
        return this.tryGetRuleContext(0, IfNotExistsContext);
    }
    ...
    KW_PARTITION() { return this.tryGetToken(ImpalaSqlParser.KW_PARTITION, 0); }
    KW_BY() { return this.tryGetToken(ImpalaSqlParser.KW_BY, 0); }
    kuduPartitionClause() {
        return this.tryGetRuleContext(0, KuduPartitionClauseContext);
    }
    KW_COMMENT() { return this.tryGetToken(ImpalaSqlParser.KW_COMMENT, 0); }
    stringLiteral() {
        return this.tryGetRuleContext(0, StringLiteralContext);
    }
    KW_TBLPROPERTIES() { return this.tryGetToken(ImpalaSqlParser.KW_TBLPROPERTIES, 0); }
    queryStatement() {
        return this.tryGetRuleContext(0, QueryStatementContext);
    }
    properties() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createKuduTableAsSelect; }
    // @Override
    enterRule(listener) {
...
export class CreateViewContext extends ParserRuleContext {
    KW_CREATE() { return this.getToken(ImpalaSqlParser.KW_CREATE, 0); }
    KW_VIEW() { return this.getToken(ImpalaSqlParser.KW_VIEW, 0); }
    viewNameCreate() {
        return this.getRuleContext(0, ViewNameCreateContext);
    }
    KW_AS() { return this.getToken(ImpalaSqlParser.KW_AS, 0); }
    queryStatement() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createView; }
    // @Override
    enterRule(listener) {
...
export class CreateSchemaContext extends ParserRuleContext {
    ...
    KW_SCHEMA() { return this.tryGetToken(ImpalaSqlParser.KW_SCHEMA, 0); }
    KW_DATABASE() { return this.tryGetToken(ImpalaSqlParser.KW_DATABASE, 0); }
    ifNotExists() {
        return this.tryGetRuleContext(0, IfNotExistsContext);
    }
    KW_COMMENT() { return this.tryGetToken(ImpalaSqlParser.KW_COMMENT, 0); }
    KW_LOCATION() { return this.tryGetToken(ImpalaSqlParser.KW_LOCATION, 0); }
    stringLiteral(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createSchema; }
    // @Override
    enterRule(listener) {
...
export class CreateRoleContext extends ParserRuleContext {
    KW_CREATE() { return this.getToken(ImpalaSqlParser.KW_CREATE, 0); }
    KW_ROLE() { return this.getToken(ImpalaSqlParser.KW_ROLE, 0); }
    identifier() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createRole; }
    // @Override
    enterRule(listener) {
...
export class CreateAggregateFunctionContext extends ParserRuleContext {
    KW_CREATE() { return this.getToken(ImpalaSqlParser.KW_CREATE, 0); }
    KW_FUNCTION() { return this.getToken(ImpalaSqlParser.KW_FUNCTION, 0); }
    functionNameCreate() {
        return this.getRuleContext(0, FunctionNameCreateContext);
    }
    KW_RETURNS() { return this.getToken(ImpalaSqlParser.KW_RETURNS, 0); }
    type(i) {
        if (i === undefined) {
    ...
    KW_LOCATION() { return this.getToken(ImpalaSqlParser.KW_LOCATION, 0); }
    STRING(i) {
        if (i === undefined) {
    ...
    KW_UPDATE_FN() { return this.getToken(ImpalaSqlParser.KW_UPDATE_FN, 0); }
    EQ(i) {
        if (i === undefined) {
    ...
    KW_MERGE_FN() { return this.getToken(ImpalaSqlParser.KW_MERGE_FN, 0); }
    KW_AGGREGATE() { return this.tryGetToken(ImpalaSqlParser.KW_AGGREGATE, 0); }
    ifNotExists() {
        return this.tryGetRuleContext(0, IfNotExistsContext);
    }
    LPAREN() { return this.tryGetToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.tryGetToken(ImpalaSqlParser.RPAREN, 0); }
    KW_INTERMEDIATE() { return this.tryGetToken(ImpalaSqlParser.KW_INTERMEDIATE, 0); }
    KW_INIT_FN() { return this.tryGetToken(ImpalaSqlParser.KW_INIT_FN, 0); }
    KW_PREPARE_FN() { return this.tryGetToken(ImpalaSqlParser.KW_PREPARE_FN, 0); }
    KW_CLOSEFN() { return this.tryGetToken(ImpalaSqlParser.KW_CLOSEFN, 0); }
    KW_SERIALIZE_FN() { return this.tryGetToken(ImpalaSqlParser.KW_SERIALIZE_FN, 0); }
    KW_FINALIZE_FN() { return this.tryGetToken(ImpalaSqlParser.KW_FINALIZE_FN, 0); }
    COMMA(i) {
        if (i === undefined) {
            return this.getTokens(ImpalaSqlParser.COMMA);
        }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createAggregateFunction; }
    // @Override
    enterRule(listener) {
...
export class CreateFunctionContext extends ParserRuleContext {
    ...
    KW_LOCATION() { return this.getToken(ImpalaSqlParser.KW_LOCATION, 0); }
    STRING() { return this.getToken(ImpalaSqlParser.STRING, 0); }
    KW_SYMBOL() { return this.getToken(ImpalaSqlParser.KW_SYMBOL, 0); }
    EQ() { return this.getToken(ImpalaSqlParser.EQ, 0); }
    stringLiteral() {
    ...
    LPAREN() { return this.tryGetToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.tryGetToken(ImpalaSqlParser.RPAREN, 0); }
    KW_RETURNS() { return this.tryGetToken(ImpalaSqlParser.KW_RETURNS, 0); }
    type(i) {
        if (i === undefined) {
            return this.getRuleContexts(TypeContext);
        }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createFunction; }
    // @Override
    enterRule(listener) {
...
export class AlterStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterStatement; }
    // @Override
    enterRule(listener) {
...
export class AlterDatabaseContext extends ParserRuleContext {
    KW_ALTER() { return this.getToken(ImpalaSqlParser.KW_ALTER, 0); }
    KW_DATABASE() { return this.getToken(ImpalaSqlParser.KW_DATABASE, 0); }
    databaseNamePath() {
        return this.getRuleContext(0, DatabaseNamePathContext);
    }
    KW_SET() { return this.getToken(ImpalaSqlParser.KW_SET, 0); }
    KW_OWNER() { return this.getToken(ImpalaSqlParser.KW_OWNER, 0); }
    identifier() {
        return this.getRuleContext(0, IdentifierContext);
    }
    KW_USER() { return this.tryGetToken(ImpalaSqlParser.KW_USER, 0); }
    KW_ROLE() { return this.tryGetToken(ImpalaSqlParser.KW_ROLE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterDatabase; }
    // @Override
    enterRule(listener) {
...
export class AlterStatsKeyContext extends ParserRuleContext {
    ...
    KW_SET() { return this.getToken(ImpalaSqlParser.KW_SET, 0); }
    KW_COLUMN() { return this.getToken(ImpalaSqlParser.KW_COLUMN, 0); }
    KW_STATS() { return this.getToken(ImpalaSqlParser.KW_STATS, 0); }
    columnNamePath() {
        return this.getRuleContext(0, ColumnNamePathContext);
    }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    statsKey(i) {
        if (i === undefined) {
    ...
    RPAREN() { return this.getToken(ImpalaSqlParser.RPAREN, 0); }
    COMMA() { return this.tryGetToken(ImpalaSqlParser.COMMA, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterStatsKey; }
    // @Override
    enterRule(listener) {
...
export class AlterPartitionCacheContext extends ParserRuleContext {
    ...
    KW_SET() { return this.getToken(ImpalaSqlParser.KW_SET, 0); }
    KW_UNCACHED() { return this.tryGetToken(ImpalaSqlParser.KW_UNCACHED, 0); }
    KW_PARTITION() { return this.tryGetToken(ImpalaSqlParser.KW_PARTITION, 0); }
    expression() {
        return this.tryGetRuleContext(0, ExpressionContext);
    }
    KW_CACHED() { return this.tryGetToken(ImpalaSqlParser.KW_CACHED, 0); }
    KW_IN() { return this.tryGetToken(ImpalaSqlParser.KW_IN, 0); }
    stringLiteral() {
        return this.tryGetRuleContext(0, StringLiteralContext);
    }
    KW_WITH() { return this.tryGetToken(ImpalaSqlParser.KW_WITH, 0); }
    KW_REPLICATION() { return this.tryGetToken(ImpalaSqlParser.KW_REPLICATION, 0); }
    EQ() { return this.tryGetToken(ImpalaSqlParser.EQ, 0); }
    number() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterPartitionCache; }
    // @Override
    enterRule(listener) {
...
export class ChangeColumnDefineContext extends ParserRuleContext {
    ...
    KW_CHANGE() { return this.getToken(ImpalaSqlParser.KW_CHANGE, 0); }
    KW_COLUMN() { return this.getToken(ImpalaSqlParser.KW_COLUMN, 0); }
    columnSpecWithKudu() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_changeColumnDefine; }
    // @Override
    enterRule(listener) {
...
export class AlterDropSingleColumnContext extends ParserRuleContext {
    ...
    KW_DROP() { return this.getToken(ImpalaSqlParser.KW_DROP, 0); }
    columnNamePath() {
        return this.getRuleContext(0, ColumnNamePathContext);
    }
    KW_COLUMN() { return this.tryGetToken(ImpalaSqlParser.KW_COLUMN, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterDropSingleColumn; }
    // @Override
    enterRule(listener) {
...
export class AlterTableOwnerContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterTableOwner; }
    // @Override
    enterRule(listener) {
...
export class ReplaceOrAddColumnsContext extends ParserRuleContext {
    ...
    KW_COLUMNS() { return this.getToken(ImpalaSqlParser.KW_COLUMNS, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    ...
    RPAREN() { return this.getToken(ImpalaSqlParser.RPAREN, 0); }
    KW_REPLACE() { return this.tryGetToken(ImpalaSqlParser.KW_REPLACE, 0); }
    KW_ADD() { return this.tryGetToken(ImpalaSqlParser.KW_ADD, 0); }
    COMMA(i) {
        if (i === undefined) {
            return this.getTokens(ImpalaSqlParser.COMMA);
        }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_replaceOrAddColumns; }
    // @Override
    enterRule(listener) {
...
export class AddSingleColumnContext extends ParserRuleContext {
    ...
    KW_ADD() { return this.getToken(ImpalaSqlParser.KW_ADD, 0); }
    KW_COLUMN() { return this.getToken(ImpalaSqlParser.KW_COLUMN, 0); }
    createColumnSpecWithKudu() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_addSingleColumn; }
    // @Override
    enterRule(listener) {
...
export class AlterTableNonKuduOrKuduOnlyContext extends ParserRuleContext {
    ...
    KW_SET() { return this.tryGetToken(ImpalaSqlParser.KW_SET, 0); }
    KW_DROP() { return this.tryGetToken(ImpalaSqlParser.KW_DROP, 0); }
    KW_DEFAULT() { return this.tryGetToken(ImpalaSqlParser.KW_DEFAULT, 0); }
    KW_COLUMN() { return this.tryGetToken(ImpalaSqlParser.KW_COLUMN, 0); }
    kuduStorageAttr() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterTableNonKuduOrKuduOnly; }
    // @Override
    enterRule(listener) {
...
export class AddPartitionByRangeOrValueContext extends ParserRuleContext {
    ...
    KW_RANGE() { return this.tryGetToken(ImpalaSqlParser.KW_RANGE, 0); }
    kuduPartitionSpec() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_addPartitionByRangeOrValue; }
    // @Override
    enterRule(listener) {
...
export class AlterFormatContext extends ParserRuleContext {
    ...
    KW_FILEFORMAT() { return this.tryGetToken(ImpalaSqlParser.KW_FILEFORMAT, 0); }
    fileFormat() {
        return this.tryGetRuleContext(0, FileFormatContext);
    }
    KW_ROW() { return this.tryGetToken(ImpalaSqlParser.KW_ROW, 0); }
    KW_FORMAT() { return this.tryGetToken(ImpalaSqlParser.KW_FORMAT, 0); }
    rowFormat() {
    ...
    KW_TBLPROPERTIES() { return this.tryGetToken(ImpalaSqlParser.KW_TBLPROPERTIES, 0); }
    KW_SERDEPROPERTIES() { return this.tryGetToken(ImpalaSqlParser.KW_SERDEPROPERTIES, 0); }
    properties() {
        return this.tryGetRuleContext(0, PropertiesContext);
    }
    constructor(parent, invokingState) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterFormat; }
    // @Override
    enterRule(listener) {
...
export class RecoverPartitionsContext extends ParserRuleContext {
    ...
    KW_RECOVER() { return this.getToken(ImpalaSqlParser.KW_RECOVER, 0); }
    KW_PARTITIONS() { return this.getToken(ImpalaSqlParser.KW_PARTITIONS, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_recoverPartitions; }
    // @Override
    enterRule(listener) {
...
export class DropPartitionByRangeOrValueContext extends ParserRuleContext {
    ...
    KW_PURGE() { return this.tryGetToken(ImpalaSqlParser.KW_PURGE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_dropPartitionByRangeOrValue; }
    // @Override
    enterRule(listener) {
...
export class AlterViewContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterView; }
    // @Override
    enterRule(listener) {
...
export class RenameViewContext extends ParserRuleContext {
    ...
    KW_RENAME() { return this.getToken(ImpalaSqlParser.KW_RENAME, 0); }
    KW_TO() { return this.getToken(ImpalaSqlParser.KW_TO, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_renameView; }
    // @Override
    enterRule(listener) {
...
export class AlterViewOwnerContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterViewOwner; }
    // @Override
    enterRule(listener) {
...
export class RenameTableContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_renameTable; }
    // @Override
    enterRule(listener) {
...
export class AlterUnSetOrSetViewTblpropertiesContext extends ParserRuleContext {
    ...
    KW_TBLPROPERTIES() { return this.getToken(ImpalaSqlParser.KW_TBLPROPERTIES, 0); }
    KW_UNSET() { return this.tryGetToken(ImpalaSqlParser.KW_UNSET, 0); }
    KW_SET() { return this.tryGetToken(ImpalaSqlParser.KW_SET, 0); }
    properties() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_alterUnSetOrSetViewTblproperties; }
    // @Override
    enterRule(listener) {
...
export class TruncateTableStatementContext extends ParserRuleContext {
    KW_TRUNCATE() { return this.getToken(ImpalaSqlParser.KW_TRUNCATE, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    KW_TABLE() { return this.tryGetToken(ImpalaSqlParser.KW_TABLE, 0); }
    ifExists() {
        return this.tryGetRuleContext(0, IfExistsContext);
    }
    constructor(parent, invokingState) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_truncateTableStatement; }
    // @Override
    enterRule(listener) {
...
export class DescribeStatementContext extends ParserRuleContext {
    KW_DESCRIBE() { return this.getToken(ImpalaSqlParser.KW_DESCRIBE, 0); }
    qualifiedName() {
        return this.getRuleContext(0, QualifiedNameContext);
    }
    KW_DATABASE() { return this.tryGetToken(ImpalaSqlParser.KW_DATABASE, 0); }
    KW_FORMATTED() { return this.tryGetToken(ImpalaSqlParser.KW_FORMATTED, 0); }
    KW_EXTENDED() { return this.tryGetToken(ImpalaSqlParser.KW_EXTENDED, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_describeStatement; }
    // @Override
    enterRule(listener) {
...
export class ComputeStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_computeStatement; }
    // @Override
    enterRule(listener) {
...
export class ComputeStatsContext extends ParserRuleContext {
    KW_COMPUTE() { return this.getToken(ImpalaSqlParser.KW_COMPUTE, 0); }
    KW_STATS() { return this.getToken(ImpalaSqlParser.KW_STATS, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    ...
    KW_TABLESAMPLE() { return this.tryGetToken(ImpalaSqlParser.KW_TABLESAMPLE, 0); }
    KW_SYSTEM() { return this.tryGetToken(ImpalaSqlParser.KW_SYSTEM, 0); }
    LPAREN(i) {
        if (i === undefined) {
    ...
    KW_REPEATABLE() { return this.tryGetToken(ImpalaSqlParser.KW_REPEATABLE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_computeStats; }
    // @Override
    enterRule(listener) {
...
export class ComputeIncrementalStatsContext extends ParserRuleContext {
    KW_COMPUTE() { return this.getToken(ImpalaSqlParser.KW_COMPUTE, 0); }
    KW_INCREMENTAL() { return this.getToken(ImpalaSqlParser.KW_INCREMENTAL, 0); }
    KW_STATS() { return this.getToken(ImpalaSqlParser.KW_STATS, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_computeIncrementalStats; }
    // @Override
    enterRule(listener) {
...
export class DropStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_dropStatement; }
    // @Override
    enterRule(listener) {
...
export class DropSchemaContext extends ParserRuleContext {
    ...
    KW_CASCADE() { return this.tryGetToken(ImpalaSqlParser.KW_CASCADE, 0); }
    KW_RESTRICT() { return this.tryGetToken(ImpalaSqlParser.KW_RESTRICT, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_dropSchema; }
    // @Override
    enterRule(listener) {
...
export class DropViewContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_dropView; }
    // @Override
    enterRule(listener) {
...
export class DropTableContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_dropTable; }
    // @Override
    enterRule(listener) {
...
export class DropIncrementalStatsContext extends ParserRuleContext {
    ...
    KW_INCREMENTAL() { return this.tryGetToken(ImpalaSqlParser.KW_INCREMENTAL, 0); }
    KW_PARTITION() { return this.tryGetToken(ImpalaSqlParser.KW_PARTITION, 0); }
    expression() {
        return this.tryGetRuleContext(0, ExpressionContext);
    }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_dropIncrementalStats; }
    // @Override
    enterRule(listener) {
...
export class DropFunctionContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_dropFunction; }
    // @Override
    enterRule(listener) {
...
export class DropRoleContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_dropRole; }
    // @Override
    enterRule(listener) {
...
export class GrantStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_grantStatement; }
    // @Override
    enterRule(listener) {
...
export class GrantRoleContext extends ParserRuleContext {
    KW_GRANT() { return this.getToken(ImpalaSqlParser.KW_GRANT, 0); }
    KW_ROLE() { return this.getToken(ImpalaSqlParser.KW_ROLE, 0); }
    identifier(i) {
        if (i === undefined) {
    ...
    KW_TO() { return this.getToken(ImpalaSqlParser.KW_TO, 0); }
    KW_GROUP() { return this.getToken(ImpalaSqlParser.KW_GROUP, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_grantRole; }
    // @Override
    enterRule(listener) {
...
export class GrantContext extends ParserRuleContext {
    ...
    KW_ON() { return this.getToken(ImpalaSqlParser.KW_ON, 0); }
    objectType() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_grant; }
    // @Override
    enterRule(listener) {
...
export class RevokeStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_revokeStatement; }
    // @Override
    enterRule(listener) {
...
export class RevokeRoleContext extends ParserRuleContext {
    KW_REVOKE() { return this.getToken(ImpalaSqlParser.KW_REVOKE, 0); }
    KW_ROLE() { return this.getToken(ImpalaSqlParser.KW_ROLE, 0); }
    identifier(i) {
        if (i === undefined) {
            return this.getRuleContexts(IdentifierContext);
    ...
    KW_FROM() { return this.getToken(ImpalaSqlParser.KW_FROM, 0); }
    KW_GROUP() { return this.getToken(ImpalaSqlParser.KW_GROUP, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_revokeRole; }
    // @Override
    enterRule(listener) {
...
export class RevokeContext extends ParserRuleContext {
    ...
    KW_GRANT() { return this.tryGetToken(ImpalaSqlParser.KW_GRANT, 0); }
    KW_OPTION() { return this.tryGetToken(ImpalaSqlParser.KW_OPTION, 0); }
    KW_FOR() { return this.tryGetToken(ImpalaSqlParser.KW_FOR, 0); }
    qualifiedName() {
        return this.tryGetRuleContext(0, QualifiedNameContext);
    }
    principal() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_revoke; }
    // @Override
    enterRule(listener) {
...
export class InsertStatementContext extends ParserRuleContext {
    KW_INSERT() { return this.getToken(ImpalaSqlParser.KW_INSERT, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    queryStatement() {
    ...
    KW_INTO() { return this.tryGetToken(ImpalaSqlParser.KW_INTO, 0); }
    KW_OVERWRITE() { return this.tryGetToken(ImpalaSqlParser.KW_OVERWRITE, 0); }
    with() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_insertStatement; }
    // @Override
    enterRule(listener) {
...
export class DeleteStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_deleteStatement; }
    // @Override
    enterRule(listener) {
...
export class DeleteContext extends ParserRuleContext {
    KW_DELETE() { return this.getToken(ImpalaSqlParser.KW_DELETE, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    KW_FROM() { return this.tryGetToken(ImpalaSqlParser.KW_FROM, 0); }
    KW_WHERE() { return this.tryGetToken(ImpalaSqlParser.KW_WHERE, 0); }
    booleanExpression() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_delete; }
    // @Override
    enterRule(listener) {
...
export class DeleteTableRefContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_deleteTableRef; }
    // @Override
    enterRule(listener) {
...
export class UpdateStatementContext extends ParserRuleContext {
    KW_UPDATE() { return this.getToken(ImpalaSqlParser.KW_UPDATE, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    KW_SET() { return this.getToken(ImpalaSqlParser.KW_SET, 0); }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_updateStatement; }
    // @Override
    enterRule(listener) {
...
export class UpsertStatementContext extends ParserRuleContext {
    KW_UPSERT() { return this.getToken(ImpalaSqlParser.KW_UPSERT, 0); }
    KW_INTO() { return this.getToken(ImpalaSqlParser.KW_INTO, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    queryStatement() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_upsertStatement; }
    // @Override
    enterRule(listener) {
...
export class ShowStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showStatement; }
    // @Override
    enterRule(listener) {
...
export class ShowSchemasContext extends ParserRuleContext {
    KW_SHOW() { return this.getToken(ImpalaSqlParser.KW_SHOW, 0); }
    KW_SCHEMAS() { return this.tryGetToken(ImpalaSqlParser.KW_SCHEMAS, 0); }
    KW_DATABASES() { return this.tryGetToken(ImpalaSqlParser.KW_DATABASES, 0); }
    stringLiteral(i) {
        if (i === undefined) {
            return this.getRuleContexts(StringLiteralContext);
        }
    ...
    KW_LIKE() { return this.tryGetToken(ImpalaSqlParser.KW_LIKE, 0); }
    BITWISEOR(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showSchemas; }
    // @Override
    enterRule(listener) {
...
export class ShowTablesContext extends ParserRuleContext {
    KW_SHOW() { return this.getToken(ImpalaSqlParser.KW_SHOW, 0); }
    KW_TABLES() { return this.getToken(ImpalaSqlParser.KW_TABLES, 0); }
    KW_IN() { return this.tryGetToken(ImpalaSqlParser.KW_IN, 0); }
    tableNamePath() {
        return this.tryGetRuleContext(0, TableNamePathContext);
    }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showTables; }
    // @Override
    enterRule(listener) {
...
export class ShowFunctionsContext extends ParserRuleContext {
    KW_SHOW() { return this.getToken(ImpalaSqlParser.KW_SHOW, 0); }
    KW_FUNCTIONS() { return this.getToken(ImpalaSqlParser.KW_FUNCTIONS, 0); }
    KW_IN() { return this.tryGetToken(ImpalaSqlParser.KW_IN, 0); }
    databaseNamePath() {
        return this.tryGetRuleContext(0, DatabaseNamePathContext);
    }
    KW_AGGREGATE() { return this.tryGetToken(ImpalaSqlParser.KW_AGGREGATE, 0); }
    KW_ANALYTIC() { return this.tryGetToken(ImpalaSqlParser.KW_ANALYTIC, 0); }
    stringLiteral(i) {
        if (i === undefined) {
            return this.getRuleContexts(StringLiteralContext);
        }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showFunctions; }
    // @Override
    enterRule(listener) {
...
export class ShowCreateTableContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showCreateTable; }
    // @Override
    enterRule(listener) {
...
export class ShowCreateViewContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showCreateView; }
    // @Override
    enterRule(listener) {
...
export class ShowTableStatsContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showTableStats; }
    // @Override
    enterRule(listener) {
...
export class ShowColumnStatsContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showColumnStats; }
    // @Override
    enterRule(listener) {
...
export class ShowPartitionsContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showPartitions; }
    // @Override
    enterRule(listener) {
...
export class ShowFilesContext extends ParserRuleContext {
    KW_SHOW() { return this.getToken(ImpalaSqlParser.KW_SHOW, 0); }
    KW_FILES() { return this.getToken(ImpalaSqlParser.KW_FILES, 0); }
    KW_IN() { return this.getToken(ImpalaSqlParser.KW_IN, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    KW_PARTITION() { return this.tryGetToken(ImpalaSqlParser.KW_PARTITION, 0); }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showFiles; }
    // @Override
    enterRule(listener) {
...
export class ShowRolesContext extends ParserRuleContext {
    KW_SHOW() { return this.getToken(ImpalaSqlParser.KW_SHOW, 0); }
    KW_ROLES() { return this.getToken(ImpalaSqlParser.KW_ROLES, 0); }
    KW_CURRENT() { return this.tryGetToken(ImpalaSqlParser.KW_CURRENT, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showRoles; }
    // @Override
    enterRule(listener) {
...
export class ShowRoleGrantContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showRoleGrant; }
    // @Override
    enterRule(listener) {
...
export class ShowGrantsContext extends ParserRuleContext {
    ...
    KW_SHOW() { return this.tryGetToken(ImpalaSqlParser.KW_SHOW, 0); }
    KW_GRANT() { return this.tryGetToken(ImpalaSqlParser.KW_GRANT, 0); }
    identifier() {
        return this.tryGetRuleContext(0, IdentifierContext);
    }
    KW_USER() { return this.tryGetToken(ImpalaSqlParser.KW_USER, 0); }
    KW_ROLE() { return this.tryGetToken(ImpalaSqlParser.KW_ROLE, 0); }
    KW_GROUP() { return this.tryGetToken(ImpalaSqlParser.KW_GROUP, 0); }
    KW_ON() { return this.tryGetToken(ImpalaSqlParser.KW_ON, 0); }
    KW_SERVER() { return this.tryGetToken(ImpalaSqlParser.KW_SERVER, 0); }
    KW_URI() { return this.tryGetToken(ImpalaSqlParser.KW_URI, 0); }
    qualifiedName() {
        return this.tryGetRuleContext(0, QualifiedNameContext);
    }
    constructor(parent, invokingState) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showGrants; }
    // @Override
    enterRule(listener) {
...
export class ShowDatabaseGrantContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showDatabaseGrant; }
    // @Override
    enterRule(listener) {
...
export class ShowTableGrantContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showTableGrant; }
    // @Override
    enterRule(listener) {
...
export class ShowColumnGrantContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_showColumnGrant; }
    // @Override
    enterRule(listener) {
...
export class AddCommentStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_addCommentStatement; }
    // @Override
    enterRule(listener) {
...
export class AddDatabaseCommentsContext extends ParserRuleContext {
    KW_COMMENT() { return this.getToken(ImpalaSqlParser.KW_COMMENT, 0); }
    KW_ON() { return this.getToken(ImpalaSqlParser.KW_ON, 0); }
    KW_DATABASE() { return this.getToken(ImpalaSqlParser.KW_DATABASE, 0); }
    databaseNamePath() {
        return this.getRuleContext(0, DatabaseNamePathContext);
    }
    KW_IS() { return this.getToken(ImpalaSqlParser.KW_IS, 0); }
    stringLiteral() {
        return this.tryGetRuleContext(0, StringLiteralContext);
    }
    KW_NULL() { return this.tryGetToken(ImpalaSqlParser.KW_NULL, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_addDatabaseComments; }
    // @Override
    enterRule(listener) {
...
export class AddTableCommentsContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_addTableComments; }
    // @Override
    enterRule(listener) {
...
export class AddColumnCommentsContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_addColumnComments; }
    // @Override
    enterRule(listener) {
...
export class ExplainStatementContext extends ParserRuleContext {
    KW_EXPLAIN() { return this.getToken(ImpalaSqlParser.KW_EXPLAIN, 0); }
    sqlStatement() {
        return this.getRuleContext(0, SqlStatementContext);
    }
    constructor(parent, invokingState) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_explainStatement; }
    // @Override
    enterRule(listener) {
...
export class SetStatementContext extends ParserRuleContext {
    KW_SET() { return this.getToken(ImpalaSqlParser.KW_SET, 0); }
    KW_ALL() { return this.tryGetToken(ImpalaSqlParser.KW_ALL, 0); }
    identifier() {
        return this.tryGetRuleContext(0, IdentifierContext);
    }
    EQ() { return this.tryGetToken(ImpalaSqlParser.EQ, 0); }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_setStatement; }
    // @Override
    enterRule(listener) {
...
export class ShutdownStatementContext extends ParserRuleContext {
    COLON() { return this.getToken(ImpalaSqlParser.COLON, 0); }
    KW_SHUTDOWN() { return this.getToken(ImpalaSqlParser.KW_SHUTDOWN, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.getToken(ImpalaSqlParser.RPAREN, 0); }
    stringLiteral() {
        return this.tryGetRuleContext(0, StringLiteralContext);
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_shutdownStatement; }
    // @Override
    enterRule(listener) {
...
export class InvalidateMetaStatementContext extends ParserRuleContext {
    KW_INVALIDATE() { return this.getToken(ImpalaSqlParser.KW_INVALIDATE, 0); }
    KW_METADATA() { return this.getToken(ImpalaSqlParser.KW_METADATA, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    constructor(parent, invokingState) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_invalidateMetaStatement; }
    // @Override
    enterRule(listener) {
...
export class LoadDataStatementContext extends ParserRuleContext {
    KW_LOAD() { return this.getToken(ImpalaSqlParser.KW_LOAD, 0); }
    KW_DATA() { return this.getToken(ImpalaSqlParser.KW_DATA, 0); }
    KW_INPATH() { return this.getToken(ImpalaSqlParser.KW_INPATH, 0); }
    STRING() { return this.getToken(ImpalaSqlParser.STRING, 0); }
    KW_INTO() { return this.getToken(ImpalaSqlParser.KW_INTO, 0); }
    KW_TABLE() { return this.getToken(ImpalaSqlParser.KW_TABLE, 0); }
    tableNamePath() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_loadDataStatement; }
    // @Override
    enterRule(listener) {
...
export class RefreshStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_refreshStatement; }
    // @Override
    enterRule(listener) {
...
export class RefreshMetaContext extends ParserRuleContext {
    KW_REFRESH() { return this.getToken(ImpalaSqlParser.KW_REFRESH, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    KW_PARTITION() { return this.tryGetToken(ImpalaSqlParser.KW_PARTITION, 0); }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_refreshMeta; }
    // @Override
    enterRule(listener) {
...
export class RefreshAuthContext extends ParserRuleContext {
    KW_REFRESH() { return this.getToken(ImpalaSqlParser.KW_REFRESH, 0); }
    KW_AUTHORIZATION() { return this.getToken(ImpalaSqlParser.KW_AUTHORIZATION, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_refreshAuth; }
    // @Override
    enterRule(listener) {
...
export class RefreshFunctionContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_refreshFunction; }
    // @Override
    enterRule(listener) {
...
export class IfExistsContext extends ParserRuleContext {
    KW_IF() { return this.getToken(ImpalaSqlParser.KW_IF, 0); }
    KW_EXISTS() { return this.getToken(ImpalaSqlParser.KW_EXISTS, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_ifExists; }
    // @Override
    enterRule(listener) {
...
export class IfNotExistsContext extends ParserRuleContext {
    KW_IF() { return this.getToken(ImpalaSqlParser.KW_IF, 0); }
    KW_NOT() { return this.getToken(ImpalaSqlParser.KW_NOT, 0); }
    KW_EXISTS() { return this.getToken(ImpalaSqlParser.KW_EXISTS, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_ifNotExists; }
    // @Override
    enterRule(listener) {
...
export class TableNameCreateContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_tableNameCreate; }
    // @Override
    enterRule(listener) {
...
export class DatabaseNameCreateContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_databaseNameCreate; }
    // @Override
    enterRule(listener) {
...
export class ViewNameCreateContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_viewNameCreate; }
    // @Override
    enterRule(listener) {
...
export class FunctionNameCreateContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_functionNameCreate; }
    // @Override
    enterRule(listener) {
...
export class ColumnNamePathCreateContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_columnNamePathCreate; }
    // @Override
    enterRule(listener) {
...
export class DatabaseNamePathContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_databaseNamePath; }
    // @Override
    enterRule(listener) {
...
export class TableNamePathContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_tableNamePath; }
    // @Override
    enterRule(listener) {
...
export class ViewNamePathContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_viewNamePath; }
    // @Override
    enterRule(listener) {
...
export class FunctionNamePathContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_functionNamePath; }
    // @Override
    enterRule(listener) {
...
export class ColumnNamePathContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_columnNamePath; }
    // @Override
    enterRule(listener) {
...
export class TableOrViewPathContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_tableOrViewPath; }
    // @Override
    enterRule(listener) {
...
export class CreateCommonItemContext extends ParserRuleContext {
    KW_SORT() { return this.tryGetToken(ImpalaSqlParser.KW_SORT, 0); }
    KW_BY() { return this.tryGetToken(ImpalaSqlParser.KW_BY, 0); }
    columnAliases() {
        return this.tryGetRuleContext(0, ColumnAliasesContext);
    }
    ...
    KW_SERDEPROPERTIES() { return this.tryGetToken(ImpalaSqlParser.KW_SERDEPROPERTIES, 0); }
    KW_STORED() { return this.tryGetToken(ImpalaSqlParser.KW_STORED, 0); }
    KW_AS() { return this.tryGetToken(ImpalaSqlParser.KW_AS, 0); }
    fileFormat() {
        return this.tryGetRuleContext(0, FileFormatContext);
    }
    ...
    KW_REPLICATION() { return this.tryGetToken(ImpalaSqlParser.KW_REPLICATION, 0); }
    EQ() { return this.tryGetToken(ImpalaSqlParser.EQ, 0); }
    INTEGER_VALUE() { return this.tryGetToken(ImpalaSqlParser.INTEGER_VALUE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createCommonItem; }
    // @Override
    enterRule(listener) {
...
export class AssignmentListContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_assignmentList; }
    // @Override
    enterRule(listener) {
...
export class AssignmentItemContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_assignmentItem; }
    // @Override
    enterRule(listener) {
...
export class ViewColumnsContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_viewColumns; }
    // @Override
    enterRule(listener) {
...
export class QueryStatementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_queryStatement; }
    // @Override
    enterRule(listener) {
...
export class WithContext extends ParserRuleContext {
    KW_WITH() { return this.getToken(ImpalaSqlParser.KW_WITH, 0); }
    namedQuery(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_with; }
    // @Override
    enterRule(listener) {
...
export class ConstraintSpecificationContext extends ParserRuleContext {
    KW_PRIMARY() { return this.getToken(ImpalaSqlParser.KW_PRIMARY, 0); }
    KW_KEY() { return this.getToken(ImpalaSqlParser.KW_KEY, 0); }
    columnAliases() {
        return this.getRuleContext(0, ColumnAliasesContext);
    }
    KW_DISABLE() { return this.tryGetToken(ImpalaSqlParser.KW_DISABLE, 0); }
    KW_NOVALIDATE() { return this.tryGetToken(ImpalaSqlParser.KW_NOVALIDATE, 0); }
    COMMA(i) {
        if (i === undefined) {
            return this.getTokens(ImpalaSqlParser.COMMA);
        }
    ...
    KW_RELY() { return this.tryGetToken(ImpalaSqlParser.KW_RELY, 0); }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_constraintSpecification; }
    // @Override
    enterRule(listener) {
...
export class ForeignKeySpecificationContext extends ParserRuleContext {
    KW_FOREIGN() { return this.getToken(ImpalaSqlParser.KW_FOREIGN, 0); }
    KW_KEY() { return this.getToken(ImpalaSqlParser.KW_KEY, 0); }
    columnAliases(i) {
        if (i === undefined) {
            return this.getRuleContexts(ColumnAliasesContext);
    ...
    KW_REFERENCES() { return this.getToken(ImpalaSqlParser.KW_REFERENCES, 0); }
    tableNamePath() {
        return this.getRuleContext(0, TableNamePathContext);
    }
    KW_DISABLE() { return this.tryGetToken(ImpalaSqlParser.KW_DISABLE, 0); }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_foreignKeySpecification; }
    // @Override
    enterRule(listener) {
...
export class ColumnDefinitionContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_columnDefinition; }
    // @Override
    enterRule(listener) {
...
export class KuduTableElementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_kuduTableElement; }
    // @Override
    enterRule(listener) {
...
export class KuduColumnDefinitionContext extends ParserRuleContext {
    ...
    KW_PRIMARY() { return this.tryGetToken(ImpalaSqlParser.KW_PRIMARY, 0); }
    KW_KEY() { return this.tryGetToken(ImpalaSqlParser.KW_KEY, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_kuduColumnDefinition; }
    // @Override
    enterRule(listener) {
...
export class ColumnSpecWithKuduContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_columnSpecWithKudu; }
    // @Override
    enterRule(listener) {
...
export class CreateColumnSpecWithKuduContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createColumnSpecWithKudu; }
    // @Override
    enterRule(listener) {
...
export class KuduAttributesContext extends ParserRuleContext {
    ...
    KW_NOT() { return this.tryGetToken(ImpalaSqlParser.KW_NOT, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_kuduAttributes; }
    // @Override
    enterRule(listener) {
...
export class KuduStorageAttrContext extends ParserRuleContext {
    KW_ENCODING() { return this.tryGetToken(ImpalaSqlParser.KW_ENCODING, 0); }
    expression() {
        return this.tryGetRuleContext(0, ExpressionContext);
    }
    KW_COMPRESSION() { return this.tryGetToken(ImpalaSqlParser.KW_COMPRESSION, 0); }
    KW_DEFAULT() { return this.tryGetToken(ImpalaSqlParser.KW_DEFAULT, 0); }
    KW_BLOCK_SIZE() { return this.tryGetToken(ImpalaSqlParser.KW_BLOCK_SIZE, 0); }
    number() {
        return this.tryGetRuleContext(0, NumberContext);
    }
    constructor(parent, invokingState) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_kuduStorageAttr; }
    // @Override
    enterRule(listener) {
...
export class StatsKeyContext extends ParserRuleContext {
    STATS_NUMDVS() { return this.tryGetToken(ImpalaSqlParser.STATS_NUMDVS, 0); }
    STATS_NUMNULLS() { return this.tryGetToken(ImpalaSqlParser.STATS_NUMNULLS, 0); }
    STATS_AVGSIZE() { return this.tryGetToken(ImpalaSqlParser.STATS_AVGSIZE, 0); }
    STATS_MAXSIZE() { return this.tryGetToken(ImpalaSqlParser.STATS_MAXSIZE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_statsKey; }
    // @Override
    enterRule(listener) {
...
export class FileFormatContext extends ParserRuleContext {
    KW_TEXTFILE() { return this.tryGetToken(ImpalaSqlParser.KW_TEXTFILE, 0); }
    KW_PARQUET() { return this.tryGetToken(ImpalaSqlParser.KW_PARQUET, 0); }
    KW_ORC() { return this.tryGetToken(ImpalaSqlParser.KW_ORC, 0); }
    KW_AVRO() { return this.tryGetToken(ImpalaSqlParser.KW_AVRO, 0); }
    KW_SEQUENCEFILE() { return this.tryGetToken(ImpalaSqlParser.KW_SEQUENCEFILE, 0); }
    KW_RCFILE() { return this.tryGetToken(ImpalaSqlParser.KW_RCFILE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_fileFormat; }
    // @Override
    enterRule(listener) {
...
export class KuduPartitionClauseContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_kuduPartitionClause; }
    // @Override
    enterRule(listener) {
...
export class HashClauseContext extends ParserRuleContext {
    KW_HASH() { return this.getToken(ImpalaSqlParser.KW_HASH, 0); }
    KW_PARTITIONS() { return this.getToken(ImpalaSqlParser.KW_PARTITIONS, 0); }
    number() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_hashClause; }
    // @Override
    enterRule(listener) {
...
export class RangeClauseContext extends ParserRuleContext {
    KW_RANGE() { return this.getToken(ImpalaSqlParser.KW_RANGE, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.getToken(ImpalaSqlParser.RPAREN, 0); }
    KW_PARTITION(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_rangeClause; }
    // @Override
    enterRule(listener) {
...
export class KuduPartitionSpecContext extends ParserRuleContext {
    KW_VALUE() { return this.tryGetToken(ImpalaSqlParser.KW_VALUE, 0); }
    partitionCol() {
    ...
    KW_VALUES() { return this.tryGetToken(ImpalaSqlParser.KW_VALUES, 0); }
    rangeOperator(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_kuduPartitionSpec; }
    // @Override
    enterRule(listener) {
...
export class CacheSpecContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_cacheSpec; }
    // @Override
    enterRule(listener) {
...
export class RangeOperatorContext extends ParserRuleContext {
    LT() { return this.tryGetToken(ImpalaSqlParser.LT, 0); }
    LTE() { return this.tryGetToken(ImpalaSqlParser.LTE, 0); }
    GT() { return this.tryGetToken(ImpalaSqlParser.GT, 0); }
    GTE() { return this.tryGetToken(ImpalaSqlParser.GTE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_rangeOperator; }
    // @Override
    enterRule(listener) {
...
export class PartitionColContext extends ParserRuleContext {
    EQ() { return this.tryGetToken(ImpalaSqlParser.EQ, 0); }
    NEQ() { return this.tryGetToken(ImpalaSqlParser.NEQ, 0); }
    KW_LIKE() { return this.tryGetToken(ImpalaSqlParser.KW_LIKE, 0); }
    KW_RLIKE() { return this.tryGetToken(ImpalaSqlParser.KW_RLIKE, 0); }
    KW_REGEXP() { return this.tryGetToken(ImpalaSqlParser.KW_REGEXP, 0); }
    KW_BETWEEN() { return this.tryGetToken(ImpalaSqlParser.KW_BETWEEN, 0); }
    KW_IN() { return this.tryGetToken(ImpalaSqlParser.KW_IN, 0); }
    rangeOperator() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_partitionCol; }
    // @Override
    enterRule(listener) {
...
export class LikeClauseContext extends ParserRuleContext {
    ...
    KW_PROPERTIES() { return this.tryGetToken(ImpalaSqlParser.KW_PROPERTIES, 0); }
    KW_INCLUDING() { return this.tryGetToken(ImpalaSqlParser.KW_INCLUDING, 0); }
    KW_EXCLUDING() { return this.tryGetToken(ImpalaSqlParser.KW_EXCLUDING, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_likeClause; }
    // @Override
    enterRule(listener) {
...
export class PropertiesContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_properties; }
    // @Override
    enterRule(listener) {
...
export class PartitionedByContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_partitionedBy; }
    // @Override
    enterRule(listener) {
...
export class SortedByContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_sortedBy; }
    // @Override
    enterRule(listener) {
...
export class RowFormatContext extends ParserRuleContext {
    KW_DELIMITED() { return this.getToken(ImpalaSqlParser.KW_DELIMITED, 0); }
    KW_FIELDS() { return this.tryGetToken(ImpalaSqlParser.KW_FIELDS, 0); }
    KW_TERMINATED(i) {
        if (i === undefined) {
    ...
    KW_LINES() { return this.tryGetToken(ImpalaSqlParser.KW_LINES, 0); }
    KW_ESCAPED() { return this.tryGetToken(ImpalaSqlParser.KW_ESCAPED, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_rowFormat; }
    // @Override
    enterRule(listener) {
...
export class PropertyContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_property; }
    // @Override
    enterRule(listener) {
...
export class QueryNoWithContext extends ParserRuleContext {
    ...
    KW_ORDER() { return this.tryGetToken(ImpalaSqlParser.KW_ORDER, 0); }
    KW_BY() { return this.tryGetToken(ImpalaSqlParser.KW_BY, 0); }
    sortItem(i) {
        if (i === undefined) {
    ...
    KW_LIMIT() { return this.tryGetToken(ImpalaSqlParser.KW_LIMIT, 0); }
    expression() {
        return this.tryGetRuleContext(0, ExpressionContext);
    }
    COMMA(i) {
    ...
    KW_OFFSET() { return this.tryGetToken(ImpalaSqlParser.KW_OFFSET, 0); }
    INTEGER_VALUE() { return this.tryGetToken(ImpalaSqlParser.INTEGER_VALUE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_queryNoWith; }
    // @Override
    enterRule(listener) {
...
export class QueryTermContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_queryTerm; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class SetOperationContext extends QueryTermContext {
    ...
    KW_INTERSECT() { return this.tryGetToken(ImpalaSqlParser.KW_INTERSECT, 0); }
    setQuantifier() {
        return this.tryGetRuleContext(0, SetQuantifierContext);
    }
    KW_UNION() { return this.tryGetToken(ImpalaSqlParser.KW_UNION, 0); }
    KW_EXCEPT() { return this.tryGetToken(ImpalaSqlParser.KW_EXCEPT, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class QueryPrimaryContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_queryPrimary; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class InlineTableContext extends QueryPrimaryContext {
    KW_VALUES() { return this.getToken(ImpalaSqlParser.KW_VALUES, 0); }
    expression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ExpressionContext);
        }
...
export class SortItemContext extends ParserRuleContext {
    ...
    KW_NULLS() { return this.tryGetToken(ImpalaSqlParser.KW_NULLS, 0); }
    KW_ASC() { return this.tryGetToken(ImpalaSqlParser.KW_ASC, 0); }
    KW_DESC() { return this.tryGetToken(ImpalaSqlParser.KW_DESC, 0); }
    KW_FIRST() { return this.tryGetToken(ImpalaSqlParser.KW_FIRST, 0); }
    KW_LAST() { return this.tryGetToken(ImpalaSqlParser.KW_LAST, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_sortItem; }
    // @Override
    enterRule(listener) {
...
export class QuerySpecificationContext extends ParserRuleContext {
    KW_SELECT() { return this.getToken(ImpalaSqlParser.KW_SELECT, 0); }
    selectItem(i) {
        if (i === undefined) {
    ...
    KW_STRAIGHT_JOIN() { return this.tryGetToken(ImpalaSqlParser.KW_STRAIGHT_JOIN, 0); }
    COMMA(i) {
        if (i === undefined) {
            return this.getTokens(ImpalaSqlParser.COMMA);
        }
    ...
    KW_HAVING() { return this.tryGetToken(ImpalaSqlParser.KW_HAVING, 0); }
    booleanExpression(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_querySpecification; }
    // @Override
    enterRule(listener) {
...
export class GroupByContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_groupBy; }
    // @Override
    enterRule(listener) {
...
export class GroupingElementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_groupingElement; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class GroupingSetContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_groupingSet; }
    // @Override
    enterRule(listener) {
...
export class NamedQueryContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_namedQuery; }
    // @Override
    enterRule(listener) {
...
export class SetQuantifierContext extends ParserRuleContext {
    KW_DISTINCT() { return this.tryGetToken(ImpalaSqlParser.KW_DISTINCT, 0); }
    KW_ALL() { return this.tryGetToken(ImpalaSqlParser.KW_ALL, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_setQuantifier; }
    // @Override
    enterRule(listener) {
...
export class SelectItemContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_selectItem; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class SelectAllContext extends SelectItemContext {
    ...
    DOT() { return this.tryGetToken(ImpalaSqlParser.DOT, 0); }
    ASTERISK() { return this.getToken(ImpalaSqlParser.ASTERISK, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class RelationContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_relation; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
export class JoinRelationContext extends RelationContext {
    ...
    KW_CROSS() { return this.tryGetToken(ImpalaSqlParser.KW_CROSS, 0); }
    KW_JOIN() { return this.tryGetToken(ImpalaSqlParser.KW_JOIN, 0); }
    joinType() {
...
export class JoinTypeContext extends ParserRuleContext {
    KW_INNER() { return this.tryGetToken(ImpalaSqlParser.KW_INNER, 0); }
    KW_LEFT() { return this.tryGetToken(ImpalaSqlParser.KW_LEFT, 0); }
    KW_RIGHT() { return this.tryGetToken(ImpalaSqlParser.KW_RIGHT, 0); }
    KW_OUTER() { return this.tryGetToken(ImpalaSqlParser.KW_OUTER, 0); }
    KW_FULL() { return this.tryGetToken(ImpalaSqlParser.KW_FULL, 0); }
    KW_SEMI() { return this.tryGetToken(ImpalaSqlParser.KW_SEMI, 0); }
    KW_ANTI() { return this.tryGetToken(ImpalaSqlParser.KW_ANTI, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_joinType; }
    // @Override
    enterRule(listener) {
...
export class JoinCriteriaContext extends ParserRuleContext {
    ...
    KW_USING() { return this.tryGetToken(ImpalaSqlParser.KW_USING, 0); }
    LPAREN() { return this.tryGetToken(ImpalaSqlParser.LPAREN, 0); }
    identifier(i) {
        if (i === undefined) {
            return this.getRuleContexts(IdentifierContext);
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_joinCriteria; }
    // @Override
    enterRule(listener) {
...
export class SampledRelationContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_sampledRelation; }
    // @Override
    enterRule(listener) {
...
export class SampleTypeContext extends ParserRuleContext {
    KW_BERNOULLI() { return this.tryGetToken(ImpalaSqlParser.KW_BERNOULLI, 0); }
    KW_SYSTEM() { return this.tryGetToken(ImpalaSqlParser.KW_SYSTEM, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_sampleType; }
    // @Override
    enterRule(listener) {
...
export class AliasedRelationContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_aliasedRelation; }
    // @Override
    enterRule(listener) {
...
export class ColumnAliasesContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_columnAliases; }
    // @Override
    enterRule(listener) {
...
export class CreateColumnAliasesContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_createColumnAliases; }
    // @Override
    enterRule(listener) {
...
export class RelationPrimaryContext extends ParserRuleContext {
    ...
    KW_LATERAL() { return this.tryGetToken(ImpalaSqlParser.KW_LATERAL, 0); }
    unnest() {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_relationPrimary; }
    // @Override
    enterRule(listener) {
...
export class SubQueryRelationContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_subQueryRelation; }
    // @Override
    enterRule(listener) {
...
export class UnnestContext extends ParserRuleContext {
    KW_UNNEST() { return this.getToken(ImpalaSqlParser.KW_UNNEST, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    expression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ExpressionContext);
    ...
    KW_WITH() { return this.tryGetToken(ImpalaSqlParser.KW_WITH, 0); }
    KW_ORDINALITY() { return this.tryGetToken(ImpalaSqlParser.KW_ORDINALITY, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_unnest; }
    // @Override
    enterRule(listener) {
...
export class ParenthesizedRelationContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_parenthesizedRelation; }
    // @Override
    enterRule(listener) {
...
export class ColumnItemContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_columnItem; }
    // @Override
    enterRule(listener) {
...
export class ExpressionContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_expression; }
    // @Override
    enterRule(listener) {
...
export class BooleanExpressionContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_booleanExpression; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class LogicalBinaryContext extends BooleanExpressionContext {
    ...
    KW_AND() { return this.tryGetToken(ImpalaSqlParser.KW_AND, 0); }
    KW_OR() { return this.tryGetToken(ImpalaSqlParser.KW_OR, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class PredicateContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_predicate; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
...
export class BetweenContext extends PredicateContext {
    KW_BETWEEN() { return this.getToken(ImpalaSqlParser.KW_BETWEEN, 0); }
    KW_AND() { return this.getToken(ImpalaSqlParser.KW_AND, 0); }
    valueExpression(i) {
        if (i === undefined) {
...
export class LikeContext extends PredicateContext {
    KW_LIKE() { return this.tryGetToken(ImpalaSqlParser.KW_LIKE, 0); }
    KW_ILIKE() { return this.tryGetToken(ImpalaSqlParser.KW_ILIKE, 0); }
    KW_RLIKE() { return this.tryGetToken(ImpalaSqlParser.KW_RLIKE, 0); }
    valueExpression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ValueExpressionContext);
    ...
    KW_NOT() { return this.tryGetToken(ImpalaSqlParser.KW_NOT, 0); }
    KW_ESCAPE() { return this.tryGetToken(ImpalaSqlParser.KW_ESCAPE, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState, ctx.value);
        this.copyFrom(ctx);
    }
...
export class REGEXPContext extends PredicateContext {
    KW_REGEXP() { return this.tryGetToken(ImpalaSqlParser.KW_REGEXP, 0); }
    KW_IREGEXP() { return this.tryGetToken(ImpalaSqlParser.KW_IREGEXP, 0); }
    valueExpression() {
        return this.getRuleContext(0, ValueExpressionContext);
    }
    constructor(ctx) {
...
export class NullOrUnKnownOrBooleanPredicateContext extends PredicateContext {
    KW_IS() { return this.getToken(ImpalaSqlParser.KW_IS, 0); }
    KW_NULL() { return this.tryGetToken(ImpalaSqlParser.KW_NULL, 0); }
    KW_UNKNOWN() { return this.tryGetToken(ImpalaSqlParser.KW_UNKNOWN, 0); }
    KW_TRUE() { return this.tryGetToken(ImpalaSqlParser.KW_TRUE, 0); }
    KW_FALSE() { return this.tryGetToken(ImpalaSqlParser.KW_FALSE, 0); }
    KW_NOT() { return this.tryGetToken(ImpalaSqlParser.KW_NOT, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState, ctx.value);
        this.copyFrom(ctx);
...
export class DistinctFromContext extends PredicateContext {
    KW_IS() { return this.getToken(ImpalaSqlParser.KW_IS, 0); }
    KW_DISTINCT() { return this.getToken(ImpalaSqlParser.KW_DISTINCT, 0); }
    KW_FROM() { return this.getToken(ImpalaSqlParser.KW_FROM, 0); }
    valueExpression() {
        return this.getRuleContext(0, ValueExpressionContext);
    }
...
export class ValueExpressionContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_valueExpression; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class ArithmeticUnaryContext extends ValueExpressionContext {
    ...
    MINUS() { return this.tryGetToken(ImpalaSqlParser.MINUS, 0); }
    PLUS() { return this.tryGetToken(ImpalaSqlParser.PLUS, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class ArithmeticBinaryContext extends ValueExpressionContext {
    ...
    ASTERISK() { return this.tryGetToken(ImpalaSqlParser.ASTERISK, 0); }
    SLASH() { return this.tryGetToken(ImpalaSqlParser.SLASH, 0); }
    PERCENT() { return this.tryGetToken(ImpalaSqlParser.PERCENT, 0); }
    PLUS() { return this.tryGetToken(ImpalaSqlParser.PLUS, 0); }
    MINUS() { return this.tryGetToken(ImpalaSqlParser.MINUS, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
...
export class ConcatenationContext extends ValueExpressionContext {
    CONCAT() { return this.getToken(ImpalaSqlParser.CONCAT, 0); }
    valueExpression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ValueExpressionContext);
        }
...
export class PrimaryExpressionContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_primaryExpression; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
export class NullLiteralContext extends PrimaryExpressionContext {
    KW_NULL() { return this.getToken(ImpalaSqlParser.KW_NULL, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class TypeConstructorContext extends PrimaryExpressionContext {
    ...
    DOUBLE_PRECISION() { return this.tryGetToken(ImpalaSqlParser.DOUBLE_PRECISION, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class BinaryLiteralContext extends PrimaryExpressionContext {
    BINARY_LITERAL() { return this.getToken(ImpalaSqlParser.BINARY_LITERAL, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class ParameterContext extends PrimaryExpressionContext {
    QUESTION() { return this.getToken(ImpalaSqlParser.QUESTION, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class PositionContext extends PrimaryExpressionContext {
    KW_POSITION() { return this.getToken(ImpalaSqlParser.KW_POSITION, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    valueExpression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ValueExpressionContext);
...
export class LambdaContext extends PrimaryExpressionContext {
    ...
    RIGHT_ARROW() { return this.getToken(ImpalaSqlParser.RIGHT_ARROW, 0); }
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    LPAREN() { return this.tryGetToken(ImpalaSqlParser.LPAREN, 0); }
...
export class SimpleCaseContext extends PrimaryExpressionContext {
    KW_CASE() { return this.getToken(ImpalaSqlParser.KW_CASE, 0); }
    valueExpression() {
        return this.getRuleContext(0, ValueExpressionContext);
    }
    KW_END() { return this.getToken(ImpalaSqlParser.KW_END, 0); }
    whenClause(i) {
        if (i === undefined) {
    ...
    KW_ELSE() { return this.tryGetToken(ImpalaSqlParser.KW_ELSE, 0); }
    expression() {
        return this.tryGetRuleContext(0, ExpressionContext);
    }
    constructor(ctx) {
...
export class CastContext extends PrimaryExpressionContext {
    KW_CAST() { return this.tryGetToken(ImpalaSqlParser.KW_CAST, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    ...
    RPAREN() { return this.getToken(ImpalaSqlParser.RPAREN, 0); }
    KW_TRY_CAST() { return this.tryGetToken(ImpalaSqlParser.KW_TRY_CAST, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class ArrayConstructorContext extends PrimaryExpressionContext {
    KW_ARRAY() { return this.getToken(ImpalaSqlParser.KW_ARRAY, 0); }
    LSQUARE() { return this.getToken(ImpalaSqlParser.LSQUARE, 0); }
    RSQUARE() { return this.getToken(ImpalaSqlParser.RSQUARE, 0); }
    expression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ExpressionContext);
        }
...
export class DereferenceContext extends PrimaryExpressionContext {
    DOT() { return this.getToken(ImpalaSqlParser.DOT, 0); }
    primaryExpression() {
        return this.getRuleContext(0, PrimaryExpressionContext);
    }
    identifier() {
...
export class SpecialDateTimeFunctionContext extends PrimaryExpressionContext {
    KW_CURRENT_DATE() { return this.tryGetToken(ImpalaSqlParser.KW_CURRENT_DATE, 0); }
    KW_CURRENT_TIME() { return this.tryGetToken(ImpalaSqlParser.KW_CURRENT_TIME, 0); }
    LPAREN() { return this.tryGetToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.tryGetToken(ImpalaSqlParser.RPAREN, 0); }
    INTEGER_VALUE() { return this.tryGetToken(ImpalaSqlParser.INTEGER_VALUE, 0); }
    KW_CURRENT_TIMESTAMP() { return this.tryGetToken(ImpalaSqlParser.KW_CURRENT_TIMESTAMP, 0); }
    KW_LOCALTIME() { return this.tryGetToken(ImpalaSqlParser.KW_LOCALTIME, 0); }
    KW_LOCALTIMESTAMP() { return this.tryGetToken(ImpalaSqlParser.KW_LOCALTIMESTAMP, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class CurrentUserContext extends PrimaryExpressionContext {
    KW_CURRENT_USER() { return this.getToken(ImpalaSqlParser.KW_CURRENT_USER, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class CurrentPathContext extends PrimaryExpressionContext {
    KW_CURRENT_PATH() { return this.getToken(ImpalaSqlParser.KW_CURRENT_PATH, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class SubstringContext extends PrimaryExpressionContext {
    KW_SUBSTRING() { return this.getToken(ImpalaSqlParser.KW_SUBSTRING, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    valueExpression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ValueExpressionContext);
...
export class NormalizeContext extends PrimaryExpressionContext {
    KW_NORMALIZE() { return this.getToken(ImpalaSqlParser.KW_NORMALIZE, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    valueExpression() {
        return this.getRuleContext(0, ValueExpressionContext);
    }
...
export class ExtractContext extends PrimaryExpressionContext {
    KW_EXTRACT() { return this.getToken(ImpalaSqlParser.KW_EXTRACT, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    identifier() {
        return this.getRuleContext(0, IdentifierContext);
    }
...
export class GroupingOperationContext extends PrimaryExpressionContext {
    KW_GROUPING() { return this.getToken(ImpalaSqlParser.KW_GROUPING, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.getToken(ImpalaSqlParser.RPAREN, 0); }
    qualifiedName(i) {
        if (i === undefined) {
...
export class StringLiteralContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_stringLiteral; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class UnicodeStringLiteralContext extends StringLiteralContext {
    UNICODE_STRING() { return this.getToken(ImpalaSqlParser.UNICODE_STRING, 0); }
    KW_UESCAPE() { return this.tryGetToken(ImpalaSqlParser.KW_UESCAPE, 0); }
    STRING() { return this.tryGetToken(ImpalaSqlParser.STRING, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class ComparisonOperatorContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_comparisonOperator; }
    // @Override
    enterRule(listener) {
...
export class ComparisonQuantifierContext extends ParserRuleContext {
    KW_ALL() { return this.tryGetToken(ImpalaSqlParser.KW_ALL, 0); }
    KW_SOME() { return this.tryGetToken(ImpalaSqlParser.KW_SOME, 0); }
    KW_ANY() { return this.tryGetToken(ImpalaSqlParser.KW_ANY, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_comparisonQuantifier; }
    // @Override
    enterRule(listener) {
...
export class BooleanValueContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_booleanValue; }
    // @Override
    enterRule(listener) {
...
export class IntervalContext extends ParserRuleContext {
    INTEGER_VALUE() { return this.getToken(ImpalaSqlParser.INTEGER_VALUE, 0); }
    intervalField() {
        return this.getRuleContext(0, IntervalFieldContext);
    }
    LPAREN() { return this.tryGetToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.tryGetToken(ImpalaSqlParser.RPAREN, 0); }
    KW_INTERVAL() { return this.tryGetToken(ImpalaSqlParser.KW_INTERVAL, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_interval; }
    // @Override
    enterRule(listener) {
...
export class IntervalFieldContext extends ParserRuleContext {
    KW_YEAR() { return this.tryGetToken(ImpalaSqlParser.KW_YEAR, 0); }
    KW_YEARS() { return this.tryGetToken(ImpalaSqlParser.KW_YEARS, 0); }
    KW_MONTH() { return this.tryGetToken(ImpalaSqlParser.KW_MONTH, 0); }
    KW_MONTHS() { return this.tryGetToken(ImpalaSqlParser.KW_MONTHS, 0); }
    KW_DAY() { return this.tryGetToken(ImpalaSqlParser.KW_DAY, 0); }
    KW_DAYS() { return this.tryGetToken(ImpalaSqlParser.KW_DAYS, 0); }
    KW_HOUR() { return this.tryGetToken(ImpalaSqlParser.KW_HOUR, 0); }
    KW_HOURS() { return this.tryGetToken(ImpalaSqlParser.KW_HOURS, 0); }
    KW_MINUTE() { return this.tryGetToken(ImpalaSqlParser.KW_MINUTE, 0); }
    KW_MINUTES() { return this.tryGetToken(ImpalaSqlParser.KW_MINUTES, 0); }
    KW_SECOND() { return this.tryGetToken(ImpalaSqlParser.KW_SECOND, 0); }
    KW_SECONDS() { return this.tryGetToken(ImpalaSqlParser.KW_SECONDS, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_intervalField; }
    // @Override
    enterRule(listener) {
...
export class NormalFormContext extends ParserRuleContext {
    KW_NFD() { return this.tryGetToken(ImpalaSqlParser.KW_NFD, 0); }
    KW_NFC() { return this.tryGetToken(ImpalaSqlParser.KW_NFC, 0); }
    KW_NFKD() { return this.tryGetToken(ImpalaSqlParser.KW_NFKD, 0); }
    KW_NFKC() { return this.tryGetToken(ImpalaSqlParser.KW_NFKC, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_normalForm; }
    // @Override
    enterRule(listener) {
...
export class TypeContext extends ParserRuleContext {
    ...
    KW_ARRAY() { return this.tryGetToken(ImpalaSqlParser.KW_ARRAY, 0); }
    LT() { return this.tryGetToken(ImpalaSqlParser.LT, 0); }
    GT() { return this.tryGetToken(ImpalaSqlParser.GT, 0); }
    KW_MAP() { return this.tryGetToken(ImpalaSqlParser.KW_MAP, 0); }
    COMMA(i) {
        if (i === undefined) {
            return this.getTokens(ImpalaSqlParser.COMMA);
        }
    ...
    KW_STRUCT() { return this.tryGetToken(ImpalaSqlParser.KW_STRUCT, 0); }
    identifier(i) {
        if (i === undefined) {
            return this.getRuleContexts(IdentifierContext);
        }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_type; }
    // @Override
    enterRule(listener) {
...
export class TypeParameterContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_typeParameter; }
    // @Override
    enterRule(listener) {
...
export class BaseTypeContext extends ParserRuleContext {
    TIME_WITH_TIME_ZONE() { return this.tryGetToken(ImpalaSqlParser.TIME_WITH_TIME_ZONE, 0); }
    TIMESTAMP_WITH_TIME_ZONE() { return this.tryGetToken(ImpalaSqlParser.TIMESTAMP_WITH_TIME_ZONE, 0); }
    DOUBLE_PRECISION() { return this.tryGetToken(ImpalaSqlParser.DOUBLE_PRECISION, 0); }
    identifier() {
        return this.tryGetRuleContext(0, IdentifierContext);
    }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_baseType; }
    // @Override
    enterRule(listener) {
...
export class WhenClauseContext extends ParserRuleContext {
    KW_WHEN() { return this.getToken(ImpalaSqlParser.KW_WHEN, 0); }
    KW_THEN() { return this.getToken(ImpalaSqlParser.KW_THEN, 0); }
    expression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ExpressionContext);
        }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_whenClause; }
    // @Override
    enterRule(listener) {
...
export class FilterContext extends ParserRuleContext {
    KW_FILTER() { return this.getToken(ImpalaSqlParser.KW_FILTER, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    KW_WHERE() { return this.getToken(ImpalaSqlParser.KW_WHERE, 0); }
    booleanExpression() {
        return this.getRuleContext(0, BooleanExpressionContext);
    }
    RPAREN() { return this.getToken(ImpalaSqlParser.RPAREN, 0); }
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_filter; }
    // @Override
    enterRule(listener) {
...
export class OverContext extends ParserRuleContext {
    KW_OVER() { return this.getToken(ImpalaSqlParser.KW_OVER, 0); }
    LPAREN() { return this.getToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.getToken(ImpalaSqlParser.RPAREN, 0); }
    KW_PARTITION() { return this.tryGetToken(ImpalaSqlParser.KW_PARTITION, 0); }
    KW_BY(i) {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_over; }
    // @Override
    enterRule(listener) {
...
export class WindowFrameContext extends ParserRuleContext {
    ...
    KW_ROWS() { return this.tryGetToken(ImpalaSqlParser.KW_ROWS, 0); }
    KW_BETWEEN() { return this.tryGetToken(ImpalaSqlParser.KW_BETWEEN, 0); }
    KW_AND() { return this.tryGetToken(ImpalaSqlParser.KW_AND, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_windowFrame; }
    // @Override
    enterRule(listener) {
...
export class FrameBoundContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_frameBound; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
export class UnboundedFrameContext extends FrameBoundContext {
    KW_UNBOUNDED() { return this.getToken(ImpalaSqlParser.KW_UNBOUNDED, 0); }
    KW_PRECEDING() { return this.tryGetToken(ImpalaSqlParser.KW_PRECEDING, 0); }
    KW_FOLLOWING() { return this.tryGetToken(ImpalaSqlParser.KW_FOLLOWING, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class CurrentRowBoundContext extends FrameBoundContext {
    KW_CURRENT() { return this.getToken(ImpalaSqlParser.KW_CURRENT, 0); }
    KW_ROW() { return this.getToken(ImpalaSqlParser.KW_ROW, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class PathElementContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_pathElement; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class PathSpecificationContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_pathSpecification; }
    // @Override
    enterRule(listener) {
...
export class PrivilegeContext extends ParserRuleContext {
    KW_ALL() { return this.tryGetToken(ImpalaSqlParser.KW_ALL, 0); }
    KW_ALTER() { return this.tryGetToken(ImpalaSqlParser.KW_ALTER, 0); }
    KW_DROP() { return this.tryGetToken(ImpalaSqlParser.KW_DROP, 0); }
    KW_CREATE() { return this.tryGetToken(ImpalaSqlParser.KW_CREATE, 0); }
    KW_INSERT() { return this.tryGetToken(ImpalaSqlParser.KW_INSERT, 0); }
    KW_REFRESH() { return this.tryGetToken(ImpalaSqlParser.KW_REFRESH, 0); }
    KW_SELECT() { return this.tryGetToken(ImpalaSqlParser.KW_SELECT, 0); }
    LPAREN() { return this.tryGetToken(ImpalaSqlParser.LPAREN, 0); }
    RPAREN() { return this.tryGetToken(ImpalaSqlParser.RPAREN, 0); }
    identifier() {
        return this.tryGetRuleContext(0, IdentifierContext);
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_privilege; }
    // @Override
    enterRule(listener) {
...
export class ObjectTypeContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_objectType; }
    // @Override
    enterRule(listener) {
...
export class QualifiedNameContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_qualifiedName; }
    // @Override
    enterRule(listener) {
...
export class PrincipalContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_principal; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
export class UserPrincipalContext extends PrincipalContext {
    KW_USER() { return this.getToken(ImpalaSqlParser.KW_USER, 0); }
    identifier() {
        return this.getRuleContext(0, IdentifierContext);
    }
    constructor(ctx) {
...
export class IdentifierContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_identifier; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
export class UnquotedIdentifierContext extends IdentifierContext {
    IDENTIFIER() { return this.tryGetToken(ImpalaSqlParser.IDENTIFIER, 0); }
    nonReserved() {
...
export class BackQuotedIdentifierContext extends IdentifierContext {
    BACKQUOTED_IDENTIFIER() { return this.getToken(ImpalaSqlParser.BACKQUOTED_IDENTIFIER, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class DigitIdentifierContext extends IdentifierContext {
    DIGIT_IDENTIFIER() { return this.getToken(ImpalaSqlParser.DIGIT_IDENTIFIER, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
export class NumberContext extends ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_number; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
export class DecimalLiteralContext extends NumberContext {
    DECIMAL_VALUE() { return this.getToken(ImpalaSqlParser.DECIMAL_VALUE, 0); }
    MINUS() { return this.tryGetToken(ImpalaSqlParser.MINUS, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
...
export class DoubleLiteralContext extends NumberContext {
    DOUBLE_VALUE() { return this.getToken(ImpalaSqlParser.DOUBLE_VALUE, 0); }
    MINUS() { return this.tryGetToken(ImpalaSqlParser.MINUS, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
...
export class ReservedKeywordsUsedAsFuncNameContext extends ParserRuleContext {
    KW_TRUNCATE() { return this.tryGetToken(ImpalaSqlParser.KW_TRUNCATE, 0); }
    KW_CAST() { return this.tryGetToken(ImpalaSqlParser.KW_CAST, 0); }
    KW_CURRENT_DATE() { return this.tryGetToken(ImpalaSqlParser.KW_CURRENT_DATE, 0); }
    KW_CURRENT_TIMESTAMP() { return this.tryGetToken(ImpalaSqlParser.KW_CURRENT_TIMESTAMP, 0); }
    KW_DAY() { return this.tryGetToken(ImpalaSqlParser.KW_DAY, 0); }
    KW_EXTRACT() { return this.tryGetToken(ImpalaSqlParser.KW_EXTRACT, 0); }
    KW_HOUR() { return this.tryGetToken(ImpalaSqlParser.KW_HOUR, 0); }
    KW_MINUTE() { return this.tryGetToken(ImpalaSqlParser.KW_MINUTE, 0); }
    KW_MONTH() { return this.tryGetToken(ImpalaSqlParser.KW_MONTH, 0); }
    KW_SECOND() { return this.tryGetToken(ImpalaSqlParser.KW_SECOND, 0); }
    KW_YEAR() { return this.tryGetToken(ImpalaSqlParser.KW_YEAR, 0); }
    KW_CASE() { return this.tryGetToken(ImpalaSqlParser.KW_CASE, 0); }
    KW_LEFT() { return this.tryGetToken(ImpalaSqlParser.KW_LEFT, 0); }
    KW_REPLACE() { return this.tryGetToken(ImpalaSqlParser.KW_REPLACE, 0); }
    KW_RIGHT() { return this.tryGetToken(ImpalaSqlParser.KW_RIGHT, 0); }
    KW_SUBSTRING() { return this.tryGetToken(ImpalaSqlParser.KW_SUBSTRING, 0); }
    KW_USER() { return this.tryGetToken(ImpalaSqlParser.KW_USER, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_reservedKeywordsUsedAsFuncName; }
    // @Override
    enterRule(listener) {
...
export class NonReservedContext extends ParserRuleContext {
    ...
    KW_OPTION() { return this.tryGetToken(ImpalaSqlParser.KW_OPTION, 0); }
    KW_ORDINALITY() { return this.tryGetToken(ImpalaSqlParser.KW_ORDINALITY, 0); }
    KW_PRIVILEGES() { return this.tryGetToken(ImpalaSqlParser.KW_PRIVILEGES, 0); }
    KW_PROPERTIES() { return this.tryGetToken(ImpalaSqlParser.KW_PROPERTIES, 0); }
    KW_SECOND() { return this.tryGetToken(ImpalaSqlParser.KW_SECOND, 0); }
    KW_SECONDS() { return this.tryGetToken(ImpalaSqlParser.KW_SECONDS, 0); }
    KW_SUBSTRING() { return this.tryGetToken(ImpalaSqlParser.KW_SUBSTRING, 0); }
    ...
    KW_TRY_CAST() { return this.tryGetToken(ImpalaSqlParser.KW_TRY_CAST, 0); }
    KW_USER() { return this.tryGetToken(ImpalaSqlParser.KW_USER, 0); }
    KW_VIEWS() { return this.tryGetToken(ImpalaSqlParser.KW_VIEWS, 0); }
    KW_YEAR() { return this.tryGetToken(ImpalaSqlParser.KW_YEAR, 0); }
    KW_ORC() { return this.tryGetToken(ImpalaSqlParser.KW_ORC, 0); }
    KW_CURRENT_TIMESTAMP() { return this.tryGetToken(ImpalaSqlParser.KW_CURRENT_TIMESTAMP, 0); }
    KW_CURRENT_USER() { return this.tryGetToken(ImpalaSqlParser.KW_CURRENT_USER, 0); }
    KW_EXTRACT() { return this.tryGetToken(ImpalaSqlParser.KW_EXTRACT, 0); }
    KW_KEY() { return this.tryGetToken(ImpalaSqlParser.KW_KEY, 0); }
    KW_LOCALTIME() { return this.tryGetToken(ImpalaSqlParser.KW_LOCALTIME, 0); }
    KW_SHUTDOWN() { return this.tryGetToken(ImpalaSqlParser.KW_SHUTDOWN, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return ImpalaSqlParser.RULE_nonReserved; }
    // @Override
    enterRule(listener) {
