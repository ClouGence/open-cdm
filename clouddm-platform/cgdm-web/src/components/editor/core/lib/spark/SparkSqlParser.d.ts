...
export declare class SparkSqlParser extends Parser {
    ...
    static readonly RULE_columnName = 45;
    static readonly RULE_columnNameSeq = 46;
    static readonly RULE_columnNameCreate = 47;
    ...
    static readonly RULE_functionKind = 73;
    static readonly RULE_temporalClause = 74;
    static readonly RULE_aggregationClause = 75;
    static readonly RULE_groupByClause = 76;
    static readonly RULE_groupingAnalytics = 77;
    static readonly RULE_groupingElement = 78;
    static readonly RULE_groupingSet = 79;
    static readonly RULE_pivotClause = 80;
    static readonly RULE_pivotColumn = 81;
    static readonly RULE_pivotValue = 82;
    static readonly RULE_unpivotClause = 83;
    static readonly RULE_unpivotNullClause = 84;
    static readonly RULE_unpivotOperator = 85;
    static readonly RULE_unpivotSingleValueColumnClause = 86;
    static readonly RULE_unpivotMultiValueColumnClause = 87;
    static readonly RULE_unpivotColumnSet = 88;
    static readonly RULE_unpivotValueColumn = 89;
    static readonly RULE_unpivotNameColumn = 90;
    static readonly RULE_unpivotColumnAndAlias = 91;
    static readonly RULE_unpivotColumn = 92;
    static readonly RULE_unpivotAlias = 93;
    static readonly RULE_ifNotExists = 94;
    static readonly RULE_ifExists = 95;
    static readonly RULE_lateralView = 96;
    static readonly RULE_setQuantifier = 97;
    static readonly RULE_relation = 98;
    static readonly RULE_relationExtension = 99;
    static readonly RULE_joinRelation = 100;
    static readonly RULE_joinType = 101;
    static readonly RULE_joinCriteria = 102;
    static readonly RULE_sample = 103;
    static readonly RULE_sampleMethod = 104;
    static readonly RULE_identifierList = 105;
    static readonly RULE_identifierSeq = 106;
    static readonly RULE_orderedIdentifierList = 107;
    static readonly RULE_orderedIdentifier = 108;
    static readonly RULE_identifierCommentList = 109;
    static readonly RULE_identifierComment = 110;
    static readonly RULE_relationPrimary = 111;
    static readonly RULE_inlineTable = 112;
    static readonly RULE_functionTableSubqueryArgument = 113;
    static readonly RULE_tableArgumentPartitioning = 114;
    static readonly RULE_functionTableNamedArgumentExpression = 115;
    static readonly RULE_functionTableReferenceArgument = 116;
    static readonly RULE_functionTableArgument = 117;
    static readonly RULE_functionTable = 118;
    static readonly RULE_tableAlias = 119;
    static readonly RULE_rowFormat = 120;
    static readonly RULE_multipartIdentifierList = 121;
    static readonly RULE_multipartIdentifier = 122;
    static readonly RULE_multipartIdentifierPropertyList = 123;
    static readonly RULE_multipartIdentifierProperty = 124;
    static readonly RULE_tableIdentifier = 125;
    static readonly RULE_viewIdentifier = 126;
    static readonly RULE_namedExpression = 127;
    static readonly RULE_namedExpressionSeq = 128;
    static readonly RULE_partitionFieldList = 129;
    static readonly RULE_partitionField = 130;
    static readonly RULE_transform = 131;
    static readonly RULE_transformArgument = 132;
    static readonly RULE_expression = 133;
    static readonly RULE_namedArgumentExpression = 134;
    static readonly RULE_functionArgument = 135;
    static readonly RULE_expressionSeq = 136;
    static readonly RULE_booleanExpression = 137;
    static readonly RULE_predicate = 138;
    static readonly RULE_valueExpression = 139;
    static readonly RULE_datetimeUnit = 140;
    static readonly RULE_primaryExpression = 141;
    static readonly RULE_literalType = 142;
    static readonly RULE_constant = 143;
    static readonly RULE_comparisonOperator = 144;
    static readonly RULE_arithmeticOperator = 145;
    static readonly RULE_predicateOperator = 146;
    static readonly RULE_booleanValue = 147;
    static readonly RULE_interval = 148;
    static readonly RULE_errorCapturingMultiUnitsInterval = 149;
    static readonly RULE_multiUnitsInterval = 150;
    static readonly RULE_errorCapturingUnitToUnitInterval = 151;
    static readonly RULE_unitToUnitInterval = 152;
    static readonly RULE_intervalValue = 153;
    static readonly RULE_unitInMultiUnits = 154;
    static readonly RULE_unitInUnitToUnit = 155;
    static readonly RULE_colPosition = 156;
    static readonly RULE_type = 157;
    static readonly RULE_dataType = 158;
    static readonly RULE_qualifiedColTypeWithPositionSeqForAdd = 159;
    static readonly RULE_qualifiedColTypeWithPositionForAdd = 160;
    static readonly RULE_qualifiedColTypeWithPositionSeqForReplace = 161;
    static readonly RULE_qualifiedColTypeWithPositionForReplace = 162;
    static readonly RULE_colDefinitionDescriptorWithPosition = 163;
    static readonly RULE_defaultExpression = 164;
    static readonly RULE_variableDefaultExpression = 165;
    static readonly RULE_colTypeList = 166;
    static readonly RULE_colType = 167;
    static readonly RULE_createOrReplaceTableColTypeList = 168;
    static readonly RULE_createOrReplaceTableColType = 169;
    static readonly RULE_colDefinitionOption = 170;
    static readonly RULE_generationExpression = 171;
    static readonly RULE_complexColTypeList = 172;
    static readonly RULE_complexColType = 173;
    static readonly RULE_whenClause = 174;
    static readonly RULE_windowClause = 175;
    static readonly RULE_namedWindow = 176;
    static readonly RULE_windowSpec = 177;
    static readonly RULE_windowFrame = 178;
    static readonly RULE_frameBound = 179;
    static readonly RULE_qualifiedNameList = 180;
    static readonly RULE_functionName = 181;
    static readonly RULE_functionNameCreate = 182;
    static readonly RULE_qualifiedName = 183;
    static readonly RULE_errorCapturingIdentifier = 184;
    static readonly RULE_errorCapturingIdentifierExtra = 185;
    static readonly RULE_identifier = 186;
    static readonly RULE_strictIdentifier = 187;
    static readonly RULE_quotedIdentifier = 188;
    static readonly RULE_backQuotedIdentifier = 189;
    static readonly RULE_number = 190;
    static readonly RULE_alterColumnAction = 191;
    static readonly RULE_stringLit = 192;
    static readonly RULE_comment = 193;
    static readonly RULE_version = 194;
    static readonly RULE_ansiNonReserved = 195;
    static readonly RULE_strictNonReserved = 196;
    static readonly RULE_nonReserved = 197;
...
export declare class StatementContext extends ParserRuleContext {
    ...
    columnNameSeq(): ColumnNameSeqContext | undefined;
    ...
    qualifiedColTypeWithPositionForAdd(): QualifiedColTypeWithPositionForAddContext | undefined;
    qualifiedColTypeWithPositionSeqForAdd(): QualifiedColTypeWithPositionSeqForAddContext | undefined;
    KW_RENAME(): TerminalNode | undefined;
    columnName(): ColumnNameContext | undefined;
    KW_TO(): TerminalNode | undefined;
    columnNameCreate(): ColumnNameCreateContext | undefined;
    ...
    qualifiedColTypeWithPositionSeqForReplace(): QualifiedColTypeWithPositionSeqForReplaceContext | undefined;
...
export declare class ColumnNameSeqContext extends ParserRuleContext {
    columnName(): ColumnNameContext[];
...
export declare class QualifiedColTypeWithPositionSeqForAddContext extends ParserRuleContext {
    qualifiedColTypeWithPositionForAdd(): QualifiedColTypeWithPositionForAddContext[];
    qualifiedColTypeWithPositionForAdd(i: number): QualifiedColTypeWithPositionForAddContext;
    COMMA(): TerminalNode[];
    COMMA(i: number): TerminalNode;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
...
export declare class QualifiedColTypeWithPositionForAddContext extends ParserRuleContext {
...
export declare class QualifiedColTypeWithPositionSeqForReplaceContext extends ParserRuleContext {
    qualifiedColTypeWithPositionForReplace(): QualifiedColTypeWithPositionForReplaceContext[];
    qualifiedColTypeWithPositionForReplace(i: number): QualifiedColTypeWithPositionForReplaceContext;
    COMMA(): TerminalNode[];
    COMMA(i: number): TerminalNode;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
...
export declare class QualifiedColTypeWithPositionForReplaceContext extends ParserRuleContext {
