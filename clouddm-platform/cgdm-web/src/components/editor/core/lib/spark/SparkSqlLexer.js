...
SparkSqlLexer.KW_NOSCAN = 192;
SparkSqlLexer.KW_NOT = 193;
SparkSqlLexer.KW_NULL = 194;
SparkSqlLexer.KW_NULLS = 195;
SparkSqlLexer.KW_NUMERIC = 196;
SparkSqlLexer.KW_OF = 197;
SparkSqlLexer.KW_OFFSET = 198;
SparkSqlLexer.KW_ON = 199;
SparkSqlLexer.KW_ONLY = 200;
SparkSqlLexer.KW_OPTION = 201;
SparkSqlLexer.KW_OPTIONS = 202;
SparkSqlLexer.KW_OR = 203;
SparkSqlLexer.KW_ORDER = 204;
SparkSqlLexer.KW_OUT = 205;
SparkSqlLexer.KW_OUTER = 206;
SparkSqlLexer.KW_OUTPUTFORMAT = 207;
SparkSqlLexer.KW_OVER = 208;
SparkSqlLexer.KW_OVERLAPS = 209;
SparkSqlLexer.KW_OVERLAY = 210;
SparkSqlLexer.KW_OVERWRITE = 211;
SparkSqlLexer.KW_PARTITION = 212;
SparkSqlLexer.KW_PARTITIONED = 213;
SparkSqlLexer.KW_PARTITIONS = 214;
SparkSqlLexer.KW_PERCENTILE_CONT = 215;
SparkSqlLexer.KW_PERCENTILE_DISC = 216;
SparkSqlLexer.KW_PERCENTLIT = 217;
SparkSqlLexer.KW_PIVOT = 218;
SparkSqlLexer.KW_PLACING = 219;
SparkSqlLexer.KW_POSITION = 220;
SparkSqlLexer.KW_PRECEDING = 221;
SparkSqlLexer.KW_PRIMARY = 222;
SparkSqlLexer.KW_PRINCIPALS = 223;
SparkSqlLexer.KW_PROPERTIES = 224;
SparkSqlLexer.KW_PURGE = 225;
SparkSqlLexer.KW_QUARTER = 226;
SparkSqlLexer.KW_QUERY = 227;
SparkSqlLexer.KW_RANGE = 228;
SparkSqlLexer.KW_REAL = 229;
SparkSqlLexer.KW_RECORDREADER = 230;
SparkSqlLexer.KW_RECORDWRITER = 231;
SparkSqlLexer.KW_RECOVER = 232;
SparkSqlLexer.KW_REDUCE = 233;
SparkSqlLexer.KW_REFERENCES = 234;
SparkSqlLexer.KW_REFRESH = 235;
SparkSqlLexer.KW_RENAME = 236;
SparkSqlLexer.KW_REPAIR = 237;
SparkSqlLexer.KW_REPEATABLE = 238;
SparkSqlLexer.KW_REPLACE = 239;
SparkSqlLexer.KW_RESET = 240;
SparkSqlLexer.KW_RESPECT = 241;
SparkSqlLexer.KW_RESTRICT = 242;
SparkSqlLexer.KW_REVOKE = 243;
SparkSqlLexer.KW_RIGHT = 244;
SparkSqlLexer.KW_RLIKE = 245;
SparkSqlLexer.KW_REGEXP = 246;
SparkSqlLexer.KW_ROLE = 247;
SparkSqlLexer.KW_ROLES = 248;
SparkSqlLexer.KW_ROLLBACK = 249;
SparkSqlLexer.KW_ROLLUP = 250;
SparkSqlLexer.KW_ROW = 251;
SparkSqlLexer.KW_ROWS = 252;
SparkSqlLexer.KW_SECOND = 253;
SparkSqlLexer.KW_SECONDS = 254;
SparkSqlLexer.KW_SCHEMA = 255;
SparkSqlLexer.KW_SCHEMAS = 256;
SparkSqlLexer.KW_SELECT = 257;
SparkSqlLexer.KW_SEMI = 258;
SparkSqlLexer.KW_SEPARATED = 259;
SparkSqlLexer.KW_SERDE = 260;
SparkSqlLexer.KW_SERDEPROPERTIES = 261;
SparkSqlLexer.KW_SESSION_USER = 262;
SparkSqlLexer.KW_SET = 263;
SparkSqlLexer.KW_MINUS = 264;
SparkSqlLexer.KW_SETS = 265;
SparkSqlLexer.KW_SHORT = 266;
SparkSqlLexer.KW_SHOW = 267;
SparkSqlLexer.KW_SINGLE = 268;
SparkSqlLexer.KW_SKEWED = 269;
SparkSqlLexer.KW_SMALLINT = 270;
SparkSqlLexer.KW_SOME = 271;
SparkSqlLexer.KW_SORT = 272;
SparkSqlLexer.KW_SORTED = 273;
SparkSqlLexer.KW_SOURCE = 274;
SparkSqlLexer.KW_START = 275;
SparkSqlLexer.KW_STATISTICS = 276;
SparkSqlLexer.KW_STORED = 277;
SparkSqlLexer.KW_STRATIFY = 278;
SparkSqlLexer.KW_STRING = 279;
SparkSqlLexer.KW_STRUCT = 280;
SparkSqlLexer.KW_SUBSTR = 281;
SparkSqlLexer.KW_SUBSTRING = 282;
SparkSqlLexer.KW_SYNC = 283;
SparkSqlLexer.KW_SYSTEM = 284;
SparkSqlLexer.KW_SYSTEM_TIME = 285;
SparkSqlLexer.KW_SYSTEM_VERSION = 286;
SparkSqlLexer.KW_TABLE = 287;
SparkSqlLexer.KW_TABLES = 288;
SparkSqlLexer.KW_TABLESAMPLE = 289;
SparkSqlLexer.KW_TARGET = 290;
SparkSqlLexer.KW_TBLPROPERTIES = 291;
SparkSqlLexer.KW_TEMPORARY = 292;
SparkSqlLexer.KW_TERMINATED = 293;
SparkSqlLexer.KW_THEN = 294;
SparkSqlLexer.KW_TIME = 295;
SparkSqlLexer.KW_TIMEDIFF = 296;
SparkSqlLexer.KW_TIMESTAMP = 297;
SparkSqlLexer.KW_TIMESTAMP_LTZ = 298;
SparkSqlLexer.KW_TIMESTAMP_NTZ = 299;
SparkSqlLexer.KW_TIMESTAMPADD = 300;
SparkSqlLexer.KW_TIMESTAMPDIFF = 301;
SparkSqlLexer.KW_TINYINT = 302;
SparkSqlLexer.KW_TO = 303;
SparkSqlLexer.KW_TOUCH = 304;
SparkSqlLexer.KW_TRAILING = 305;
SparkSqlLexer.KW_TRANSACTION = 306;
SparkSqlLexer.KW_TRANSACTIONS = 307;
SparkSqlLexer.KW_TRANSFORM = 308;
SparkSqlLexer.KW_TRIM = 309;
SparkSqlLexer.KW_TRUE = 310;
SparkSqlLexer.KW_TRUNCATE = 311;
SparkSqlLexer.KW_TRY_CAST = 312;
SparkSqlLexer.KW_TYPE = 313;
SparkSqlLexer.KW_UNARCHIVE = 314;
SparkSqlLexer.KW_UNBOUNDED = 315;
SparkSqlLexer.KW_UNCACHE = 316;
SparkSqlLexer.KW_UNION = 317;
SparkSqlLexer.KW_UNIQUE = 318;
SparkSqlLexer.KW_UNKNOWN = 319;
SparkSqlLexer.KW_UNLOCK = 320;
SparkSqlLexer.KW_UNPIVOT = 321;
SparkSqlLexer.KW_UNSET = 322;
SparkSqlLexer.KW_UPDATE = 323;
SparkSqlLexer.KW_USE = 324;
SparkSqlLexer.KW_USER = 325;
SparkSqlLexer.KW_USING = 326;
SparkSqlLexer.KW_VALUES = 327;
SparkSqlLexer.KW_VARCHAR = 328;
SparkSqlLexer.KW_VAR = 329;
SparkSqlLexer.KW_VARIABLE = 330;
SparkSqlLexer.KW_VERSION = 331;
SparkSqlLexer.KW_VIEW = 332;
SparkSqlLexer.KW_VIEWS = 333;
SparkSqlLexer.KW_VOID = 334;
SparkSqlLexer.KW_WEEK = 335;
SparkSqlLexer.KW_WEEKS = 336;
SparkSqlLexer.KW_WHEN = 337;
SparkSqlLexer.KW_WHERE = 338;
SparkSqlLexer.KW_WINDOW = 339;
SparkSqlLexer.KW_WITH = 340;
SparkSqlLexer.KW_WITHIN = 341;
SparkSqlLexer.KW_YEAR = 342;
SparkSqlLexer.KW_YEARS = 343;
SparkSqlLexer.KW_ZONE = 344;
SparkSqlLexer.EQ = 345;
SparkSqlLexer.NSEQ = 346;
SparkSqlLexer.NEQ = 347;
SparkSqlLexer.NEQJ = 348;
SparkSqlLexer.LT = 349;
SparkSqlLexer.LTE = 350;
SparkSqlLexer.GT = 351;
SparkSqlLexer.GTE = 352;
SparkSqlLexer.NOT = 353;
SparkSqlLexer.PLUS = 354;
SparkSqlLexer.MINUS = 355;
SparkSqlLexer.ASTERISK = 356;
SparkSqlLexer.SLASH = 357;
SparkSqlLexer.PERCENT = 358;
SparkSqlLexer.TILDE = 359;
SparkSqlLexer.AMPERSAND = 360;
SparkSqlLexer.PIPE = 361;
SparkSqlLexer.CONCAT_PIPE = 362;
SparkSqlLexer.HAT = 363;
SparkSqlLexer.COLON = 364;
SparkSqlLexer.ARROW = 365;
SparkSqlLexer.FAT_ARROW = 366;
SparkSqlLexer.HENT_START = 367;
SparkSqlLexer.HENT_END = 368;
SparkSqlLexer.QUESTION = 369;
SparkSqlLexer.STRING_LITERAL = 370;
SparkSqlLexer.DOUBLEQUOTED_STRING = 371;
SparkSqlLexer.BIGINT_LITERAL = 372;
SparkSqlLexer.SMALLINT_LITERAL = 373;
SparkSqlLexer.TINYINT_LITERAL = 374;
SparkSqlLexer.INTEGER_VALUE = 375;
SparkSqlLexer.EXPONENT_VALUE = 376;
SparkSqlLexer.DECIMAL_VALUE = 377;
SparkSqlLexer.FLOAT_LITERAL = 378;
SparkSqlLexer.DOUBLE_LITERAL = 379;
SparkSqlLexer.BIGDECIMAL_LITERAL = 380;
SparkSqlLexer.IDENTIFIER = 381;
SparkSqlLexer.BACKQUOTED_IDENTIFIER = 382;
SparkSqlLexer.SIMPLE_COMMENT = 383;
SparkSqlLexer.BRACKETED_COMMENT = 384;
SparkSqlLexer.WS = 385;
SparkSqlLexer.UNRECOGNIZED = 386;
...
SparkSqlLexer._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\u0184\u0E33\b" +
...
SparkSqlLexer._serializedATNSegment1 = "\x03\xEC\x03\xEC\x03\xEC\x03\xEC\x03\xEC\x03\xED\x03\xED\x03\xED\x03\xED" +
...
SparkSqlLexer._serializedATNSegment2 = "\x02\x02\u01DF\x03\x02\x02\x02\x02\u01E1\x03\x02\x02\x02\x02\u01E3\x03" +
...
SparkSqlLexer._serializedATNSegment3 = "\u0437\x07E\x02\x02\u0437\u0438\x07Q\x02\x02\u0438\u0439\x07N\x02\x02" +
    ...
    "\u0777\u0778\x07";
SparkSqlLexer._serializedATNSegment4 = "G\x02\x02\u0778\u0142\x03\x02\x02\x02\u0779\u077A\x07K\x02\x02\u077A\u077B" +
...
SparkSqlLexer._serializedATNSegment5 = "\x02\u0AB9\u021C\x03\x02\x02\x02\u0ABA\u0ABB\x07U\x02\x02\u0ABB\u0ABC" +
